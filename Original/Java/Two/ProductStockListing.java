// =======================================================================================================================================================================================================
// System: ZaraStar Product: Create stock listing report page
// Module: ProductStockListing.java
// Author: C.K.Harvey
...
public class ProductStockListing extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ProductStockListing", bytesOut);
                    ...
                    String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "ProductStockListing", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "ProductStockListing", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut)
                   throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Stock Listing Report Options</title>");
    ...
    scoutln(out, bytesOut, "window.location.href='/central/servlet/ProductStockListingGenerate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                           + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p4='+store+'&p2='+dateFrom+'&p3='+dateTo+'&p5='+p5+'&p1='+mfr;}");
    ...
    drawingUtils.drawTitle(out, false, false, "ProductStockLevelListing", "", "Stock Listing Report Options", "3010", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>Store</td><td><p>" + documentUtils.getStoresDDL(con, stmt, rs, "store") + "</td></tr>");
