...
public class TrailShow extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "TrailShow", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "TrailShow", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, HttpServletRequest req, String docCode, String docType, String unm, String sid, String uty, String men, String den, String dnm,
                   String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Document Trail</title>");

    scoutln(out, bytesOut, "<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"" + directoryUtils.getCssGeneralDirectory(con, stmt, rs, unm, dnm, defnsDir) + "general.css\">");

    int[] hmenuCount = new int[1];
    
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "11800", "", "TrailShow", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
  
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Document Trail", "11800", unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
  ...
  private void getTrail(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, String docCode, String docType, String unm, int[] bytesOut) throws Exception
  {
    ...
    {
      services = "AND (Service = '3038' OR Service = '3039' OR Service = '3043' OR Service = '3044' OR Service = '3045' OR Service = '3046' "
               + "OR Service = '3047' OR Service = '3048' OR Service = '3054' OR Service = '3056' OR Service = '4125')";
    }
    else
    if(docType.equals("Q")) // quote
    {
      services = "AND (Service = '4019' OR Service = '4020' OR Service = '4021' OR Service = '4022' OR Service = '4023' OR Service = '4024' "
               + "OR Service = '4025' OR Service = '4026' OR Service = '4027' OR Service = '4028' OR Service = '4180')";
    }
    else
    if(docType.equals("Q")) // enquiry
    {
      services = "AND (Service = '4519' OR Service = '4520' OR Service = '4523' OR Service = '4524' "
               + "OR Service = '4525' OR Service = '4526' OR Service = '4527' OR Service = '4528' OR Service = '4531')";
    }
    else
    ...
    {
      services = "AND (Service = '3025' OR Service = '3026' OR Service = '3027' OR Service = '3028' OR Service = '3029' OR Service = '3030' "
               + "OR Service = '3031' OR Service = '3032' OR Service = '3033' OR Service = '3034')";
    }
    else
    ...
    if(docType.equals("I")) // invoice
    {
      services = "AND (Service = '4067' OR Service = '4224' OR Service = '4068' OR Service = '4069' OR Service = '4070' OR Service = '4071' "
               + "OR Service = '4072' OR Service = '4073' OR Service = '4074' OR Service = '4075' OR Service = '4076' OR Service = '4077' "
               + "OR Service = '4124')";
    }
    else
    ...
    {
      services = "AND (Service = '4080' OR Service = '4081' OR Service = '4082' OR Service = '4083' OR Service = '4084' OR Service = '4085' "
               + "OR Service = '4086' OR Service = '4087' OR Service = '4088' OR Service = '4089')";
    }
    else
