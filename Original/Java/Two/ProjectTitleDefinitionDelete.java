// =======================================================================================================================================================================================================
// System: ZaraStar Project: Title definition - delete
// Module: ProjectTitleDefinitionDelete.java
// Author: C.K.Harvey
...
public class ProjectTitleDefinitionDelete extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 6804b: " + e));
      res.getWriter().write("Unexpected System Error: 6804b");
    }
  }
                    ...
                    int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 6804b";
    ...
    serverUtils.totalBytes(req, unm, dnm, 6804, bytesOut[0], 0, code);
  }
  ...
  private boolean deleteRec(String dnm, String name, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM title WHERE Name = '" + name + "'");
