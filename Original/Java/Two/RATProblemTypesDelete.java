// =======================================================================================================================================================================================================
// System: ZaraStar RAT Problem Types - delete
// Module: RATProblemTypesDelete.java
// Author: C.K.Harvey
...
public class RATProblemTypesDelete extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 5917b: " + e));
      res.getWriter().write("Unexpected System Error: 5917b");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String code, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 5917b";
    ...
    {
      if(deleteRec(dnm, generalUtils.deSanitise(code)))
      rtn = ".";
    }
  ...
  private boolean deleteRec(String dnm, String name) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM ratprob WHERE Name = '" + generalUtils.sanitiseForSQL(name) + "'");
