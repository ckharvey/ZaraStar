...
public class WikiStyling extends HttpServlet
{
                   ...
                   int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "function change(source,name){var p1=sanitise(name);");
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/WikiStylingEdit?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=\"+source+\"&p1=\"+p1;}");
 
    scoutln(out, bytesOut, "function create(source,name){var p1=sanitise(name);");
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/WikiStylingCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=\"+source+\"&p1=\"+p1;}");
 
    scoutln(out, bytesOut, "function del(name){var p1=sanitise(name);");
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/WikiStylingDelete?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=\"+p1;}");
    ...
    dashboardUtils.drawTitle(out, "Site Styling", "7081", unm, sid, uty, men, den, dnm, bnm, bytesOut);
