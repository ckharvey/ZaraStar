...
public class TextMaintainDirectoriesWave extends HttpServlet
{
                      ...
                      String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "6100\001Text\001Text Main\001javascript:getHTML('TextMaintainDirectoriesWave','')\001\001Y\001\001\003");
                         ...
                         String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/TextInsertDirectory?unm=" + unm + "&sid=" + sid + "&uty="
                           + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=" + option + "&p1=\"+p1;}");
    ...
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/TextListDirectory?unm=" + unm + "&sid=" + sid + "&uty="
                           + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=\"+userName+\"&p1=\"+p1;}");
    scoutln(out, bytesOut, "</script>");

    int[] hmenuCount = new int[1];
    hmenuCount[0] = 0;

    textUtils.drawTitleW(con, stmt, rs, out, req, false, "", "Text Library Directory List", "6100", unm, sid, uty, men, den, dnm, bnm, hmenuCount, localDefnsDir, defnsDir, bytesOut);
