// =======================================================================================================================================================================================================
// System: ZaraStar Tasks: Utilities
// Module: TasksUtils.java
// Author: C.K.Harvey
...
public class TasksUtils
{
                                  ...
                                  throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 2027, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      s += "<a href=\"/central/servlet/SalesOrdersSales?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + unm + "\">Sales: Projects</a></dt></dl>";
    }
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 2042, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\">";
      s += "<a href=\"/central/servlet/SalesOrderTradesa?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + unm + "\">Sales: Trades</a></dt></dl>";
    }
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6820, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\">";
      s += "<a href=\"http://" + men + "/central/servlet/ProjectContactStyle?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\">Projects</a></dt></dl>";
    }
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6900, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\">";
      s += "<a href=\"http://" + men + "/central/servlet/ConsolidationInfo?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\">Consolidations</a></dt></dl>";
    }
