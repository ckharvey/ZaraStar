...
// Module: SalesOrderCoordinating.java
// Author: C.K.Harvey
...
public class SalesOrderCoordinating extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "SalesOrderCoordinating", bytesOut);
                    ...
                    int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "SalesOrderCoordinating", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "SalesOrderCoordinating", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String imagesDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<form action=\"SalesOrderCoordinatingExecute\" name=go enctype=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    drawingUtils.outputPageFrame(con, stmt, rs, out, req, "2034", "", "SalesOrderCoordinating", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    drawingUtils.drawTitle(out, false, false, "SalesOrderCoordinating", "", "Sales Order Processing - Coordinating", "2034", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    getSalesPeople(con, stmt, rs, out, dnm, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void getSalesPeople(Connection con, Statement stmt, ResultSet rs, PrintWriter out, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    try
    {
