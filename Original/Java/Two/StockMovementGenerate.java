// =======================================================================================================================================================================================================
// System: ZaraStar Product: Stock Movement
// Module: StockMovementGenerate.java
// Author: C.K.Harvey
...
public class StockMovementGenerate extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "StockMovementGenerate", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
   {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "3055a", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "3055a", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   throws Exception
  {
    ...
    scoutln(out, bytesOut, "<form name=\"go\" action=\"StockMovementExecute\" enctype=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Stock Movement Report", "3055", unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);

    scoutln(out, bytesOut, "<table id=\"page\" width=100%>");

    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");

    scoutln(out, bytesOut, "<tr><td colspan=2><p>Note: All purchase values are in SGD using the exchange rate as of the final day of the last year.</td></tr>");
    ...
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td><p><a href=\"javascript:generate('screen')\">Generate</a> To Screen</td></tr>");
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
