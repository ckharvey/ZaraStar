// =======================================================================================================================================================================================================
// System: ZaraStar: Product: Smart create search results display page
// Module: ProductSmarSearchResults.java
// Author: C.K.Harvey
...
public class ProductSmarSearchResults extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      if(p5 == null || p5.equalsIgnoreCase("null"))
      p5 = "1";
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ProductSmarSearchResults", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 2013, bytesOut[0], 0, "ERR:" + p7);
    }
  }
                    ...
                    throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "ProductSmarSearchResults", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 2013, bytesOut[0], 0, "ACC:" + p7);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "ProductSmarSearchResults", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 2013, bytesOut[0], 0, "SID:" + p7);
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 2013, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), p7);
                       ...
                       String numEntries, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "function similar(desc){");
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/ProductSmartWordPhraseSearch?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
                         + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=\"+desc;}");
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/ProductSmarSearchResults?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
    ...
    drawingUtils.outputPageFrame(con, stmt, rs, out, req, "2013", "", "ProductSmartWordPhraseSearch", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    drawingUtils.drawTitle(out, false, false, "ProductSmartWordPhraseSearch", "", "Search Results", "2013", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
  }
                             ...
                             String dnm, String localDefnsDir, String defnsDir, byte[][] sectionsList, int[] sectionsListLen) throws Exception
  {
    ...
    {
      desc = getStockDetsGivenCode(con, stmt, rs, docCodeB, dets, dnm, localDefnsDir, defnsDir, data);
      html[0] += "<tr><td height=18 nowrap><p><b>Stock Item</b> - <a href=\"javascript:fetch('" + docType + "','" + s + "')\">" + docCode
              + "</a>&nbsp;</td></tr>\n";
      html[0] += "<tr><td height=18><p>" + generalUtils.stringFromBytes(dets, 0L) + "</td></tr>\n";
      if(desc.length() > 0)
        html[0] += "<tr><td height=18><p><a href=\"javascript:similar('" + generalUtils.sanitise(desc) + "')\">Find Similar</a></td></tr>";
      html[0] += "<tr><td>&nbsp;</td></tr>\n";
    }
    else
    if(docType.equals("StockEMIC"))
    {
      desc = getStockDetsGivenCode(con, stmt, rs, docCodeB, dets, dnm, localDefnsDir, defnsDir, data);
      html[0] += "<tr><td height=18 nowrap><p><b>Stock Item EMIC</b> - <a href=\"javascript:fetch('" + docType + "','" + s + "')\">" + docCode
              + "</a>&nbsp;</td></tr>\n";
      html[0] += "<tr><td height=18><p>" + generalUtils.stringFromBytes(dets, 0L) + "</td></tr>\n";
      if(desc.length() > 0)
        html[0] += "<tr><td height=18><p><a href=\"javascript:similar('" + generalUtils.sanitise(desc) + "')\">Find Similar</a></td></tr>";
    ...
    if(docType.equals("StockEMMC"))
    {
      desc = getStockDetsGivenCode(con, stmt, rs, docCodeB, dets, dnm, localDefnsDir, defnsDir, data);
      html[0] += "<tr><td height=18 nowrap><p><b>Stock Item EMMC</b> - <a href=\"javascript:fetch('" + docType + "','" + s + "')\">" + docCode
              + "</a>&nbsp;</td></tr>\n";
      html[0] += "<tr><td height=18><p>" + generalUtils.stringFromBytes(dets, 0L) + "</td></tr>\n";
      if(desc.length() > 0)
        html[0] += "<tr><td height=18><p><a href=\"javascript:similar('" + generalUtils.sanitise(desc) + "')\">Find Similar</a></td></tr>";
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private String getStockDetsGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] itemCode, byte[] dets, String dnm, String localDefnsDir,
                                       String defnsDir, byte[] data) throws Exception
  {
    ...
    return generalUtils.dfsAsStr(data, (short)1) + " " + generalUtils.dfsAsStr(data, (short)2);
  }
