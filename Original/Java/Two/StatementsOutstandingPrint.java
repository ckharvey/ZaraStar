...
// Module: StatementsOutstandingPrint.java
// Author: C.K.Harvey
...
public class StatementsOutstandingPrint extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "StatementsOutstandingPrint", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1011, bytesOut[0], 0, "ERR:" + p1);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den,
                    String dnm, String bnm, String p1, int[] bytesOut) throws Exception
   {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "1011c", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1011, bytesOut[0], 0, "ACC:" + p1);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "1011c", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1011, bytesOut[0], 0, "SID:" + p1);
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 1011, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), p1);
                   ...
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/StatementsOutstandingReport?unm=" + unm + "&sid=" + sid + "&uty="
    ...
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Statements of Outstanding Print", "1011",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
