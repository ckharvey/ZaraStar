// =======================================================================================================================================================================================================
// System: ZaraStar DocumentEngine: Purchase Invoice Record Access
// Module: purchaseInvoice.java
// Author: C.K.Harvey
...
public class PurchaseInvoice
{
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseInvoice() throws Exception
  {  
    return "pinvoice ( InvoiceCode char(20) not null, Date date not null,           CompanyCode char(20) not null, "
                    ...
                    + "RevisionOf char(20),           SupplierInvoiceCode char(40), BaseGSTTotal decimal(19,8), "
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseInvoice(String[] s) throws Exception
  {
    s[0] = "pinvoiceDateInx on pinvoice (Date)";
    s[1] = "pinvoiceCompanyCodeInx on pinvoice (CompanyCode)";
    
    return 2;
  }
      
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseInvoice() throws Exception
  {  
    return "InvoiceCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
         ...
         + "ShipAddrCode, PrintCount, Status, unused7, unused8, RevisionOf, SupplierInvoiceCode, BaseGSTTotal, Currency, Rate, "
         + "ShipName, ShipAddress1, ShipAddress2, ShipAddress3, ShipAddress4, ShipAddress5, BaseTotalTotal, OCCode, Misc3, Misc4, "
         + "Terms, ExportStatement, Closed, Reference";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseInvoice() throws Exception
  {
  ...
  public void getFieldSizesInvoice(short[] sizes) throws Exception
  {
    ...
    sizes[42] = 1;   sizes[43] = 0;   sizes[44] = 0;   sizes[45] = 20;  sizes[46] = 40;  sizes[47] = 0;   sizes[48] = 3;
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseInvoice() throws Exception
  {
    return "MMMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseInvoiceL() throws Exception
  {  
    return "pinvoicel ( InvoiceCode char(20) not null, ItemCode char(20) not null,     Description char(80), "
                     ...
                     + "PODate date,                   ReceivedAmount decimal(17,8),   RefundedAmount decimal(17,8), "
                     + "AltItemCode char(20),          PORefNum char(40),              DORefNum char(20), "
                     + "Manufacturer char(30),         ManufacturerCode char(60),      GRCode char(20), "
                     + "GRLine integer,                Category char(40), "
                     + "unique(InvoiceCode, Line))";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseInvoiceL(String[] s) throws Exception
  {
    s[0] = "pinvoicelItemCodeInx on pinvoicel(ItemCode)";
    
    return 1;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseInvoiceL() throws Exception
  {  
    return "InvoiceCode, ItemCode, Description, UnitPrice, Quantity, Amount, GSTRate, Discount, DateLastModified, SignOn, Amount2, ProfitCentre, "
         + "AccCode, AppliedStatus, StockUpdated, DateOfStockUpdate, QuantityRequired, CustomerItemCode, UoM, Line, Entry, PODate, ReceivedAmount, "
         + "RefundedAmount, AltItemCode, PORefNum, DORefNum, Manufacturer, ManufacturerCode, GRCode, GRLine, Category";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseInvoiceL() throws Exception
  {
    return "CCCFFFCFSCFCCCCDFCCICDFFCCCCCCIC";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesPurchaseInvoiceL(short[] sizes) throws Exception
  {
    ...
    sizes[21] = 0;   sizes[22] = 0;   sizes[23] = 0;   sizes[24] = 20;  sizes[25] = 40;  sizes[26] = 20;  sizes[27] = 30;
    sizes[28] = 60;  sizes[29] = 20;  sizes[30] = 0;   sizes[31] = 40;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseInvoiceL() throws Exception
  {
    return "OOOOOOOOOOOOOOOOOOOMOOOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseInvoiceLL() throws Exception
  {  
    return "pinvoicell ( InvoiceCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), "
                      + "unique(InvoiceCode, Entry, Line))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseInvoiceLL(String[] s) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseInvoiceLL() throws Exception
  {  
    return "InvoiceCode, Entry, Line, Text";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseInvoiceLL() throws Exception
  {
    return "CCIC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesPurchaseInvoiceLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseInvoiceLL() throws Exception
  {
    return "MMMO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseInvoiceA() throws Exception
  {  
    return "pinvoicea ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseInvoiceA(String[] s) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseInvoiceA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseInvoiceA() throws Exception
  {
    return "CI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesPurchaseInvoiceA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseInvoiceA() throws Exception
  {
    return "MM";
  }
                              ...
                              char cad, String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    if(cad == 'A' && code[0] == '\000')
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "PurchaseInvoice", imagesDir, localDefnsDir, defnsDir, bytesOut);
      return true;
    }
    ...
    {
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "pinvoice");
    }
    ...
    short[] fieldSizesPurchaseInvoice = new short[70]; // plenty
    getFieldSizesInvoice(fieldSizesPurchaseInvoice);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesPurchaseInvoiceL = new short[40]; // plenty
      getFieldSizesPurchaseInvoiceL(fieldSizesPurchaseInvoiceL);
      ...
      if(dispOrEdit == 'D')
      {  
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "222.htm", 2,
                                         getFieldNamesPurchaseInvoice(), fieldSizesPurchaseInvoice, getFieldNamesPurchaseInvoiceL(),
                                         fieldSizesPurchaseInvoiceL, null, null);
      }
      else
      {
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "222a.htm", 1,
                                         getFieldNamesPurchaseInvoice(), fieldSizesPurchaseInvoice, null, null, null, null);
      }
      ...
      {
        prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(code, 0L), "222a.htm",
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        generalUtils.dfsGivenSeparator(true, '\001', headData, (short)26, b); // was 27 12nov08
        ...
        if(generalUtils.doubleToStr(groupDiscount).indexOf("E") != -1) groupDiscount=0;
        ...
        stmt.executeUpdate("UPDATE pinvoice SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " 
        ...
        scoutln(headData, bytesOut, "pinvoice.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen
        ...
        scoutln(headData, bytesOut, "pinvoice.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 49); // rate
        scoutln(headData, bytesOut, "pinvoice.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)49) + "\001");
        ...
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "pinvoice.Attachments=" + attachments + "\001");
      }
      else // edit
      {
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "pinvoice.Currency", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
        ddlData = documentUtils.getSalesPersonDDLData(con, stmt, rs, "pinvoice.SalesPerson", ddlData, ddlDataUpto, ddlDataLen);
        ddlData = documentUtils.getCountryDDLData(con, stmt, rs, "pinvoice.Country", ddlData, ddlDataUpto, ddlDataLen);
    ...
    else // a new layout
    {
      ...
      {                            // be in the correct order
        sortFields(dataAlready, data, "pinvoice");
      }  
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "pinvoice", data);

        documentUtils.getNextCode(con, stmt, rs, "pinvoice", true, code);
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L),
                  generalUtils.todaySQLFormat(localDefnsDir, defnsDir), "222a.htm", localDefnsDir, defnsDir, prependCode, req, bytesOut);
  ...
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=pinvoicel.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5086, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pinvoice", date, unm))
                            ...
                            String den, String dnm, String bnm, byte[] b, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5084, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PurchaseInvoiceLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                       ...
                       String code, String date, byte[] b, HttpServletRequest req, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5082, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function fetch(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PurchaseInvoiceHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty="
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty="
                       + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=PI\";}");
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6098, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/DocumentChangeDiscounts?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
                           + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=PI\";}");
      }
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5084, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PurchaseInvoiceLine?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=&p3=&p4=\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/TrailShow?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=J\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5087, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function print(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/_5087?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=&p3=&p4=\";}");
    }
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', ' ', "", "PurchaseInvoicePage", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                           ...
                           HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/PurchaseInvoiceHeaderUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', cad.charAt(0), "", "PurchaseInvoiceHeaderEdit", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "pinvoicel", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "pinvoicel"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesPurchaseInvoiceL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "pinvoicel", fieldName, value) != -1) // entry exists
      {
        if(fieldCount == 1) // itemCode
          itemCodeIn = generalUtils.stringFromBytes(value, 0L);
        else
        if(fieldCount == 27) // mfr
          mfrIn = generalUtils.stringFromBytes(value, 0L);
        else
        if(fieldCount == 28)
          mfrCodeIn = generalUtils.stringFromBytes(value, 0L);
        else
        if(fieldCount == 21) // poDate
        {
          generalUtils.repAlpha(buf, 2000, (short)21, generalUtils.convertDateToSQLFormat(generalUtils.stringFromBytes(value, 0L)));
        }
        else
        {
    ...
    generalUtils.repAlpha(buf, 2000, (short)27, mfrOut[0]);
    generalUtils.repAlpha(buf, 2000, (short)28, mfrCodeOut[0]);
    ...
    if((generalUtils.dfsAsStr(buf, (short)21)).length() == 0) // poDate
    ...
    if((generalUtils.dfsAsStr(buf, (short)30)).length() == 0) // grLine
      generalUtils.putAlpha(buf, 2000, (short)30, "0");

    if((generalUtils.dfsAsStr(buf, (short)31)).length() == 0) // category
      generalUtils.putAlpha(buf, 2000, (short)31, accountsUtils.getPurchasesAccCode(accountsUtils.getAccountingYearForADate(con, stmt, rs, generalUtils.today(localDefnsDir, defnsDir), dnm, localDefnsDir, defnsDir), dnm, localDefnsDir, defnsDir));

    byte[] rateB = new byte[30];
    getAnInvoiceFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir); // getCurrencyRateGivenCode
    ...
    if(   searchDataString(recData, recDataLen, "pinvoicel", fieldName, value) != -1 // exists
       && value[0] != '\000')
    {
    ...
    if(searchDataString(recData, recDataLen, "pinvoicel", fieldName, value) != -1) // exists
    {
      if(value[0] == '\000') // description fld is blank
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, itemCode, '\000', data) != -1) // exists
        {
          ...
          if(! unitPriceGiven)
          {
            ...
            getAnInvoiceFieldGivenCode(con, stmt, rs, "Currency", code, currency, dnm, localDefnsDir, defnsDir); 
      ...
      else // strip only the first desc line for pinvoiceL rec
      {
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE pinvoice SET SignOn = '" + unm + "', DateLastModified = NULL WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
                                   ...
                                   throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM pinvoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) 
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE pinvoicell SET Text = '" + sanitisedDesc + "' WHERE InvoiceCode = '"
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO pinvoicell (" + getFieldNamesPurchaseInvoiceLL() + ") VALUES ('"
      ...
      {
        stmt.executeUpdate("DELETE FROM pinvoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getAnInvoiceFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, String invoiceCode, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    byte[] value = new byte[300]; // plenty
    byte[] invoiceCodeB = new byte[21];
    generalUtils.strToBytes(invoiceCodeB, invoiceCode);
    
    getAnInvoiceFieldGivenCode(con, stmt, rs, fieldName, invoiceCodeB, value, dnm, localDefnsDir, defnsDir);
    
    return generalUtils.stringFromBytes(value, 0L);
  }
  public void getAnInvoiceFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] pinvoiceCode, byte[] value, String dnm, String localDefnsDir, String defnsDir)
                                         throws Exception
  {
    if(pinvoiceCode[0] == '\000') // just-in-case
      return;

    generalUtils.toUpper(pinvoiceCode, 0);

    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT " + fieldName + " FROM pinvoice WHERE InvoiceCode = '" + generalUtils.stringFromBytes(pinvoiceCode, 0L) + "'");
    if(! rs.next())
      value[0] = '\000';
                                        ...
                                        byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, layoutFile, 1,
                                     getFieldNamesPurchaseInvoiceL(), fieldSizesPurchaseInvoiceL, null, null, null, null);
    ...
    if(line[0] != '\000') // existing line
    {
      if(code[0] != '\000') // just-in-case
      {
        if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not
        {                          // be in the correct order
          sortFields(dataAlready, data, "pinvoicel");
        }
        else
        {
          ...
          generalUtils.dfsGivenSeparator(true, '\001', data, (short)21, b); // origin-0 podate
          generalUtils.convertFromYYYYMMDD(b);
          generalUtils.repAlphaGivenSeparator('\001', data, 2000, (short)21, b);
          ...
          int[]  multipleLinesCount = new int[1];
          byte[] llData = new byte[200];
          multipleLinesData = getMultipleLine(con, stmt, rs, code, line, multipleLinesData, multipleListLen, multipleLinesCount, dnm, localDefnsDir,
                                              defnsDir);
    ...
    else // new line
    {
      ...
      else
      {
        ...
        scoutln(data, bytesOut, "pinvoicel.entry=" + generalUtils.intToStr(nextLine) + "\001");
  
        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "pinvoicel.gstrate=" + gstRateDefault + "\001");
      }
    
      newOrEdit = 'N';
    }

    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "pinvoicel.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);

    ddlData = inventory.getMfrsDDLData(con, stmt, rs, "pinvoicel.manufacturer", ddlData, ddlDataUpto, ddlDataLen);

    getAnInvoiceFieldGivenCode(con, stmt, rs, "Date", code, b, dnm, localDefnsDir, defnsDir);
    String thisCategory = generalUtils.dfsGivenSeparator(true, '\001', data, (short)31);
    String[] thisAccCodeAndDesc = new String[1];
    ddlData = accountsUtils.getCategoryDDLData(con, stmt, rs, 'P', generalUtils.stringFromBytes(b, 0L), thisCategory, "pinvoicel.category", dnm, ddlData, ddlDataUpto, ddlDataLen,
                                       localDefnsDir, defnsDir, thisAccCodeAndDesc);
    generalUtils.repAlphaGivenSeparator('\001', data, 2000, (short)31, thisAccCodeAndDesc[0]);

    getAnInvoiceFieldGivenCode(con, stmt, rs, "Currency", code, b, dnm, localDefnsDir, defnsDir);
    scoutln(data, bytesOut, "pinvoicel.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "pinvoicel.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(line, 0L),
                    "222b.htm", localDefnsDir, defnsDir, prependCode, newOrEdit, req, bytesOut);
                               ...
                               byte[] b, char newOrEdit, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/PurchaseInvoiceLineUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
    ...
    outputPageFrame(con, stmt, rs, b, req, newOrEdit, ' ', "", "PurchaseInvoiceLine", "", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  ...
  //       'F' if not updated
  //       'I' if illegal code
  public char putHead(Connection con, Statement stmt, ResultSet rs, byte[] originalCode, String unm, String dnm, String localDefnsDir, String defnsDir, char cad, byte[] recData, int recDataLen, byte[] code, int[] bytesOut, String[] dupCodes)
                      throws Exception
  {
    byte[] str = new byte[21];  str[0] = '\000';
    generalUtils.catAsBytes("InvoiceCode", 0, str, true);

    if(searchDataString(recData, recDataLen, "pinvoice", str, code) == 0)
      return 'N';
    ...
    // chk for dup supplierInvoiceCode
    generalUtils.strToBytes(fldName, "SupplierInvoiceCode");
    searchDataString(recData, recDataLen, "pinvoice", fldName, value);
    generalUtils.strToBytes(fldName, "CompanyCode");
    byte[] companyCode = new byte[21];
    searchDataString(recData, recDataLen, "pinvoice", fldName, companyCode);
    dupCodes[0] = "";
    if(duplicateSupplierInvoiceCodesExist(con, stmt, rs, generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(value, 0L), generalUtils.stringFromBytes(companyCode, 0L), dupCodes))
    {
      return 'D';
    }
    ...
    if(searchDataString(recData, recDataLen, "pinvoice", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "pinvoice", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "pinvoice", fldName, date); // assumes exists
    ...
    String fieldNamesInvoice = getFieldNamesPurchaseInvoice();
        ...
        if(fieldCount == 2)
        {
          ...
          if(! atleastOneHasValue || ! atleastOneHasValue2) // companycode
          {
            ...
            if(supplier.getSupplierRecGivenCode(con, stmt, rs, value, '\000', dnm, data, localDefnsDir, defnsDir) != -1) // exists
            {
              ...
              {
                generalUtils.dfs(data, (short)32, b);          // shipname
                generalUtils.repAlpha(buf, 2000, (short)51, b);
                generalUtils.dfs(data, (short)33, b);          // shipaddr1
                generalUtils.repAlpha(buf, 2000, (short)52, b);
                generalUtils.dfs(data, (short)34, b);          // shipaddr2
                generalUtils.repAlpha(buf, 2000, (short)53, b);
                generalUtils.dfs(data, (short)35, b);          // shipaddr3
                generalUtils.repAlpha(buf, 2000, (short)54, b);
                generalUtils.dfs(data, (short)36, b);          // shipaddr4
                generalUtils.repAlpha(buf, 2000, (short)55, b);
                generalUtils.dfs(data, (short)37, b);          // shipaddr5
                generalUtils.repAlpha(buf, 2000, (short)56, b);
              }
            }  
          }
    ...
    if((generalUtils.dfsAsStr(buf, (short)19)).length() == 0) // amountPaid 
      generalUtils.putAlpha(buf, 2000, (short)19, "0.0");

    generalUtils.putAlpha(buf, 2000, (short)31, "0");

    generalUtils.putAlpha(buf, 2000, (short)32, "0.0");

    generalUtils.putAlpha(buf, 2000, (short)33, "0.0");

    if((generalUtils.dfsAsStr(buf, (short)35)).length() == 0) // commissionValue 
      generalUtils.putAlpha(buf, 2000, (short)35, "0.0");

    if((generalUtils.dfsAsStr(buf, (short)41)).length() == 0) // printCount 
      generalUtils.putAlpha(buf, 2000, (short)41, "0.0");
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getRecGivenCode(Connection con, Statement stmt, ResultSet rs, String code, char separator, byte[] data, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    byte[] codeB = new byte[21];
    generalUtils.strToBytes(codeB, code);
    
    return getRecGivenCode(con, stmt, rs, codeB, separator, data, dnm, localDefnsDir, defnsDir, bytesOut);
  }
  public int getRecGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char separator, byte[] data, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM pinvoice WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      if(rs   != null) rs.close();
      if(stmt != null) stmt.close();
    ...
    String fieldTypes = getFieldTypesPurchaseInvoice();
    ...
    {    
      String fieldNames = getFieldNamesPurchaseInvoice();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "pinvoice." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  public String getValue(int colNum, char type, ResultSet rs, ResultSetMetaData rsmd)
  {
    ...
    catch(Exception e)
    {
      try
      {
        System.out.println("PurchaseInvoice: getValue(): " + colNum + " " + rsmd.getColumnType(colNum) + " " + e);
      }
      catch(Exception e2) { }
    }
  ...
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO pinvoice (" + getFieldNamesPurchaseInvoice() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE pinvoice SET " + opStr + " WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
  ...
  public char putRecLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesPurchaseInvoiceL();
      int x=0, count=0;
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO pinvoicel (" + getFieldNamesPurchaseInvoiceL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE pinvoicel SET " + opStr + " WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" 
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM pinvoicel WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" + generalUtils.stringFromBytes(line, 0L) + "'");
      ...
      stmt = con.createStatement();
      stmt.executeUpdate("DELETE FROM pinvoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
  ...
  public byte[] getLines(Connection con, Statement stmt, ResultSet rs, byte[] code, char separator, byte[] linesData, int[] listLen, int[] linesCount, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM pinvoicel WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "pinvoicel." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
  ...
  private int getLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char separator, byte[] data, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    if(code[0] == '\000') // just-in-case
      return -1;
    ...
    rs = stmt.executeQuery("SELECT * FROM pinvoicel WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "pinvoicel." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
                                   ...
                                   String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM pinvoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
                                  ...
                                  String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM pinvoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L)
                                   + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
                                  ...
                                  int[] bytesOut) throws Exception
  {
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ',  ' ', "", "SalesOrderToOrderAcknowledgement", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  }
  ...
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("pinvoice"))
      fieldNames = getFieldNamesPurchaseInvoice();
    else // if(which.equals("pinvoicel"))
      fieldNames = getFieldNamesPurchaseInvoiceL();
    int len = fieldNames.length();
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public void updateGSTRates(Connection con, Statement stmt, ResultSet rs, byte[] code, String gstRate, String unm, String dnm,
                             String localDefnsDir, String defnsDir) throws Exception
  {
    updateDLM(con, stmt, code, unm);
  ...
  public void updatePrices(Connection con, Statement stmt, ResultSet rs, byte[] code, String band, String clear, String unm, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    byte[] rateB = new byte[30];
    getAnInvoiceFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir);
    double rate = generalUtils.doubleFromBytesCharFormat(rateB, 0);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  // uses layout 222d.htm
  public boolean getRecToHTMLDisplayOnly(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, HttpServletRequest req,
                                         byte[] code, String unm, String sid, String uty, String men, String den, String dnm, String bnm,
                                         String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    String imagesDir = directoryUtils.getSupportDirs('I');
    ...
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "PurchaseInvoice", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      return false;
    }
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "222d.htm", 2,
                                     getFieldNamesPurchaseInvoice(), fieldSizesPurchaseInvoice, getFieldNamesPurchaseInvoiceL(), fieldSizesPurchaseInvoiceL,
                                     null, null);

    int recDataLen = generalUtils.lengthBytes(data, 0);

    String fieldNamesPI = getFieldNamesPurchaseInvoice();
    byte[] value     = new byte[1000]; // plenty - to cover notes
    byte[] fieldName = new byte[50];
    int x=0, y, fieldCount=0;
    int len = fieldNamesPI.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesPI.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesPI.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "pinvoice", fieldName, value) != -1) // entry exists
      {
    ...
    String attachments = getAttachments(con, stmt, stmt2, rs, rs2, generalUtils.stringFromBytes(code, 0L), unm, sid, uty, men, den,
                                        dnm, bnm, localDefnsDir, defnsDir);
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "pinvoice.Attachments=" + attachments + "\001");
                               ...
                               String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM pinvoicea WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
                               ...
                               String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "5080", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);

    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Purchase Invoice" + directoryUtils.buildHelp(5080) + "</td></tr></table>";
                                  ...
                                  String defnsDir, int[] hmenuCount) throws Exception
  {
    ...
    if(callingServlet.equals("PurchaseInvoicePage"))
      s += drawOptions5080(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("PurchaseInvoiceHeaderEdit"))      
      s += drawOptions5082(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("PurchaseInvoiceLine"))
      s += drawOptions5084(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5080(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty,
                                 String dnm, String localDefnsDir, String defnsDir) throws Exception
  {      
    String s = "";
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5082, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pinvoice", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:fetch()\">Edit Details</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5084, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pinvoice", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:add()\">Add New Line</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pinvoice", date, unm))
    ...
    if(serverUtils.passLockCheck(con, stmt, rs, "pinvoice", date, unm))
    {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5082(int[] hmenuCount, char cad, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5084(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
  ...
  public void putMultipleLine(Connection con, Statement stmt, ResultSet rs, byte[] code, int line, byte[] descData, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    try
    {
      ...
      stmt.executeUpdate("INSERT INTO pinvoicell (" + getFieldNamesPurchaseInvoiceLL() + ") VALUES ('"
                         + generalUtils.stringFromBytes(code, 0L) + "','" + line + "','" + generalUtils.dfsAsStr(descData, (short)2)  + "','"
                         + opStr + "')");
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private boolean duplicateSupplierInvoiceCodesExist(Connection con, Statement stmt, ResultSet rs, String invoiceCode, String suppInvoiceCode, String companyCode, String[] dupCodes) throws Exception
  {
    if(suppInvoiceCode.length() == 0) return false;
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT InvoiceCode FROM pinvoice WHERE CompanyCode = '" + companyCode + "' AND InvoiceCode != '" + invoiceCode + "' AND SupplierInvoiceCode = '" + generalUtils.sanitiseForSQL(suppInvoiceCode) + "'");

      while(rs.next())
      {
        dupCodes[0] += ("&nbsp;&nbsp;" + rs.getString(1));
        res = true;
      }
