// =======================================================================================================================================================================================================
// System: ZaraStar Document: Invoice Record Access
// Module: salesInvoice.java
// Author: C.K.Harvey
...
public class SalesInvoice
{
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringInvoice() throws Exception
  {  
    return "invoice ( InvoiceCode char(20) not null, Date date not null,         CompanyCode char(20) not null, "
                   ...
                   + "unused6 char(1),               PaymentReference char(20),  LocationCode char(20), "
                   + "DatePaid date,                 ShipAddrCode char(20),      PrintCount integer, "
                   + "Status char(1),                unused7 date,               unused8 date, "
                   + "RevisionOf char(20),           BOMCode char(20),           BaseGSTTotal decimal(19,8), "
                   ...
                   + "PLCode char(20),               Misc3 char(60),             Misc4 char(60), "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsInvoice(String[] s) throws Exception
  {
    s[0] = "invoiceDateInx on invoice (Date)";
    s[1] = "invoiceCompanyCodeInx on invoice (CompanyCode)";
    s[2] = "invoiceDORefNumInx on invoice (DORefNum)";
    s[3] = "invoicePORefNumInx on invoice (PORefNum)";
    s[4] = "invoiceProjectCodeInx on invoice (ProjectCode)";
    
    return 5;
  }
      
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesInvoice() throws Exception
  {  
    return "InvoiceCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
         + "Attention, unused1, DateProcessed, Misc1, Misc2, GSTTotal, TotalTotal, AmountPaid, Settled, Processed, SignOn, "
         + "GroupDiscount, DORefNum, PORefNum, GroupDiscountType, CashOrAccount, DateLastModified, ProjectCode, SalesPerson, "
         + "unused3, unused4, unused5, CommissionPaid, CommissionValue, unused6, PaymentReference, LocationCode, DatePaid , "
         + "ShipAddrCode, PrintCount, Status, unused7, unused8, RevisionOf, BOMCode, BaseGSTTotal, Currency, Rate, ShipName, "
         + "ShipAddress1, ShipAddress2, ShipAddress3, ShipAddress4, ShipAddress5, BaseTotalTotal, PLCode, Misc3, Misc4, Terms, "
         + "ExportStatement, Closed, Reference";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesInvoice() throws Exception
  {
    return "CDCCCCCCCCCCCDDCCFFFCCCFCCCCSCCIFFCFCCCDCICDDCCFCFCCCCCCFCCCCCCC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesInvoice(short[] sizes) throws Exception
  {
    ...
    sizes[49] = 0;   sizes[50] = 60;  sizes[51] = 40;  sizes[52] = 40;  sizes[53] = 40;  sizes[54] = 40;  sizes[55] = 40;
    sizes[56] = 0;   sizes[57] = 20;  sizes[58] = 60;  sizes[59] = 60;  sizes[60] = 20;  sizes[61] = 40;  sizes[62] = 1;
    sizes[63] = 40;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesInvoice() throws Exception
  {
    return "MMMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringInvoiceL() throws Exception
  {  
    return "invoicel ( InvoiceCode char(20) not null, ItemCode char(20) not null,     Description char(80), "
                    ...
                    + "SignOn char(20),               Amount2 decimal(17,8),          SOCode char(20), "
                    + "AccCode char(20),              Hide char(1),                   StockUpdated char(1), "
                    ...
                    + "Category char(40),             ReceivedAmount decimal(17,8),   RefundedAmount decimal(17,8), "
                    ...
                    + "unique(InvoiceCode, Line))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsInvoiceL(String[] s) throws Exception
  {
    s[0] = "invoicelItemCodeInx on invoicel(ItemCode)";
    s[1] = "invoicelSOCodeInx on invoicel(SOCode)";

    return 2;
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesInvoiceL() throws Exception
  {  
    return "InvoiceCode, ItemCode, Description, UnitPrice, Quantity, Amount, GSTRate, Discount, DateLastModified, SignOn, Amount2, SOCode, AccCode, "
         + "Hide, StockUpdated, DateOfStockUpdate, QuantityRequired, CustomerItemCode, UoM, Line, Entry, Category, ReceivedAmount, "
         + "RefundedAmount, AltItemCode, PORefNum, DORefNum, CostPrice, Manufacturer, ManufacturerCode";
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesInvoiceL() throws Exception
  {
    return "CCCFFFCFSCFCCCCDFCCICCFFCCCFCC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesInvoiceL(short[] sizes) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesInvoiceL() throws Exception
  {
    return "OOOOOOOOOOOOOOOOOOOMOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringInvoiceLL() throws Exception
  {  
    return "invoicell ( InvoiceCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), "
                    + "unique(InvoiceCode, Entry, Line))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsInvoiceLL(String[] s) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesInvoiceLL() throws Exception
  {  
    return "InvoiceCode, Entry, Line, Text";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesInvoiceLL() throws Exception
  {
    return "CCIC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesInvoiceLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesInvoiceLL() throws Exception
  {
    return "MMMO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringInvoiceA() throws Exception
  {  
    return "invoicea ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsInvoiceA(String[] s) throws Exception
  {
    s[0]="\0"; // remove compiler warning
    return 0;
  }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesInvoiceA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesInvoiceA() throws Exception
  {
    return "CI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesInvoiceA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesInvoiceA() throws Exception
  {
    return "MM";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public boolean getRecToHTML(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, boolean plain, char dispOrEdit,
                              byte[] code, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String localDefnsDir,
                              String defnsDir, char cad, String errStr, String cashOrNot, byte[] dataAlready, HttpServletRequest req, int[] bytesOut)
                              throws Exception
  {
    ...
    int[] ddlDataLen  = new int[1];  ddlDataLen[0] = 1500;
    ...
    {
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "invoice");
    }
    else // get header data
    {
      if(cad == 'A')
      {
        ...
        {
          messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "SalesInvoice", imagesDir, localDefnsDir, defnsDir, bytesOut);
          return true;
        }
      }
    }
    ...
    if(plain)
    {
      ...
      scoutln(javaScriptCallCode, bytesOut, "_.lineFile=invoicel.line\001_.permitted=n\001");
    }
    else javaScriptCall(con, stmt, rs, javaScriptCallCode, req, date, unm, uty, dnm, localDefnsDir, defnsDir, bytesOut);
    
    short[] fieldSizesInvoice = new short[70]; // plenty
    getFieldSizesInvoice(fieldSizesInvoice);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesInvoiceL = new short[30]; // plenty
      getFieldSizesInvoiceL(fieldSizesInvoiceL);
      ...
      {  
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir,
                                         "288.htm", 2, getFieldNamesInvoice(), fieldSizesInvoice, getFieldNamesInvoiceL(),
                                         fieldSizesInvoiceL, null, null);
      }
      else
      {
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir,
                                         "288a.htm", 1, getFieldNamesInvoice(), fieldSizesInvoice, null, null, null, null);
      }
      ...
      {
        prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), date, "288a.htm", localDefnsDir,
                    defnsDir, prependCode, req, bytesOut);
      }

      screenLayout.bufferToBuffer(buf1, buf2, size1, size2, source, numFields, fieldNames, fieldTypes, fieldSizes, dispOrEdit, 'X', data, 0, ddlData, ddlDataUpto[0],
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        generalUtils.dfsGivenSeparator(true, '\001', headData, (short)26, b);
        ...
        for(x=0;x<linesCount[0];++x)
        {
          if(generalUtils.getListEntryByNum(x, linesData, data)) // just-in-case
          {
            ...
            screenLayout.bufferToBuffer(buf1, buf2, size1, size2, source, numFields, fieldNames, fieldTypes, fieldSizes, 'D', 'L', data,
                                 5000, ddlData, ddlDataUpto[0], javaScriptCallCode, null);
          }
        }
        ...
        stmt.executeUpdate("UPDATE invoice SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " 
                         + totalGSTAmt2Lines + ", BaseTotalTotal = " + (totalAmtLines + totalGSTAmtLines) + ", BaseGSTTotal = "
                         + totalGSTAmtLines + " WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
        stmt.close();
        ...
        scoutln(headData, bytesOut, "invoice.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen
        ...
        scoutln(headData, bytesOut, "invoice.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2', headData, 5000, 49); // rate
        scoutln(headData, bytesOut, "invoice.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)49) + "\001");

        String attachments = getAttachments(con, stmt, stmt2, rs, rs2, generalUtils.stringFromBytes(code, 0L), unm, sid, uty, men, den, dnm, bnm, localDefnsDir,
                                            defnsDir);
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "invoice.Attachments=" + attachments + "\001");
      }
      else // edit
      {
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "invoice.Currency", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
        ddlData = documentUtils.getSalesPersonDDLData(con, stmt, rs, "invoice.SalesPerson", ddlData, ddlDataUpto, ddlDataLen);
        ddlData = documentUtils.getCountryDDLData(con, stmt, rs, "invoice.Country", ddlData, ddlDataUpto, ddlDataLen);
        // combo
        ddlData = profile.getContactDDLData(con, stmt, rs, generalUtils.dfsAsStrGivenBinary1(true, data, (short)2), "invoice.FAO", ddlData, ddlDataUpto, ddlDataLen);
    ...
    {
      numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "288a.htm", 1, getFieldNamesInvoice(), fieldSizesInvoice, null, null, null, null);

      if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not be in the correct order
        sortFields(dataAlready, data, "invoice");
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "invoice", data);

        if(cashOrNot.equals("C"))
          documentUtils.getNextCode(con, stmt, rs, "cashinvoice", true, code);
        else documentUtils.getNextCode(con, stmt, rs, "invoice", true, code);

        generalUtils.repAlphaUsingOnes(data, 5000, "InvoiceCode", generalUtils.stringFromBytes(code, 0L));
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L), date, "288a.htm", localDefnsDir, defnsDir, prependCode, req, bytesOut);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private void javaScriptCall(Connection con, Statement stmt, ResultSet rs, byte[] b, HttpServletRequest req, String date, String unm, String uty,
                              String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=invoicel.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4076, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "invoice", date, unm))
  ...
  {
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4074, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      b[0]= '\000';
      scoutln(b, bytesOut, "<script language=\"JavaScript\">function affect(line){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/SalesInvoiceLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                       ...
                       throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4072, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function fetch(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/SalesInvoiceHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=A&p3=&p4=\");}\n");

      scoutln(b, bytesOut, "function gst(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=I\";}");
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6093, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PricgrChange?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=I\";}");
      }
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6098, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/DocumentChangeDiscounts?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
                           + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=I\";}");
      }
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4074, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/SalesInvoiceLine?unm=" + unm + "&sid=" + sid
    ...
    {
      String projectCode = getAnInvoiceFieldGivenCode(con, stmt, rs, "ProjectCode", code);
      String companyCode = getAnInvoiceFieldGivenCode(con, stmt, rs, "CompanyCode", code);
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/MailExternalUserCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm="
              + dnm + "&p6=C&p4=" + companyCode + "&p5=" + projectCode + "&p1=SalesInvoiceRegisteredUser&p2=" + code2
                         + "&p3=Invoice&bnm=" + bnm + "\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/TrailShow?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=I\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6006, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function audit(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/AccountsWACDerivation?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4077, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControl?unm=" + unm + "&sid=" + sid + "&uty="
                         + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=SalesInvoicePrint&p2=" + code2 + "&p3=\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4185, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/FaxCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men
                         + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=I&p3=SalesInvoicePrint&p4=&p5=Invoice\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 12708, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/ChannelSendDirect?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                         ...
                         + "&p2=Sales_Invoice&p3=Requested%20Sales%20Invoice%20Sent (" + generalUtils.sanitise(code2)+ ")\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11200, unm, uty, dnm, localDefnsDir, defnsDir)
            && authenticationUtils.verifyAccess(con, stmt, rs, req, 4077, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PrintToPDFUtils?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p3=" + code2 + "&p1=0.000&p5=Invoice&p2=SalesInvoicePrint\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4083, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function proinv(){");
      scoutln(b, bytesOut, "var p1='CREATEBASEDONINVOICE:'+'" + code + "';");
      scoutln(b, bytesOut, "this.location.href=\"/central/servlet/ProformaInvoicePage?unm=" + unm + "&sid=" + sid + "&uty=" + uty
                          +"&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=A&p3=&p4=&p1=\"+p1;}");
    }

    scoutln(b, bytesOut, "function plain(){");
    scoutln(b, bytesOut, "window.location.href=\"/central/servlet/SalesInvoicePage?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm="
                       + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=A&p3=&p4=&p6=P\";}\n");
    ...
    outputPageFrame(con, stmt, rs, b, req, plain, ' ', ' ', "", "SalesInvoicePage", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                             ...
                             HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/SalesInvoiceHeaderUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                       + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + cad + "&p2=" + code2 + "&p3=\"+saveStr2+\"&p4=\"+thisOp)}\n");
    ...
    outputPageFrame(con, stmt, rs, b, req, false, ' ', cad.charAt(0), "", "SalesInvoiceHeaderEdit", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut); // combo
                      ...
                      char cad, byte[] recData, int recDataLen, byte[] rtnLineBytes, int[] bytesOut) throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "invoicel", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "invoicel"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesInvoiceL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "invoicel", fieldName, value) != -1) // entry exists
      {
    ...
    if((generalUtils.dfsAsStr(buf, (short)22)).length() == 0) // receivedAmount 
      generalUtils.putAlpha(buf, 2000, (short)22, "0");

    if((generalUtils.dfsAsStr(buf, (short)23)).length() == 0) // refundedAmount
    ...
    if((generalUtils.dfsAsStr(buf, (short)21)).length() == 0) // category
    {
      generalUtils.putAlpha(buf, 2000, (short)21, accountsUtils.getSalesAccCode(accountsUtils.getAccountingYearForADate(con, stmt, rs,
                                                                                                 generalUtils.today(localDefnsDir, defnsDir), dnm,
                                                                                                 localDefnsDir, defnsDir),
                                                                 dnm, localDefnsDir, defnsDir));
    }

    byte[] rateB = new byte[30];
    getAnInvoiceFieldGivenCode(con, stmt, rs, "Rate", code, rateB);
    ...
    if(   searchDataString(recData, recDataLen, "invoicel", fieldName, value) != -1 // exists
       && value[0] != '\000')
    {
    ...
    if(searchDataString(recData, recDataLen, "invoicel", fieldName, value) != -1) // exists
    {
      if(value[0] == '\000') // description fld is blank
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, itemCode, '\000', data) != -1) // exists
        {
          ...
          if(! unitPriceGiven)
          {
            ...
            getAnInvoiceFieldGivenCode(con, stmt, rs, "Currency", code, currency); 
      ...
      else // strip only the first desc line for invoiceL rec
      {
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE invoice SET SignOn = '" + unm + "', DateLastModified = NULL WHERE InvoiceCode = '"
                                     ...
                                     String defnsDir) throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM invoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) 
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE invoicell SET Text = '" + sanitisedDesc + "' WHERE InvoiceCode = '"
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO invoicell (" + getFieldNamesInvoiceLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L)
      ...
      {
        stmt.executeUpdate("DELETE FROM invoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getAnInvoiceFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, String invoiceCode) throws Exception
  {
    byte[] value = new byte[300]; // plenty
    byte[] invoiceCodeB = new byte[21];
    generalUtils.strToBytes(invoiceCodeB, invoiceCode);

    getAnInvoiceFieldGivenCode(con, stmt, rs, fieldName, invoiceCodeB, value);

    return generalUtils.stringFromBytes(value, 0L);
  }
  public void getAnInvoiceFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] invoiceCode, byte[] value) throws Exception
  {
    if(invoiceCode[0] == '\000') // just-in-case
      return;

    generalUtils.toUpper(invoiceCode, 0);

    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT " + fieldName + " FROM invoice WHERE InvoiceCode = '" + generalUtils.stringFromBytes(invoiceCode, 0L) + "'");
    if(! rs.next())
      value[0] = '\000';
                                        ...
                                        byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, layoutFile, 1,
                                     getFieldNamesInvoiceL(), fieldSizesInvoiceL, null, null, null, null);
    ...
    if(line[0] != '\000') // existing line
    {
      if(code[0] != '\000') // just-in-case
      {
        ...
        {                            // be in the correct order
          sortFields(dataAlready, data, "invoicel");
        }
        else
        {
          ...
          generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  data, 2000, 27); // costprice
    ...
    else /// new line
    {
      ...
      {
        data[0]= '\000';
        scoutln(data, bytesOut, "invoicel.entry=" + generalUtils.intToStr(nextLine) + "\001");

        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "invoicel.gstrate=" + gstRateDefault + "\001");
      }
      
      newOrEdit = 'N';
    }

    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "invoicel.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
    ddlData = inventory.getMfrsDDLData(con, stmt, rs, "invoicel.manufacturer", ddlData, ddlDataUpto, ddlDataLen);

    getAnInvoiceFieldGivenCode(con, stmt, rs, "Date", code, b);
    String thisCategory = generalUtils.dfsGivenSeparator(true, '\001', data, (short)21);
    String[] thisAccCodeAndDesc = new String[1];
    ddlData = accountsUtils.getCategoryDDLData(con, stmt, rs, 'S', generalUtils.stringFromBytes(b, 0L), thisCategory, "invoicel.category", dnm, ddlData, ddlDataUpto,
                                       ddlDataLen, localDefnsDir, defnsDir, thisAccCodeAndDesc);
    generalUtils.repAlphaGivenSeparator('\001', data, 2000, (short)21, thisAccCodeAndDesc[0]);

    getAnInvoiceFieldGivenCode(con, stmt, rs, "Currency", code, b);
    scoutln(data, bytesOut, "invoicel.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "invoicel.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(line, 0L),
                    "288b.htm", localDefnsDir, defnsDir, prependCode, newOrEdit, req, bytesOut);
  ...
  private void prependEditLine(Connection con, Statement stmt, ResultSet rs, String unm, String sid, String uty, String men, String den, String dnm, String bnm,
                               String errStr, String cad, String code, String line, String layoutFile, String localDefnsDir, String defnsDir,
                               byte[] b, char newOrEdit, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    String code2 = generalUtils.sanitise(code);
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/SalesInvoiceLineUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1="
    ...
    scoutln(b, bytesOut, "else if(saveStr.charAt(x)=='?')saveStr2+='%3F';\n");
    scoutln(b, bytesOut,
        "else if(escape(saveStr.charAt(x))=='%0A')saveStr2+='\003';\n");
    scoutln(b, bytesOut, "else if(escape(saveStr.charAt(x))=='%0D');");
    scoutln(b, bytesOut, "else saveStr2+=saveStr.charAt(x);return saveStr2;}\n");
    ...
    outputPageFrame(con, stmt, rs, b, req, false, newOrEdit, ' ', "", "SalesInvoiceLine", "", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  ...
  public char putHead(Connection con, Statement stmt, ResultSet rs, byte[] originalCode, String unm, String dnm, String localDefnsDir, String defnsDir, char cad, byte[] recData, int recDataLen, byte[] code, int[] bytesOut) throws Exception
  {
    ...
    generalUtils.catAsBytes("InvoiceCode", 0, str, true);

    if(searchDataString(recData, recDataLen, "invoice", str, code) == 0)
      return 'N';
    ...
    if(searchDataString(recData, recDataLen, "invoice", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "invoice", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "invoice", fldName, date); // assumes exists
    ...
    String fieldNamesInvoice = getFieldNamesInvoice();
    ...
    {
      getFieldName(fieldNamesInvoice, x, fldName);
      if(searchDataString(recData, recDataLen, "invoice", fldName, value) != -1) // entry exists
      {
        if(value[0] != '\000')
    ...
    String cashOrAccount = "A";
    generalUtils.strToBytes(fldName, "CashOrAccount");
    if(searchDataString(recData, recDataLen, "invoice", fldName, value) != -1) // entry exists
      cashOrAccount = generalUtils.stringFromBytes(value, 0L); 
    
    len = fieldNamesInvoice.length();
    int x=0, y, fieldCount=0;
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesInvoice.charAt(x) != ',')
        fldName[y++] = (byte)fieldNamesInvoice.charAt(x++);
      fldName[y] = '\000';
      ++x;
    ...
    generalUtils.putAlpha(buf, 2000, (short)36, "0");
    ...
    if(rtn == ' ') // head saved ok
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        searchDataString(recData, recDataLen, "invoice", fldName, value);
        byte[] value2 = new byte[21];
        generalUtils.strToBytes(fldName, "DOCode");
        searchDataString(recData, recDataLen, "invoice", fldName, value2);
        serverUtils.syncToIW(con, generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(value, 0L), generalUtils.stringFromBytes(value2, 0L), 'I', generalUtils.todaySQLFormat(localDefnsDir, defnsDir), unm, companyCode, dnm);
      }
      else serverUtils.updateNewWavechannelsRec(con, stmt, rs, generalUtils.stringFromBytes(code, 0L), "I", companyCode);
    }
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getRecGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char separator, byte[] data, String dnm, String localDefnsDir,
                             String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM invoice WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      rs.close();
      stmt.close();
    ...
    String fieldTypes = getFieldTypesInvoice();
    ...
    {    
      String fieldNames = getFieldNamesInvoice();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "invoice." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir,
                                  String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO invoice (" + getFieldNamesInvoice() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE invoice SET " + opStr + " WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
  ...
  public char putRecLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesInvoiceL();
      int x=0, count=0;
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO invoicel (" + getFieldNamesInvoiceL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE invoicel SET " + opStr + " WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" 
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM invoicel WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" + generalUtils.stringFromBytes(line, 0L)
                       + "'");
      ...
      stmt.executeUpdate("DELETE FROM invoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L)
                       + "'");
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM invoicel WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "invoicel." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "invoicel." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
                                   ...
                                   String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM invoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
                                ...
                                int[] linesCount) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM invoicell WHERE InvoiceCode = '" + generalUtils.stringFromBytes(code, 0L)
                                   + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
                                  ...
                                  throws Exception
  {
    ...
    scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PrintToPDFUtils?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                       + "&dnm=" + dnm + "&bnm=" + bnm + "&p3=" + code2 + "&p1=0.000&p5=Invoice&p2=SalesInvoicePrint\";}");

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4077, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function print(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControl?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                         + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=SalesInvoiceRegisteredUser&p2=" + code2 + "&p3=\";}");
    }
    ...
    outputPageFrame(con, stmt, rs, b, req, false, ' ',  ' ', "", "SalesInvoiceRegisteredUser", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  }
  ...
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("invoice"))
      fieldNames = getFieldNamesInvoice();
    else // if(which.equals("invoicel"))
      fieldNames = getFieldNamesInvoiceL();
    int len = fieldNames.length();
                                         ...
                                         throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "288d.htm", 2,
                                     getFieldNamesInvoice(), fieldSizesInvoice, getFieldNamesInvoiceL(), fieldSizesInvoiceL, null, null);
    ...
    int x=0, y, fieldCount=0;
    int len = fieldNamesInvoice.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesInvoice.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesInvoice.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "invoice", fieldName, value) != -1) // entry exists
      {
    ...
    generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  data, 3000, 47);
    generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  data, 3000, 56);
    ...
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "invoice.Attachments=" + attachments + "\001");
                               ...
                               throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM invoicea WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void outputPageFrame(Connection con, Statement stmt, ResultSet rs, byte[] b, HttpServletRequest req, boolean plain, char newOrEdit, char cad, String bodyStr, String callingServlet, String date, String unm, String sid, String uty,
                               String men, String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    int[] hmenuCount = new int[1];

    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "4067", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);
   
    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Sales Invoice" + directoryUtils.buildHelp(4067) + "</td></tr></table>";
                                  ...
                                  String bnm, String localDefnsDir, String defnsDir, int[] hmenuCount) throws Exception
  {
    ...
    if(callingServlet.equals("SalesInvoicePage"))
      s += drawOptions4067(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("SalesInvoiceHeaderEdit"))      
      s += drawOptions4072(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("SalesInvoiceLine"))      
      s += drawOptions4074(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
    else
    if(callingServlet.equals("SalesInvoiceRegisteredUser"))
      s += drawOptions4124(con, stmt, rs, req, hmenuCount, unm, uty, dnm, localDefnsDir, defnsDir);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4067(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {      
    String s = "";
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4072, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "invoice", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:fetch()\">Edit Details</a></dt></dl>\n";
  
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4074, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "invoice", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:add()\">Add New Line</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "invoice", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:attach()\">Attachments</a></dt></dl>\n";

    boolean SalesInvoicePrint  = authenticationUtils.verifyAccess(con, stmt, rs, req, 4077, unm, uty, dnm, localDefnsDir, defnsDir);
    boolean _4185  = authenticationUtils.verifyAccess(con, stmt, rs, req, 4185, unm, uty, dnm, localDefnsDir, defnsDir);
    ...
    if(SalesInvoicePrint || _4185 || MailExternalUserCreate || PrintToPDFUtils || ChannelSendDirect)
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0] + "');\">Send</dt><dd id='hmenu" + hmenuCount[0]++ + "'><ul>";
      if(SalesInvoicePrint)
    ...
    if(serverUtils.passLockCheck(con, stmt, rs, "invoice", date, unm))
    {
      ...
      {
        s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0] + "');\">Change</dt>";
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4083, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      s += "<li><a href=\"javascript:proinv()\">Proforma Invoice</a></li></ul></dd></dl>";
    }
    ...
    boolean TrailShow = authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir);
    boolean AccountsWACDerivation = authenticationUtils.verifyAccess(con, stmt, rs, req, 6006, unm, uty, dnm, localDefnsDir, defnsDir);

    if(TrailShow || AccountsWACDerivation)
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0] + "');\">Trail</dt><dd id='hmenu" + hmenuCount[0]++ + "'><ul>";
      if(TrailShow)
        s += "<li><a href=\"javascript:trail()\">User</a></li>";
      if(AccountsWACDerivation)
        s += "<li><a href=\"javascript:audit()\">Audit</a></li>";
      s += "</ul></dd></dl>\n";
    }
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4072(int[] hmenuCount, char cad, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm) throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4074(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4124(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String unm, String uty, String dnm,
                                 String localDefnsDir, String defnsDir) throws Exception
  {      
    boolean SalesInvoicePrint = authenticationUtils.verifyAccess(con, stmt, rs, req, 4077,  unm, uty, dnm, localDefnsDir, defnsDir);
