...
public class WikiStylingProcessWave extends HttpServlet
{
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private boolean updateStyling(String headerLogo, String plainLogo, String footerText, String pageHeaderImage1, String pageHeaderImage2, String pageHeaderImage3, String pageHeaderImage4, String pageHeaderImage5, String dnm) throws Exception
  {
    Connection con = null;
    Statement stmt = null;
  ...
  {
    URL url = new URL("http://" + serverUtils.serverToCall("OFSA", localDefnsDir) + "/central/servlet/WikiStylingEditWave?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + generalUtils.sanitise(styleName) + "&p2="
                    + source + "&bnm=" + bnm);
