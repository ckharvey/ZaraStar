// =======================================================================================================================================================================================================
// System: ZaraStar: Product: Search stock file
// Module: ProductWordSearchFile.java
// Author: C.K.Harvey
...
public class ProductWordSearchFile extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ProductWordSearchFile", bytesOut);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private byte[] process(Connection con, Statement stmt, ResultSet rs, String grOptions, String phrase, String unm, String uty, byte[] list, int[] listLen, int[] lenListEntries, long[] totalMilliSeconds) throws Exception
  {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private byte[] set(Connection con, Statement stmt, ResultSet rs, String whichType, String phrase, String unm, String uty, byte[] list, int[] listLen, int[] lenListEntries, long[] totalMilliSeconds) throws Exception
  {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private byte[] search(Connection con, Statement stmt, ResultSet rs, String whichType, String phrase, String unm, String uty, byte[] list, int[] listLen, int[] lenListEntries, long[] totalMilliSeconds) throws Exception
  {
    long startTime = new java.util.Date().getTime();
    ...
    String where = "";
    if(uty.equals("A") || (uty.equals("R") && unm.endsWith("_")))
    ...
    while(x < len)
    {
      ...
      rs = stmt.executeQuery("SELECT ItemCode FROM stock WHERE " + where + "( Description LIKE '%" + word + "%' OR Description2 LIKE '%" + word + "%' OR ItemCode LIKE '%" + word + "%' OR Manufacturer LIKE '%" + word
