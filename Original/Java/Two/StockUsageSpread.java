// =======================================================================================================================================================================================================
// System: ZaraStar Product: Stock usage spread for a mfr 
// Module: StockUsageSpread.java
// Author: C.K.Harvey
...
public class StockUsageSpread extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "StockUsageSpread", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 3014, bytesOut[0], 0, "ERR:");
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den,
                    String dnm, String bnm, int[] bytesOut) throws Exception
   {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "3014", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 3014, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "3014", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 3014, bytesOut[0], 0, "SID:");
    ...
    set(con, stmt, rs, out, req, unm, sid, uty, men, den, dnm, bnm, imagesDir, reportsDir, localDefnsDir, defnsDir, bytesOut);
      ...
      serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 3014, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
                   ...
                   int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "window.location.href='/central/servlet/StockUsageSpreadExecute?unm=" + unm + "&sid=" + sid + "&uty="
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "3014", "", "StockUsageSpread", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
                                
    scoutln(out, bytesOut, "<form>");
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Stock Usage Spread for a Manufacturer", "3014",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
