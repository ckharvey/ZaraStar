...
public class StoreStoreMove extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "StoreStoreMove", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 3071, bytesOut[0], 0, "ERR:");
                    ...
                    throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 3071, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3071, bytesOut[0], 0, "ACC:");
    ...
    if(! serverUtils.checkSID(unm, sid, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3071, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 3071, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
                   ...
                   String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/StoreStoreMoveExecute?&p1=\"+date+\"&p2=\"+remark+\"&p3=\"+storeFrom+\"&p4=\"+storeTo+\"&unm=" + unm
    ...
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=3><p>Create Stock Adjustment records; effectively moving items currently in <i>From Store</i> to <i>To Store</i>.</td></tr>");

    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>From Store</td><td><p>");
    scoutln(out, bytesOut, documentUtils.getStoresDDL(con, stmt, rs, "storeFrom"));
    scoutln(out, bytesOut, "</span></td></tr>");
    
    scoutln(out, bytesOut, "<tr><td><p>To Store</td><td><p>");
    scoutln(out, bytesOut, documentUtils.getStoresDDL(con, stmt, rs, "storeTo"));
    scoutln(out, bytesOut, "</span></td></tr>");
    
    scoutln(out, bytesOut, "<tr><td nowrap><p>Date</td><td><p><input type=text maxlength=10 size=10 name=date></td></tr>");
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td nowrap><p>Remark</td><td><p><input type=text maxlength=60 size=60 name=remark></td></tr>");

    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td><p><a href=\"javascript:create()\">Create</a> Stock Adjustment Records</td></tr>");
