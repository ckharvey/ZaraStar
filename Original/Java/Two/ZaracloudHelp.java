// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Create Zaracloud_scbs help table
// Module: ZaracloudHelp.java
// Author: C.K.Harvey
...
public class ZaracloudHelp extends HttpServlet
{
  ...
  private boolean createTable() throws Exception
  {
    ...
    try
    {
      ...
      q = "CREATE TABLE help ( Service integer not null, PageCode char(80), PageType char(1), PageTitle char(80) )";
