...
public class WikiStylingEdit extends HttpServlet
{
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Site: Styling</title>");
    ...
    dashboardUtils.drawTitle(out, "Site Styling for " + styleName, "7081", unm, sid, uty, men, den, dnm, bnm, bytesOut);

    scoutln(out, bytesOut, "<form action=\"WikiStylingProcess\" enctype=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    scoutln(out, bytesOut, "<tr bgcolor='darkgray'><td><p>Width</td><td colspan=5><p><input type='text' name='outerWidth' size='4' maxlength='4' value='"
                         + outerWidth + "'> pixels</td></tr>");
    ...
    /* div#headerrepeat { font-size: 19px; font-family: courier; font-style: italic; font-weight: normal; text-align: center; height: 60px; color: orange;
                          background-image: url("http://www.xxx.com/Zara/xxx/Website Images/cfrepeat.png"); } */
    ...
    /* div#footer { padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; 
                    ...
                    background-color: orange; color: darkblue; text-align: center; 
                    font-weight: normal; font-size: 10px; font-family: courier,Verdana,Arial,Helvetica,sans-serif; } */
  ...
  private String getEntry(String entry, String elementToFind, boolean stripTrailing) throws Exception
  {
    ...
    // background-image: url("http://www.xxx.com/Zara/xxx/Website Images/cfwatermark.png");
    if(t.startsWith("url"))
    {
      x = t.length() - 1;
