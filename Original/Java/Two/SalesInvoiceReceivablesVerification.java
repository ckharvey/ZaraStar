...
// Module: SalesInvoiceReceivablesVerification.java
// Author: C.K.Harvey
...
public class SalesInvoiceReceivablesVerification extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3072, bytesOut[0], 0, "ERR:");
                    ...
                    throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 3072, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3072, bytesOut[0], 0, "ACC:");
    ...
    if(! serverUtils.checkSID(unm, sid, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3072, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 3072, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
                   ...
                   String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/SalesInvoiceReceivablesVerificationExecute?p1=\"+p1+\"&unm=" + unm + "&uty=" + uty + "&sid=" + sid + "&men=" + men + "&den="
                         + den + "&dnm=" + dnm + "&bnm=" + bnm + "\";}");
    ...
    scoutln(out, bytesOut, "<tr><td nowrap><p>Sales Invoices dated up to &nbsp;&nbsp;<input type=text maxlength=10 size=10 name=dateTo></td></tr>");
