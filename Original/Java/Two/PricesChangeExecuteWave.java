...
public class PricesChangeExecuteWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "6093", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "6093", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "function go(band){var clear;if(document.forms[0].clear.checked)clear='Y';else clear='N';getHTML('PricesChangeExecutew','&p1=" + generalUtils.sanitise(docCode) + "&p2=" + generalUtils.sanitise(docType) + "&p3='+band+'&p4='+clear);}");
    ...
    drawingUtils.drawTitleW(out, false, false, "PricgrChange", "", "Documents - Prices Change", "6093", "", "", bytesOut);
