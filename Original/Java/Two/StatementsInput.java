...
public class StatementsInput extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "StatementsInput", bytesOut);
                    ...
                    String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "1012a", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "1012a", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Statements of Account Report Parameters</title>");
    ...
    scoutln(out, bytesOut, "window.location.href='/central/servlet/StatementsGenerate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men
    ...
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Statements of Account Generation", "1012",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
