// =======================================================================================================================================================================================================
// System: ZaraStar Analytic: sales invoice listing enquiry by month - calculate bottomline
// Module: SalesInvoiceListingCalc.java
// Author: C.K.Harvey
...
public class SalesInvoiceListingCalc extends HttpServlet
{
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("1033b: " +e);
//      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "SalesInvoiceListingCalc", bytesOut);
                        ...
                        String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT TotalTotal, Currency, CashOrAccount FROM invoice WHERE " + cashOrAccountStr
                                   + "Status != 'C' && Date >= {d '" + dateFrom + "'} AND Date <= {d '" + dateTo + "'} ORDER BY CompanyCode, Date");
