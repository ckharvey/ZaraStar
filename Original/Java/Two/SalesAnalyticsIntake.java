// =======================================================================================================================================================================================================
// System: ZaraStar: Sales Analytics: Intake
// Module: SalesAnalyticsIntake.java
// Author: C.K.Harvey
...
public class SalesAnalyticsIntake extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 120, unm, uty, dnm, localDefnsDir, defnsDir))
    {
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Sales: Intake</title>");
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "1200", "", "SalesAnalyticsIntake", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    scoutln(out, bytesOut, "<form>");

    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Sales: Intake", "1200",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "</td><td width=70%><span id=\"service\">&nbsp;&nbsp;&nbsp;<a href=\"javascript:help('1200')\">(Service 1200)</a></span></td></tr>");
