...
public class RATSaveIssue extends HttpServlet
{
                    ...
                    String closedByUser, String isPrivate, String dateTime, String service, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "RATSaveIssue", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "RATSaveIssue", imagesDir, localDefnsDir, defnsDir, bytesOut);
