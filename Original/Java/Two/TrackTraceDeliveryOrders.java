// =======================================================================================================================================================================================================
// System: ZaraStar: TNT: DOs
// Module: TrackTraceDeliveryOrders.java
// Author: C.K.Harvey
...
public class TrackTraceDeliveryOrders extends HttpServlet
{
                    ...
                    String bnm, String p1, int[] bytesOut) throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 2026, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 2026, bytesOut[0], 0, "ACC:");
    ...
    if(! serverUtils.checkSID(unm, sid, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 2026, bytesOut[0], 0, "SID:");
      if(con  != null) con.close();
      if(out != null) out.flush(); 
      return;
    }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String customerCode, String unm, String sid, String uty, String men,
                   String den, String dnm, String bnm, String imagesDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "2026", "", "TrackTraceDeliveryOrders", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    scoutln(out, bytesOut, "<form action=\"TrackTraceDeliveryOrdersa\" name=options enctype=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Track &amp; Trace: Delivery Orders", "2026", unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "<tr><td colspan=5><p>This service provides a range of options for searching Delivery Orders.</i>");
    ...
    scoutln(out, bytesOut, "<tr><td colspan=5><p>1. Provide a <i>Delivery Order Code</i>, to process one specific Delivery Order.</td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td nowrap><p>Delivery Order Code</td>");
    scoutln(out, bytesOut, "<td><p><input type=text maxlength=20 size=20 name=doCode></td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=2><p><a href=\"javascript:search(1)\">Fetch</a> the Delivery Order</td></tr>");

    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=5><hr></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=5><p>2. Provide an <i>Item Code</i>, to process all Delivery Orders that contain that stock item.</td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    ...
    scoutln(out, bytesOut, "<tr><td nowrap><p>Not-Returned Only</td><td nowrap><p><input type=checkbox name=osOnly1 checked></td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=2><p><a href=\"javascript:search(2)\">Search</a> for matching Delivery Order</td></tr>");

    if(customerCode.length() == 0) // not called with a known custCode
    {
      scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
      scoutln(out, bytesOut, "<tr><td colspan=5><hr></td></tr>");
      scoutln(out, bytesOut, "<tr><td colspan=5><p>3. Provide a <i>Customer Code</i>, to process all Delivery Orders for that Customer.</td></tr>");
      scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
...
//      scoutln(out, bytesOut, "<td><p>&nbsp; (optional)</td></tr>");
      ...
      scoutln(out, bytesOut, "&nbsp; (optional)</td></tr>");
    scoutln(out, bytesOut, "<tr><td nowrap><p>Not-Returned Only</td><td nowrap><p><input type=checkbox name=osOnly2 checked></td></tr>");
      scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
      scoutln(out, bytesOut, "<tr><td colspan=2><p><a href=\"javascript:search(3)\">Search</a> for matching Delivery Orders</td></tr>");
    }
    
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=5><hr></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=5><p>4. Provide a <i>Date Range</i>, to process all Delivery Orders within that range.</td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td nowrap><p>SalesPerson</td><td><p>" + getSalesPeople(con, stmt, rs, "salesPerson4") + "</td></tr>");
    ...
    scoutln(out, bytesOut, "<td><p>&nbsp; (optional)</td></tr>");
    scoutln(out, bytesOut, "<tr><td nowrap><p>Not-Returned Only</td><td nowrap><p><input type=checkbox name=osOnly3 checked></td></tr>");
    scoutln(out, bytesOut, "<tr><td nowrap><p>Not-Invoiced Only</td><td nowrap><p><input type=checkbox name=osOnly3a checked></td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=2><p><a href=\"javascript:search(4)\">Search</a> for matching Delivery Orders</td></tr>");
        
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=5><hr></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=5><p>5. Provide a <i>Date Range</i>, to process all Delivery Orders within that range; ");
    scoutln(out, bytesOut, "listing Delivery Order lines.</td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    ...
    scoutln(out, bytesOut, "<td><p>&nbsp; (optional)</td></tr>");
    scoutln(out, bytesOut, "<tr><td nowrap><p>Not-Returned Only</td><td nowrap><p><input type=checkbox name=osOnly4 checked></td></tr>");
    scoutln(out, bytesOut, "<tr><td><img src=\"" + imagesDir + "z402.gif\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=2><p><a href=\"javascript:search(5)\">Search</a> for matching Delivery Orders</td></tr>");
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private String getSalesPeople(Connection con, Statement stmt, ResultSet rs, String name) throws Exception
  {
