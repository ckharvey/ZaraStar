// =======================================================================================================================================================================================================
// System: ZaraStar RAT Categories - delete
// Module: RATCategoriesDelete.java
// Author: C.K.Harvey
...
public class RATCategoriesDelete extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 5907b: " + e));
      res.getWriter().write("Unexpected System Error: 5907b");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String code, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 5907b";
  ...
  private boolean deleteRec(String dnm, String name) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM ratcat WHERE Name = '" + generalUtils.sanitiseForSQL(name) + "'");
