...
// Module: PurchaseInvoicePayablesVerification.java
// Author: C.K.Harvey
...
public class PurchaseInvoicePayablesVerification extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3073, bytesOut[0], 0, "ERR:");
                    ...
                    throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 3073, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3073, bytesOut[0], 0, "ACC:");
    ...
    if(! serverUtils.checkSID(unm, sid, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3073, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 3073, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Purchase Invoice Payables Verification</title>");

    scoutln(out, bytesOut, "<script language=\"JavaScript\">");
  
    scoutln(out, bytesOut, "function go(){var p1=document.forms[0].dateTo.value;");
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/PurchaseInvoicePayablesVerificationExecute?p1=\"+p1+\"&unm=" + unm + "&uty=" + uty + "&sid=" + sid + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\";}");
    ...
    scoutln(out, bytesOut, "<tr><td nowrap><p>Purchase Invoices dated up to &nbsp;&nbsp;<input type=text maxlength=10 size=10 name=dateTo></td></tr>");
