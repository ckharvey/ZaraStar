// =======================================================================================================================================================================================================
// System: ZaraStar Text: delete directory
// Module: TextDeleteDirectory.java
// Author: C.K.Harvey
...
public class TextDeleteDirectory extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "TextDeleteDirectory", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 6109, bytesOut[0], 0, "ERR:" + p1);
                      ...
                      String den, String dnm, String bnm, String p1, String p2, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "TextDeleteDirectory", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 6109, bytesOut[0], 0, "ACC:" + p1);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "TextDeleteDirectory", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 6109, bytesOut[0], 0, "SID:" + p1);
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 6109, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), p1);
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String p1, String p2, String unm, String sid, String uty,
                     String men, String den, String dnm, String bnm, String imagesDir, String textLibraryDir, String localDefnsDir,
                     String defnsDir, int[] bytesOut) throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Text Library: Delete Directory</title>");
    ...
    textUtils.outputPageFrame(con, stmt, rs, out, req, "TextDeleteDirectory", "6109", unm, sid, uty, men, den, dnm, bnm, "", "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    textUtils.drawTitle(con, stmt, rs, out, req, false, "", "Delete Directory", "6109", unm, sid, uty, men, den, dnm, bnm, hmenuCount, localDefnsDir, defnsDir, bytesOut);

    scoutln(out, bytesOut, "<FORM ACTION=\"TextDeleteDirectoryExecute\" ENCTYPE=\"application/x-www-form-urlencoded\" METHOD=POST>");
    ...
    scoutln(out, bytesOut, "<tr><td colspan=2><span id=\"textErrorLarge\">WARNING: This operation will delete the stated directory ("
              + p1.substring(len) + ") PLUS do the same for all directories and files contained under that directory!</span></td></tr>");
