// =======================================================================================================================================================================================================
// System: ZaraStar DocumentEngine: CN Record Access
// Module: salesSalesCreditNote.java
// Author: C.K.Harvey
...
public class SalesCreditNote
{
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringSalesCreditNote() throws Exception
  {  
    return "credit ( CNCode char(20) not null,    Date date not null,        CompanyCode char(20) not null, "
                  ...
                  + "unused3 char(20),            RevisionOf char(20),       BaseTotalTotal decimal(19,8), "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsSalesCreditNote(String[] s) throws Exception
  {
    s[0] = "creditDateInx on credit (Date)";
    s[1] = "creditCompanyCodeInx on credit (CompanyCode)";
    s[2] = "creditProjectCodeInx on credit (ProjectCode)";
    
    return 3;
  }
      
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesSalesCreditNote() throws Exception
  {  
    return "CNCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
         + "Attention, Misc1, Misc2, GSTTotal, TotalTotal, Processed, DateProcessed, SignOn, unused1, unused2, Closed, Status, "
         + "DateLastModified, ProjectCode, BaseGSTTotal, unused3, RevisionOf, BaseTotalTotal, Currency, Rate, DateIssued, "
         + "GroupDiscount, GroupDiscountType, PrintCount";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesSalesCreditNote() throws Exception
  {
    return "CDCCCCCCCCCCCCCFFCDCCCCCSCFCCFCFDFCI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesSalesCreditNote(short[] sizes) throws Exception
  {
    ...
    sizes[21] = 20;  sizes[22] = 1;   sizes[23] = 1;   sizes[24] = -1;  sizes[25] = 20;  sizes[26] = 0;   sizes[27] = 20;
    sizes[28] = 20;  sizes[29] = 0;   sizes[30] = 3;   sizes[31] = 0;   sizes[32] = 0;   sizes[33] = 0;   sizes[34] = 1;
    sizes[35] = 0;   
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesSalesCreditNote() throws Exception
  {
    return "MMMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringSalesCreditNoteL() throws Exception
  {  
    return "creditl ( CNCode char(20) not null, ItemCode char(20) not null, Description char(80), "
                   ...
                   + "Entry char(6),            CostOfSaleAdjustment char(1), InvoiceCode char(20), "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsSalesCreditNoteL(String[] s) throws Exception
  {
    s[0] = "creditlItemCodeInx on creditl(ItemCode)";
    
    return 1;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesSalesCreditNoteL() throws Exception
  {  
    return "CNCode, ItemCode, Description, UnitPrice, Quantity, Amount, GSTRate, SignOn, AccCode, AppliedStatus, Amount2, "
         + "DateLastModified, Discount, CustomerItemCode, Line, Entry, CostOfSaleAdjustment, InvoiceCode, InvoiceLine, Category, "
         + "EffectiveDateFrom, EffectiveDateTo, UoM, Manufacturer, ManufacturerCode";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesSalesCreditNoteL() throws Exception
  {
    return "CCCFFFCCCCFSFCICCCICDDCCC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesSalesCreditNoteL(short[] sizes) throws Exception
  {
    ...
    sizes[14] = 0;  sizes[15] = 6;   sizes[16] = 1;  sizes[17] = 20;  sizes[18] = 0;   sizes[19] = 40;  sizes[20] = 0;
    sizes[21] = 0;  sizes[22] = 20;  sizes[23] = 30; sizes[24] = 60;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesSalesCreditNoteL() throws Exception
  {
    return "OOOOOOOOOOOOOOMOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringSalesCreditNoteLL() throws Exception
  {  
    return "creditll ( CNCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), "
                    + "unique(CNCode, Entry, Line))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsSalesCreditNoteLL(String[] s) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesSalesCreditNoteLL() throws Exception
  {  
    return "CNCode, Entry, Line, Text";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesSalesCreditNoteLL() throws Exception
  {
    return "CCIC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesSalesCreditNoteLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesSalesCreditNoteLL() throws Exception
  {
    return "MMMO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringSalesCreditNoteA() throws Exception
  {  
    return "credita ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsSalesCreditNoteA(String[] s) throws Exception
  {
    s[0] = "\000"; // remove compiler warning
    return 0;
  }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesSalesCreditNoteA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesSalesCreditNoteA() throws Exception
  {
    return "CI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesSalesCreditNoteA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesSalesCreditNoteA() throws Exception
  {
    return "MM";
  }
                              ...
                              String defnsDir, char cad, String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    {
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "credit");
    }
    ...
    if(plain)
    {
      ...
      scoutln(javaScriptCallCode, bytesOut, "_.lineFile=creditl.line\001_.permitted=n\001");
    }
    else javaScriptCall(con, stmt, rs, javaScriptCallCode, req, date, unm, uty, dnm, localDefnsDir, defnsDir, bytesOut);

    short[] fieldSizesSalesCreditNote = new short[70]; // plenty
    getFieldSizesSalesCreditNote(fieldSizesSalesCreditNote);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesSalesCreditNoteL = new short[30]; // plenty
      getFieldSizesSalesCreditNoteL(fieldSizesSalesCreditNoteL);
      ...
      if(dispOrEdit == 'D')
      {  
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "272.htm", 2,
                                         getFieldNamesSalesCreditNote(), fieldSizesSalesCreditNote, getFieldNamesSalesCreditNoteL(), fieldSizesSalesCreditNoteL, null,
                                         null);
      }
      else
      {
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "272a.htm", 1,
                                         getFieldNamesSalesCreditNote(), fieldSizesSalesCreditNote, null, null, null, null);
      }
      ...
      {
        prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), date, "272a.htm", localDefnsDir,
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        for(x=0;x<linesCount[0];++x)
        {
          if(generalUtils.getListEntryByNum(x, linesData, data)) // just-in-case
          {
            ...
            if(z < 10) // just-in-case
            {
              ...
              {
                gstRates[z]         = gstRate;
                gstTotalsBase[z]    +=  generalUtils.doubleDPs((amt  * gstRate), '2');
                gstTotalsNonBase[z] +=  generalUtils.doubleDPs((amt2 * gstRate), '2');
              }
              else
              {
                gstTotalsBase[z]    +=  generalUtils.doubleDPs((amt  * gstRates[z]), '2');
                gstTotalsNonBase[z] +=  generalUtils.doubleDPs((amt2 * gstRates[z]), '2');
              }
            }
        ...
        stmt.executeUpdate("UPDATE credit SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " 
                         + totalGSTAmt2Lines + ", BaseTotalTotal = " + (totalAmtLines + totalGSTAmtLines) + ", BaseGSTTotal = "
                         + totalGSTAmtLines + " WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
        stmt.close();
        ...
        scoutln(headData, bytesOut, "credit.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen
        ...
        scoutln(headData, bytesOut, "credit.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 31); // rate
        scoutln(headData, bytesOut, "credit.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)31) + "\001");
        ...
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "credit.Attachments=" + attachments + "\001");
      }
      else // edit
      {
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "credit.Currency", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
    ...
    else // a new layout
    {
      ...
      if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not be in the correct order
        sortFields(dataAlready, data, "credit");
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "credit", data);

        documentUtils.getNextCode(con, stmt, rs, "cn", true, code);

        generalUtils.repAlphaUsingOnes(data, 5000, "CNCode", generalUtils.stringFromBytes(code, 0L));
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L), date, "272a.htm", localDefnsDir, defnsDir,
                  prependCode, req, bytesOut);

      screenLayout.bufferToBuffer(buf1, buf2, size1, size2, source, numFields, fieldNames, fieldTypes, fieldSizes, 'E', 'H', data, 5000, ddlData, ddlDataUpto[0],
                           javaScriptCode, prependCode);
  ...
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=creditl.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4107, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "credit", date, unm))
                          ...
                          String den, String dnm, String bnm, byte[] b, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4105, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/SalesCreditNoteLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                       ...
                       throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4103, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function fetch(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/SalesCreditNoteHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty="
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty="
                       + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=CN\";}");
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6098, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/DocumentChangeDiscounts?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
                           + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=CN\";}");
      }
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4105, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/SalesCreditNoteLine?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=&p3=&p4=\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 8016, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/MailExternalUserCreate?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=SalesCreditNotePage&p2=" + code2
                         + "&p3=Credit%20Note&bnm=" + bnm + "\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4108, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControl?unm=" + unm + "&sid=" + sid + "&uty="
                          + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=SalesCreditNotePrint&p2=" + code2
                          + "&p3=\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/TrailShow?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=C\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4187, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/FaxCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=C&p5=Credit%20Note&p4=&p3=SalesCreditNotePrint\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11200, unm, uty, dnm, localDefnsDir, defnsDir) && authenticationUtils.verifyAccess(con, stmt, rs, req, 4108, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function pdf(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PrintToPDFUtils?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p3=" + code2 + "&p1=0.000&p5=CreditNote&p2=SalesCreditNotePrint\";}");
    }

    scoutln(b, bytesOut, "function plain(){");
    scoutln(b, bytesOut, "window.location.href=\"/central/servlet/SalesCreditNotePage?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm="
    ...
    outputPageFrame(con, stmt, rs, b, req, plain, ' ', ' ', "", "SalesCreditNotePage", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                           ...
                           HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/SalesCreditNoteHeaderUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
    ...
    outputPageFrame(con, stmt, rs, b, req, false, ' ', cad.charAt(0), "", "SalesCreditNoteHeaderEdit", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      char cad, byte[] recData, int recDataLen, byte[] rtnLineBytes, int[] bytesOut) throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "creditl", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "creditl"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesSalesCreditNoteL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "creditl", fieldName, value) != -1) // entry exists
      {
        if(fieldCount == 1) // itemCode
          itemCodeIn = generalUtils.stringFromBytes(value, 0L);
        else
        if(fieldCount == 23) // mfr
    ...
    if((generalUtils.dfsAsStr(buf, (short)16)).length() == 0) // ReturnedStock
      generalUtils.putAlpha(buf, 2000, (short)16, "N");
    ...
    {
      generalUtils.putAlpha(buf, 2000, (short)19, accountsUtils.getSalesReturnedAccCode(accountsUtils.getAccountingYearForADate(con, stmt, rs, generalUtils.today(localDefnsDir, defnsDir), dnm, localDefnsDir, defnsDir),
                                                                         dnm, localDefnsDir, defnsDir));
    }

    byte[] rateB = new byte[30];
    getASalesCreditNoteFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir); // getCurrencyRateGivenCode
    ...
    if(   searchDataString(recData, recDataLen, "creditl", fieldName, value) != -1 // exists
       && value[0] != '\000')
    {
    ...
    if(searchDataString(recData, recDataLen, "creditl", fieldName, value) != -1) // exists
    {
      if(value[0] == '\000') // description fld is blank
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, itemCode, '\000', data) != -1) // exists
        {
          ...
          if(! unitPriceGiven)
          {
            ...
            getASalesCreditNoteFieldGivenCode(con, stmt, rs, "Currency", code, currency, dnm, localDefnsDir, defnsDir); 
      ...
      else // strip only the first desc line for creditL rec
      {
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE credit SET SignOn = '" + unm + "', DateLastModified = NULL WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    stmt.close();
  }
                                     ...
                                     String defnsDir) throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM creditll WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) 
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE creditll SET Text = '" + sanitisedDesc + "' WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L)
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO creditll (" + getFieldNamesSalesCreditNoteLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L)
      ...
      {
        stmt.executeUpdate("DELETE FROM creditll WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getASalesCreditNoteFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, String cnCode, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    byte[] value = new byte[300]; // plenty
    byte[] b     = new byte[21];
    generalUtils.strToBytes(b, cnCode);
    
    getASalesCreditNoteFieldGivenCode(con, stmt, rs, fieldName, b, value, dnm, localDefnsDir, defnsDir);
    
    return generalUtils.stringFromBytes(value, 0L);
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public void getASalesCreditNoteFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] cnCode, byte[] value, String dnm,
                                           String localDefnsDir, String defnsDir) throws Exception
  {
    if(cnCode[0] == '\000') // just-in-case
      return;

    generalUtils.toUpper(cnCode, 0);

    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT " + fieldName + " FROM credit WHERE CNCode = '" + generalUtils.stringFromBytes(cnCode, 0L) + "'");
    if(! rs.next())
      value[0] = '\000';
    else
    {    
                                        ...
                                        String defnsDir, String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, layoutFile, 1,
                                     getFieldNamesSalesCreditNoteL(), fieldSizesSalesCreditNoteL, null, null, null, null);
    ...
    if(line[0] != '\000') // existing line
    {
      ...
      {
        if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not be in the correct order
          sortFields(dataAlready, data, "creditl");
        else
        {
          ...
          char dpOnUnitPrice  = miscDefinitions.dpOnUnitPrice(con, stmt, rs, "5");
    ...
    else // new line
    {
      ...
      {
        data[0]= '\000';
        scoutln(data, bytesOut, "creditl.entry=" + generalUtils.intToStr(nextLine) + "\001");

        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "creditl.gstrate=" + gstRateDefault + "\001");
      }
      
      newOrEdit = 'N';
    }

    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "creditl.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
    ddlData = inventory.getMfrsDDLData(con, stmt, rs, "creditl.manufacturer", ddlData, ddlDataUpto, ddlDataLen);
    
    getASalesCreditNoteFieldGivenCode(con, stmt, rs, "Date", code, b, dnm, localDefnsDir, defnsDir);
    String thisCategory = generalUtils.dfsGivenSeparator(true, '\001', data, (short)19);
    String[] thisAccCodeAndDesc = new String[1];
    ddlData = accountsUtils.getCategoryDDLData(con, stmt, rs, 'C', generalUtils.stringFromBytes(b, 0L), thisCategory, "creditl.category", dnm, ddlData, ddlDataUpto,
    ...
    getASalesCreditNoteFieldGivenCode(con, stmt, rs, "Currency", code, b, dnm, localDefnsDir, defnsDir);
    scoutln(data, bytesOut, "creditl.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "creditl.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(line, 0L),
                    "272b.htm", localDefnsDir, defnsDir, prependCode, newOrEdit, req, bytesOut);
                               ...
                               String defnsDir, byte[] b, char newOrEdit, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/SalesCreditNoteLineUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
    ...
    outputPageFrame(con, stmt, rs, b, req, false, newOrEdit, ' ', "", "SalesCreditNoteLine", "", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      byte[] recData, int recDataLen, byte[] code, int[] bytesOut) throws Exception
  {
    ...
    generalUtils.catAsBytes("CNCode", 0, str, true);

    if(searchDataString(recData, recDataLen, "credit", str, code) == 0)
      return 'N';
    ...
    if(searchDataString(recData, recDataLen, "credit", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "credit", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "credit", fldName, date); // assumes exists
    ...
    String fieldNamesSalesCreditNote = getFieldNamesSalesCreditNote();
    ...
    {
      getFieldName(fieldNamesSalesCreditNote, x, fldName);
      if(searchDataString(recData, recDataLen, "credit", fldName, value) != -1) // entry exists
      {
        if(value[0] != '\000')
    ...
    len = fieldNamesSalesCreditNote.length();
    int x=0, y, fieldCount=0;
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesSalesCreditNote.charAt(x) != ',')
        fldName[y++] = (byte)fieldNamesSalesCreditNote.charAt(x++);
      fldName[y] = '\000';
      ++x;
                             ...
                             int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM credit WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      rs.close();
      stmt.close();
    ...
    String fieldTypes = getFieldTypesSalesCreditNote();
    ...
    {    
      String fieldNames = getFieldNamesSalesCreditNote();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "credit." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO credit (" + getFieldNamesSalesCreditNote() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE credit SET " + opStr + " WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
  ...
  public char putRecLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesSalesCreditNoteL();
      int x=0, count=0;
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO creditl (" + getFieldNamesSalesCreditNoteL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE creditl SET " + opStr + " WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" 
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM creditl WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '"
                         + generalUtils.stringFromBytes(line, 0L) + "'");
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM creditl WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "creditl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "creditl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
                                 ...
                                 String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM creditll WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
                                ...
                                String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM creditll WHERE CNCode = '" + generalUtils.stringFromBytes(code, 0L)
                                   + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
                                  ...
                                  int[] bytesOut) throws Exception
  {
    ...
    outputPageFrame(con, stmt, rs, b, req, false, ' ',  ' ', "", "OrderAcknowledgementPage", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  }
  ...
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("credit"))
      fieldNames = getFieldNamesSalesCreditNote();
    else // if(which.equals("creditl"))
      fieldNames = getFieldNamesSalesCreditNoteL();
    int len = fieldNames.length();
  ...
  public void updatePrices(Connection con, Statement stmt, ResultSet rs, byte[] code, String band, String clear, String unm, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    byte[] rateB = new byte[30];
    getASalesCreditNoteFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir);
    double rate = generalUtils.doubleFromBytesCharFormat(rateB, 0);
    ...
    for(int x=0;x<linesCount[0];++x)
    {
      if(generalUtils.getListEntryByNum(x, linesData, line)) // just-in-case
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, b, '\000', data) != -1) // is an existent stock rec
        {
                                         ...
                                         String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "SalesCreditNote", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      return false;
    }
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "272d.htm", 2, getFieldNamesSalesCreditNote(), fieldSizesSalesCreditNote,
                         getFieldNamesSalesCreditNoteL(), fieldSizesSalesCreditNoteL, null, null);

    int recDataLen = generalUtils.lengthBytes(data, 0);

    String fieldNamesCN = getFieldNamesSalesCreditNote();
    byte[] value     = new byte[1000]; // plenty - to cover notes
    byte[] fieldName = new byte[50];
    int x=0, y, fieldCount=0;
    int len = fieldNamesCN.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesCN.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesCN.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "credit", fieldName, value) != -1) // entry exists
      {
    ...
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "credit.Attachments=" + attachments + "\001");
                               ...
                               String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM credita WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
                               ...
                               String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "4101", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);

    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Sales Credit Note" + directoryUtils.buildHelp(4101) + "</td></tr></table>";
                                  ...
                                  String defnsDir, int[] hmenuCount) throws Exception
  {
    ...
    if(callingServlet.equals("SalesCreditNotePage"))      
      s += drawOptions4101(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("SalesCreditNoteHeaderEdit"))      
      s += drawOptions4103(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("SalesCreditNoteLine"))
      s += drawOptions4105(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4101(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty,
                                 String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    String s = "";
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4103, unm, uty, dnm, localDefnsDir, defnsDir)&& serverUtils.passLockCheck(con, stmt, rs, "credit", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:fetch()\">Edit Details</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4105, unm, uty, dnm, localDefnsDir, defnsDir)&& serverUtils.passLockCheck(con, stmt, rs, "credit", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:add()\">Add New Line</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir)&& serverUtils.passLockCheck(con, stmt, rs, "credit", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:attach()\">Attachments</a></dt></dl>\n";

    boolean SalesCreditNotePrint = authenticationUtils.verifyAccess(con, stmt, rs, req, 4108, unm, uty, dnm, localDefnsDir, defnsDir);
    boolean _4187 = authenticationUtils.verifyAccess(con, stmt, rs, req, 4187, unm, uty, dnm, localDefnsDir, defnsDir);
    ...
    if(SalesCreditNotePrint || _4187 || MailExternalUserCreate || PrintToPDFUtils)
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0] + "');\">Send</dt><dd id='hmenu" + hmenuCount[0]++ + "'><ul>";
      if(SalesCreditNotePrint)
    ...
    if(serverUtils.passLockCheck(con, stmt, rs, "credit", date, unm))
    {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4103(int[] hmenuCount, char cad, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
    String s = "";
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4105(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
    String s = "";
