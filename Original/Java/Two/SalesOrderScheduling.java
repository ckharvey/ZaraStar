...
// Module: SalesOrderScheduling.java
// Author: C.K.Harvey
...
public class SalesOrderScheduling extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "SalesOrderScheduling", bytesOut);
                    ...
                    int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "SalesOrderScheduling", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "SalesOrderScheduling", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String imagesDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<form action=\"SalesOrderSchedulinga\" name=go enctype=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    drawingUtils.outputPageFrame(con, stmt, rs, out, req, "2033", "", "SalesOrderScheduling", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    drawingUtils.drawTitle(out, false, false, "SalesOrderScheduling", "", "Sales Order Processing - Scheduling", "2033", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
