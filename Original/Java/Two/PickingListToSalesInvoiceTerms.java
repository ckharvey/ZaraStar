// =======================================================================================================================================================================================================
// System: ZaraStar Document: PL to terms invoice
// Module: PickingListToSalesInvoiceTerms.java
// Author: C.K.Harvey
...
public class PickingListToSalesInvoiceTerms
{
                        ...
                        String localDefnsDir, String defnsDir, byte[] newDocCode, int[] bytesOut) throws Exception
  {
    ...
    {
      multipleLinesData = pickingList.getMultipleLines(con, stmt, rs, code, multipleLinesData, multipleListLen, multipleLinesCount, dnm,
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void plToInvoice(Connection con, Statement stmt, ResultSet rs, char which, byte[] newDocCode, byte[] fromBuf, byte[] toBuf, byte[] code, String unm, String dnm, String localDefnsDir,
                           String defnsDir, byte[] b) throws Exception
  {
    ...
    switch(which)
    {
      case 'H' : // head
                 ...
                 generalUtils.repAlpha(toBuf, 3000, (short)57, b); // plCode
