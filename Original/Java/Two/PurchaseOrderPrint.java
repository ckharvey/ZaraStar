// =======================================================================================================================================================================================================
// System: ZaraStar Document: POs: Print
// Module: PurchaseOrderPrint.java
// Author: C.K.Harvey
...
public class PurchaseOrderPrint extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "PurchaseOrderPrint", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 5013, bytesOut[0], 0, "ERR:" + p1);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "5013", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 5013, bytesOut[0], 0, "ACC:" + p1);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "5013", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 5013, bytesOut[0], 0, "SID:" + p1);
      if(con != null) con.close();
      if(out != null) out.flush();
      return;
    }
    ...
    switch(numPages)
    {
      case -1 : // Definition File Not Found
                messagePage.msgScreen(false, out, req, 17, unm, sid, uty, men, den, dnm, bnm, "5013", imagesDir, localDefnsDir, defnsDir, bytesOut);
                break;
      case -2 : // cannot create report output file
                messagePage.msgScreen(false, out, req, 18, unm, sid, uty, men, den, dnm, bnm, "5013", imagesDir, localDefnsDir, defnsDir, bytesOut);
                break;
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 5013, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), p1);
    if(con != null) con.close();
    if(out != null) out.flush();
  }
  ...
  private int generate(Connection con, Statement stmt, ResultSet rs, byte[] code, String dnm, String unm, String workingDir, String reportsDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    int docSizeMax  = miscDefinitions.docSizeMax(con, stmt, rs, "po");
    int numPages=1;
    ...
    linesData = purchaseOrder.getLines(con, stmt, rs, code, '\001', linesData, listLen, linesCount, dnm, localDefnsDir, defnsDir);
    ...
    if(linesCount[0] > 0) // get all the multiple lines for this document
      multipleLinesData = purchaseOrder.getMultipleLines(con, stmt, rs, code, multipleLinesData, multipleListLen, multipleLinesCount, dnm, localDefnsDir, defnsDir);
    
    String pprFile = "225.ppr";
    ...
    generalUtils.putAlpha(fldNames, 4000, (short)0,  "PO.POCode");
    generalUtils.putAlpha(fldNames, 4000, (short)1,  "PO.Date");
    generalUtils.putAlpha(fldNames, 4000, (short)2,  "PO.SupplierCode");
    generalUtils.putAlpha(fldNames, 4000, (short)3,  "PO.SupplierName");
    generalUtils.putAlpha(fldNames, 4000, (short)4,  "PO.Address1");
    generalUtils.putAlpha(fldNames, 4000, (short)5,  "PO.Address2");
    generalUtils.putAlpha(fldNames, 4000, (short)6,  "PO.Address3");
    generalUtils.putAlpha(fldNames, 4000, (short)7,  "PO.Address4");
    generalUtils.putAlpha(fldNames, 4000, (short)8,  "PO.Address5");
    generalUtils.putAlpha(fldNames, 4000, (short)9,  "PO.PostCode");
    generalUtils.putAlpha(fldNames, 4000, (short)10, "PO.FAO");
    generalUtils.putAlpha(fldNames, 4000, (short)11, "PO.Misc1");
    generalUtils.putAlpha(fldNames, 4000, (short)12, "PO.Misc2");
    generalUtils.putAlpha(fldNames, 4000, (short)13, "Supplier.OfficePhone");
    generalUtils.putAlpha(fldNames, 4000, (short)14, "PO.Attention");
    generalUtils.putAlpha(fldNames, 4000, (short)15, "PO.StoreCode");
    generalUtils.putAlpha(fldNames, 4000, (short)16, "PO.ProjectCode");
    generalUtils.putAlpha(fldNames, 4000, (short)17, "Supplier.Fax");
    generalUtils.putAlpha(fldNames, 4000, (short)18, "PO.Rate");
    generalUtils.putAlpha(fldNames, 4000, (short)19, "PO.Currency");
    generalUtils.putAlpha(fldNames, 4000, (short)20, "PO.ShipName");
    generalUtils.putAlpha(fldNames, 4000, (short)21, "PO.ShipAddress1");
    generalUtils.putAlpha(fldNames, 4000, (short)22, "PO.ShipAddress2");
    generalUtils.putAlpha(fldNames, 4000, (short)23, "PO.ShipAddress3");
    generalUtils.putAlpha(fldNames, 4000, (short)24, "PO.ShipAddress4");
    generalUtils.putAlpha(fldNames, 4000, (short)25, "PO.ShipAddress5");
    generalUtils.putAlpha(fldNames, 4000, (short)26, "PO.RevisionOf");
    generalUtils.putAlpha(fldNames, 4000, (short)27, "PO.GSTTotal");
    generalUtils.putAlpha(fldNames, 4000, (short)28, "PO.TotalTotal");
    generalUtils.putAlpha(fldNames, 4000, (short)29, "PO.TotalWithoutGST");
    generalUtils.putAlpha(fldNames, 4000, (short)30, "PO.SignOn");
    generalUtils.putAlpha(fldNames, 4000, (short)31, "POL.Entry");
    generalUtils.putAlpha(fldNames, 4000, (short)32, "POL.ItemCode");
    generalUtils.putAlpha(fldNames, 4000, (short)33, "POL.Description");
    generalUtils.putAlpha(fldNames, 4000, (short)34, "POL.UnitPrice");
    generalUtils.putAlpha(fldNames, 4000, (short)35, "POL.Quantity");
    generalUtils.putAlpha(fldNames, 4000, (short)36, "POL.Amount");
    generalUtils.putAlpha(fldNames, 4000, (short)37, "POL.GSTRate");
    generalUtils.putAlpha(fldNames, 4000, (short)38, "POL.UoM");
    generalUtils.putAlpha(fldNames, 4000, (short)39, "POL.StoreCode");
    generalUtils.putAlpha(fldNames, 4000, (short)40, "POL.RequiredBy");
    generalUtils.putAlpha(fldNames, 4000, (short)41, "POL.DeliveryMethod");
    generalUtils.putAlpha(fldNames, 4000, (short)42, "POL.SOCode");
    generalUtils.putAlpha(fldNames, 4000, (short)43, "PO.NoteLine1");
    generalUtils.putAlpha(fldNames, 4000, (short)44, "PO.NoteLines");
    generalUtils.putAlpha(fldNames, 4000, (short)45, "POL.SupplierItemCode");
    generalUtils.putAlpha(fldNames, 4000, (short)46, "PO.RemarkLine");
    generalUtils.putAlpha(fldNames, 4000, (short)47, "PO.Revision");
    generalUtils.putAlpha(fldNames, 4000, (short)48, "PO.DeliveryMethod");
    generalUtils.putAlpha(fldNames, 4000, (short)49, "PO.ShipTo");
    generalUtils.putAlpha(fldNames, 4000, (short)50, "PO.InvoiceTo");
    generalUtils.putAlpha(fldNames, 4000, (short)51, "PO.Customer");
    generalUtils.putAlpha(fldNames, 4000, (short)52, "PO.Misc3");
    generalUtils.putAlpha(fldNames, 4000, (short)53, "PO.ShippingTerms");
    generalUtils.putAlpha(fldNames, 4000, (short)54, "PO.GroupDiscountAmount");
    generalUtils.putAlpha(fldNames, 4000, (short)55, "PO.GroupDiscountValue");
    generalUtils.putAlpha(fldNames, 4000, (short)56, "PO.RequiredBy");
    generalUtils.putAlpha(fldNames, 4000, (short)57, "PO.SalesPerson");
    generalUtils.putAlpha(fldNames, 4000, (short)58, "POL.Discount");
    generalUtils.putAlpha(fldNames, 4000, (short)59, "POL.Manufacturer");
    generalUtils.putAlpha(fldNames, 4000, (short)60, "POL.ManufacturerCode");

    double groupDiscount=0.0;
    String remarkType="";

    if(purchaseOrder.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut) != -1L) // just-in-case
    {
      ...
      generalUtils.dfs(tmp, (short)53, b); generalUtils.putAlpha(data, 4000, (short)56, generalUtils.convertFromYYYYMMDD(b)); // requiredby
    ...
    purchaseOrder.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut);
