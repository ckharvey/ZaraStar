// =======================================================================================================================================================================================================
// System: ZaraStar: Product: Create accounts year selection page for cycle count
// Module: ProductCycleCountSelection.java
// Author: C.K.Harvey
...
public class ProductCycleCountSelection extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ProductCycleCountSelection", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "3081", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "3081", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   throws Exception
  {
    ...
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Select Accounts Year for Cycle Counting Setup", "3081", unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
    ...
    while(x < len)
    {
      ...
      scoutln(out, bytesOut, "<tr id=\"" + cssFormat + "\"><td><p><a href=\"/central/servlet/ProductCycleCountingSetup?unm=" + unm + "&uty=" + uty + "&sid=" + sid + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + db + "\">" + db
                           + "</a></td></tr>");
    }
