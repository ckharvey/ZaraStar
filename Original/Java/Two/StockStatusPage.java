...
public class StockStatusPage extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "StockStatusPage", bytesOut);
                    ...
                    String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "StockStatusPage", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "StockStatusPage", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Stock Status Report</title>");
    ...
    drawingUtils.drawTitle(out, false, false, "StockStatusPage", "", "Stock Status Report", "3062", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "<a href=\"/central/servlet/StockStatusPageExecute?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm+"\">Generate</a> a new report</td></tr>");
    ...
    for(int i=0;i<names.length;++i)
    {
      if(names[i].endsWith("021"))
      {
        ...
        scoutln(out, bytesOut, "&nbsp;&nbsp;&nbsp;<a href=\"/central/servlet/StockStatusPagePrint?unm=" + unm + "&uty=" + uty + "&p1=" + names[i] + "&sid=" + sid + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\">Printer</a>");

        scoutln(out, bytesOut, "&nbsp;&nbsp;&nbsp;<a href=\"/central/servlet/RemoveReport?unm=" + unm + "&uty=" + uty + "&p1=" + names[i] + "&p2=StockStatusPage&sid=" + sid + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\">Remove</a></td></tr>");
      }
    }

    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");

    scoutln(out, bytesOut, "<tr><td><a href=\"/central/servlet/StockStatusPage?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men
