...
public class RATCreateEditIssueWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String p1, String p2, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "RATCreateEditIssue", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "RATCreateEditIssue", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "5905\001Issues\001Issue Create\001javascript:getHTML('RATCreateEditIssueWave','')\001\001Y\001\001\003");
                   ...
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<form name='form5902' id='form5902' enctype='application/x-www-form-urlencoded' method='POST'>");

    if(p1.length() == 0)
      issuesUtils.drawTitleW(con, stmt, rs, req, out, "New Issue in: " + p2, "5905", p1, true, true, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
    else issuesUtils.drawTitleW(con, stmt, rs, req, out, "Edit Issue " + p1 + ", in: " + p2, "5905", p1, true, true, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "<input type=hidden name=typeForEditor value=\"I\">");//////////////////////////
    scoutln(out, bytesOut, "<input type=hidden name=codeForEditor value=\"" + ratCode[0] + "\">");
    ...
    if(categoryType.equals("P") || categoryType.equals("R")) // Problem || Request
    {
      ...
      if(canEditStuff)
        scoutln(out, bytesOut, "<tr><td><p>Service: </p></td><td colspan=3><p><input type=text size=15 maxlength=20 name=service value=\"" + service[0] + "\"></p></td>");
      else
      {
        scoutln(out, bytesOut, "<td><p>Service: </p></td><td><p>" + service + "</p></td></tr>");
        scoutln(out, bytesOut, "<input name='service' type=hidden value='O'>");
      }
