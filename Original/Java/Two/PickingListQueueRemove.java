// =======================================================================================================================================================================================================
// System: ZaraStar Utils: Remove a PL from the queue
// Module: PickingListQueueRemove.java
// Author: C.K.Harvey
...
public class PickingListQueueRemove extends HttpServlet
{
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String p1, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 3049d";
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 3049, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "Remove PL (3049d)");
  ...
  private boolean update(Connection con, Statement stmt, String plCode) throws Exception
  {
    try
    {
      ...
      stmt.executeUpdate("UPDATE pl SET TimesPrinted = '1' WHERE PLCode = '" + plCode + "'");
