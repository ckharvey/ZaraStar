// =======================================================================================================================================================================================================
// System: ZaraStar DocumentEngine: Change Prices for a Document - update
// Module: PricesChangeExecute.java
// Author: C.K.Harvey
...
public class PricesChangeExecute extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      p3  = req.getParameter("p3"); // band
      p4  = req.getParameter("p4"); // clear line discounts
                    ...
                    String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "6093a", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "6093a", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, String docCode, String docType, String band, String clear,
                   ...
                   throws Exception
  {
    ...
    if(docType.equals("SO"))
    {
      ...
      salesOrder.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("Q"))
    {
      ...
      quotation.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("OC"))
    {
      ...
      orderConfirmation.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("OA"))
    {
      ...
      orderAcknowledgement.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("PL"))
    {
      ...
      pickingList.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("DO"))
    {
      ...
      deliveryOrder.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("I"))
    {
      ...
      salesInvoice.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("PRO"))
    {
      ...
      proformaInvoice.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("DN"))
    {
      ...
      salesDebitNote.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("CN"))
    {
      ...
      salesSalesCreditNote.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("PO"))
    {
      ...
      purchaseOrder.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("LP"))
    {
      ...
      localPurchase.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("PI"))
    {
      ...
      purchaseInvoice.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("PDN"))
    {
      ...
      purchaseDebitNote.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("PCN"))
    {
      ...
      purchaseCreditNote.updatePrices(con, stmt, rs, code, band, clear, unm, dnm, localDefnsDir, defnsDir);
