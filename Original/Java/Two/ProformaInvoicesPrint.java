// =======================================================================================================================================================================================================
// System: ZaraStar Document: Proforma Invoices: Print
// Module: ProformaInvoicesPrint.java
// Author: C.K.Harvey
...
public class ProformaInvoicesPrint extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ProformaInvoicesPrint", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 4089, bytesOut[0], 0, "ERR:" + p1);
                    ...
                    String bnm, String p1, String p2, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "4089", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 4089, bytesOut[0], 0, "ACC:" + p1);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "4089", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 4089, bytesOut[0], 0, "SID:" + p1);
    if(con  != null) con.close();
      if(out != null) out.flush();
      return;
    }
    ...
    switch(numPages)
    {
      case -1 : // Definition File Not Found
                messagePage.msgScreen(false, out, req, 17, unm, sid, uty, men, den, dnm, bnm, "4089", imagesDir,
                                   localDefnsDir, defnsDir, bytesOut);
                break;
      case -2 : // cannot create report output file
                messagePage.msgScreen(false, out, req, 18, unm, sid, uty, men, den, dnm, bnm, "4089", imagesDir,
                                   localDefnsDir, defnsDir, bytesOut);
                break;
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 4089, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), p1);
    if(con  != null) con.close();
    if(out != null) out.flush();
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private int generate(Connection con, Statement stmt, ResultSet rs, byte[] code, String option, String dnm, String unm, String workingDir, String reportsDir, String localDefnsDir,
                       String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    linesData = proformaInvoice.getLines(con, stmt, rs, code, '\001', linesData, listLen, linesCount, dnm, localDefnsDir, defnsDir);
    ...
    if(linesCount[0] > 0) // get all the multiple lines for this document
      multipleLinesData = proformaInvoice.getMultipleLines(con, stmt, rs, code, multipleLinesData, multipleListLen, multipleLinesCount, dnm, localDefnsDir, defnsDir);
    ...
    generalUtils.putAlpha(fldNames, 6000, (short)0,  "Proforma.ProformaCode");
    generalUtils.putAlpha(fldNames, 6000, (short)1,  "Proforma.Date");
    generalUtils.putAlpha(fldNames, 6000, (short)2,  "Proforma.CompanyCode");
    generalUtils.putAlpha(fldNames, 6000, (short)3,  "Proforma.CompanyName");
    generalUtils.putAlpha(fldNames, 6000, (short)4,  "Proforma.Address1");
    generalUtils.putAlpha(fldNames, 6000, (short)5,  "Proforma.Address2");
    generalUtils.putAlpha(fldNames, 6000, (short)6,  "Proforma.Address3");
    generalUtils.putAlpha(fldNames, 6000, (short)7,  "Proforma.Address4");
    generalUtils.putAlpha(fldNames, 6000, (short)8,  "Proforma.Address5");
    generalUtils.putAlpha(fldNames, 6000, (short)9,  "Proforma.PostCode");
    generalUtils.putAlpha(fldNames, 6000, (short)10, "Proforma.FAO");
    generalUtils.putAlpha(fldNames, 6000, (short)11, "Proforma.Misc1");
    generalUtils.putAlpha(fldNames, 6000, (short)12, "Proforma.Misc2");
    generalUtils.putAlpha(fldNames, 6000, (short)13, "Proforma.DateRange");
    generalUtils.putAlpha(fldNames, 6000, (short)14, "Proforma.Attention");
    generalUtils.putAlpha(fldNames, 6000, (short)15, "ProformaL.Entry");
    generalUtils.putAlpha(fldNames, 6000, (short)16, "ProformaL.ItemCode");
    generalUtils.putAlpha(fldNames, 6000, (short)17, "ProformaL.Description");
    generalUtils.putAlpha(fldNames, 6000, (short)18, "ProformaL.UnitPrice");
    generalUtils.putAlpha(fldNames, 6000, (short)19, "ProformaL.Quantity");
    generalUtils.putAlpha(fldNames, 6000, (short)20, "ProformaL.DiscountPercentage");
    generalUtils.putAlpha(fldNames, 6000, (short)21, "ProformaL.Amount");
    generalUtils.putAlpha(fldNames, 6000, (short)22, "ProformaL.GSTRate");
    generalUtils.putAlpha(fldNames, 6000, (short)23, "ProformaL.UoM");
    generalUtils.putAlpha(fldNames, 6000, (short)24, "ProformaL.AltItemCode");
    generalUtils.putAlpha(fldNames, 6000, (short)25, "Proforma.GSTTotal");
    generalUtils.putAlpha(fldNames, 6000, (short)26, "Proforma.TotalTotal");
    generalUtils.putAlpha(fldNames, 6000, (short)27, "Proforma.GroupDiscount");
    generalUtils.putAlpha(fldNames, 6000, (short)28, "Proforma.GroupDiscountType");
    generalUtils.putAlpha(fldNames, 6000, (short)29, "Proforma.TotalWithoutGST");
    generalUtils.putAlpha(fldNames, 6000, (short)30, "Proforma.SalesPerson");
    generalUtils.putAlpha(fldNames, 6000, (short)31, "Proforma.DORefNum");
    generalUtils.putAlpha(fldNames, 6000, (short)32, "Proforma.PORefNum");
    generalUtils.putAlpha(fldNames, 6000, (short)33, "Proforma.SignOn");
    generalUtils.putAlpha(fldNames, 6000, (short)34, "Proforma.NoteLine1");
    generalUtils.putAlpha(fldNames, 6000, (short)35, "Proforma.NoteLines");
    generalUtils.putAlpha(fldNames, 6000, (short)36, "Proforma.Currency2");
    generalUtils.putAlpha(fldNames, 6000, (short)37, "Proforma.Rate2");
    generalUtils.putAlpha(fldNames, 6000, (short)38, "Proforma.ShipName");
    generalUtils.putAlpha(fldNames, 6000, (short)39, "Proforma.ShipAddress1");
    generalUtils.putAlpha(fldNames, 6000, (short)40, "Proforma.ShipAddress2");
    generalUtils.putAlpha(fldNames, 6000, (short)41, "Proforma.ShipAddress3");
    generalUtils.putAlpha(fldNames, 6000, (short)42, "Proforma.ShipAddress4");
    generalUtils.putAlpha(fldNames, 6000, (short)43, "Proforma.ShipAddress5");
    generalUtils.putAlpha(fldNames, 6000, (short)44, "Proforma.BaseGSTTotal");
    generalUtils.putAlpha(fldNames, 6000, (short)45, "Proforma.BaseTotalTotal");
    generalUtils.putAlpha(fldNames, 6000, (short)46, "Proforma.CurrencyDescription");
    generalUtils.putAlpha(fldNames, 6000, (short)47, "Proforma.AmountInWords");
    generalUtils.putAlpha(fldNames, 6000, (short)48, "Proforma.OCCode");
    generalUtils.putAlpha(fldNames, 6000, (short)49, "Proforma.Misc3");
    generalUtils.putAlpha(fldNames, 6000, (short)50, "Proforma.Misc4");
    generalUtils.putAlpha(fldNames, 6000, (short)51, "ProformaL.Currency");
    generalUtils.putAlpha(fldNames, 6000, (short)52, "ProformaL.CustomerItemCode");
    generalUtils.putAlpha(fldNames, 6000, (short)53, "Proforma.Terms");
    generalUtils.putAlpha(fldNames, 6000, (short)54, "Proforma.PLCode");
    generalUtils.putAlpha(fldNames, 6000, (short)55, "Proforma.ExportStatement");
    generalUtils.putAlpha(fldNames, 6000, (short)56, "Proforma.BaseTotalWithoutGST");
    generalUtils.putAlpha(fldNames, 6000, (short)57, "Proforma.ExchangeRateMessage");
    generalUtils.putAlpha(fldNames, 6000, (short)58, "Proforma.Status");
    generalUtils.putAlpha(fldNames, 6000, (short)59, "Proforma.Reference");
    generalUtils.putAlpha(fldNames, 6000, (short)60, "ProformaL.ManufacturerCode");
    generalUtils.putAlpha(fldNames, 6000, (short)61, "ProformaL.Manufacturer");
    
    double groupDiscount=0.0, gstTotal=0, total=0;
    String currency="";

    if(proformaInvoice.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut) != -1L) // just-in-case
    {
      generalUtils.putAlpha(data, 6000, (short)0, code);
      
      generalUtils.dfs(tmp, (short)1,  b); 
      generalUtils.putAlpha(data, 6000, (short)1,  generalUtils.convertFromYYYYMMDD(b)); // date
      ...
      generalUtils.dfs(tmp, (short)57, b); generalUtils.putAlpha(data, 6000, (short)48, b); // occode
      ...
      // get PLcode from DO given DOrefnum
      deliveryOrder.getADOFieldGivenCode(con, stmt, rs, "PLCode", doRefNum, b);
      generalUtils.putAlpha(data, 6000, (short)54, b); // plcode
    }
    ...
    int docSizeMax = miscDefinitions.docSizeMax(con, stmt, rs, "proforma");
    ...
    for(int xx=0;xx<linesCount[0];++xx)
    {
      if(generalUtils.getListEntryByNum(xx, linesData, tmp)) // just-in-case
      {
        ...
        generalUtils.dfsGivenSeparator(true, '\001', tmp, (short)28, mfr);
        generalUtils.dfsGivenSeparator(true, '\001', tmp, (short)29, mfrCode);
        ...
        {  
          outputDetailLine(con, stmt, rs, data, fldNames, lineNumB, itemCode, mfrCode, unitPrice, quantity, amount2, gstRate, discountPercentage, uom, custItemCode, 
                           entry, lastEntry, lineCount, mfr, mfrCode, dpOnQuantities, unm, dnm, localDefnsDir, defnsDir, tm, bm, lm, rm, pageSizeWidth,
          ...
          {
            b[0] = '\000';
            reportGenDetails.outputLine('E', b, data, fldNames, (short)62, ' ', dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
        ...
        if(   miscDefinitions.showDuplicateDescriptions(con, stmt, rs) || itemCode[0] == '-' || ! generalUtils.matchIgnoreCase(lastItemCode, 0, itemCode, 0))
        {
          ...
          generalUtils.repAlpha(data, 6000, (short)61, b); // mfr
    ...
    proformaInvoice.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    String s = generalUtils.getFromDefnFile("Proforma-" + which, "pretext.dfn", localDefnsDir, defnsDir);
    int len = s.length();
    if(len == 0)
      return;
  ...
  private void outputDetailLine(Connection con, Statement stmt, ResultSet rs, byte[] data, byte[] fldNames, byte[] lineNumB, byte[] itemCode, byte[] desc, byte[] unitPrice, byte[] quantity,
                                ...
                                byte[] lastEntry, int[] lineCount, byte[] mfr, byte[] mfrCode, char dpOnQuantities,
                                String unm, String dnm, String localDefnsDir, String defnsDir, double[] tm, double[] bm, double[] lm, double[] rm,
                                ...
                                double[] down2Coord, double[] across2Coord, byte[] oBuf, String[] gstRates) throws Exception
  {
    ...
    generalUtils.repAlpha(data, 6000, (short)15, entry);//lineNumB);
    generalUtils.repAlpha(data, 6000, (short)16, itemCode);
    generalUtils.repAlpha(data, 6000, (short)17, desc);

    if(unitPrice[0] != '\000')
      generalUtils.bytesDPsGivenSeparator(true, '\000', '2', unitPrice, 20, 0);
    generalUtils.repAlpha(data, 6000, (short)18, unitPrice);
    ...
    generalUtils.repAlpha(data, 6000, (short)19, quantity);
        
    if(amount2[0] != '\000')
      generalUtils.bytesDPsGivenSeparator(true, '\000', '2', amount2, 20, 0);
    generalUtils.repAlpha(data, 6000, (short)21, amount2);
    
    generalUtils.repAlpha(data, 6000, (short)22, gstRate);
    
    if(discountPercentage[0] != '\000')
      generalUtils.bytesDPsGivenSeparator(true, '\000', '2', discountPercentage, 20, 0);
    generalUtils.repAlpha(data, 6000, (short)20, discountPercentage);
    
    generalUtils.repAlpha(data, 6000, (short)23, uom);
    generalUtils.repAlpha(data, 6000, (short)52, custItemCode);
    ...
    if(miscDefinitions.hideDuplicateEntries(con, stmt, rs))
    {
      if(generalUtils.matchIgnoreCase(entry, 0, lastEntry, 0))
      {
        ...
        generalUtils.repAlpha(data, 6000, (short)16, b); // itemCode
        generalUtils.repAlpha(data, 6000, (short)18, b); // unitPrice
        generalUtils.repAlpha(data, 6000, (short)20, b); // discountPercentage
        generalUtils.repAlpha(data, 6000, (short)21, b); // amount
        generalUtils.repAlpha(data, 6000, (short)60, b); // mfrCode
        generalUtils.repAlpha(data, 6000, (short)61, b); // mfr
      }
    ...
    else
    {
      ...
      generalUtils.repAlpha(data, 6000, (short)16, itemCode);
      generalUtils.repAlpha(data, 6000, (short)17, desc);
      generalUtils.repAlpha(data, 6000, (short)60, mfrCode);
      generalUtils.repAlpha(data, 6000, (short)61, mfr);
    }
