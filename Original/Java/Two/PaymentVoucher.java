// =======================================================================================================================================================================================================
// System: ZaraStar Document: PV Record Access
// Module: paymentVoucher.java
// Author: C.K.Harvey
...
public class PaymentVoucher
{
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringVoucher() throws Exception
  {  
    return "voucher ( VoucherCode char(20) not null, Date date not null,           CompanyCode char(20) not null, "
                   ...
                   + "GSTTotal decimal(19,8),        TotalTotal decimal(19,8),     AccountCr char(20), "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsVoucher(String[] s) throws Exception
  {
    s[0] = "voucherDateInx on voucher (Date)";
    s[1] = "voucherCompanyCodeInx on voucher (CompanyCode)";
    
    return 2;
  }
      
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesVoucher() throws Exception
  {  
    return "VoucherCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
         + "Attention, Misc1, Misc2, GSTTotal, TotalTotal, AccountCr, ChequeNumber, PrintCount, unused1, Reference, ProjectCode, "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesVoucher() throws Exception
  {
    return "CDCCCCCCCCCCCCCFFCCICCCCDCFCFFSCCCCCCC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesVoucher(short[] sizes) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesVoucher() throws Exception
  {
    return "MMMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringVoucherL() throws Exception
  {  
    return "voucherl ( VoucherCode char(20) not null, ItemCode char(20) not null, Description char(80), "
                    + "Amount decimal(17,8),          GSTRate char(20),           unused1 char(20), "
                    + "AccountDr char(20),            Amount2 decimal(17,8),      Line integer not null, "
                    + "Entry char(6),                 DateLastModified timestamp, SignOn char(20), "
                    + "unique(VoucherCode, Line))";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsVoucherL(String[] s) throws Exception
  {
    s[0] = "";
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesVoucherL() throws Exception
  {  
    return "VoucherCode, ItemCode, Description, Amount, GSTRate, unused1, AccountDr, Amount2, Line, Entry, DateLastModified, SignOn";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesVoucherL() throws Exception
  {
    return "CCCFCCCFICSC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesVoucherL(short[] sizes) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesVoucherL() throws Exception
  {
    return "OOOOOOOOMOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringVoucherLL() throws Exception
  {  
    return "voucherll ( VoucherCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), "
                      + "unique(VoucherCode, Entry, Line))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsVoucherLL(String[] s) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesVoucherLL() throws Exception
  {  
    return "VoucherCode, Entry, Line, Text";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesVoucherLL() throws Exception
  {
    return "CCIC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesVoucherLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesVoucherLL() throws Exception
  {
    return "MMMO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringVoucherA() throws Exception
  {  
    return "vouchera ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsVoucherA(String[] s) throws Exception
  {
    s[0]="\0"; // remove compiler warning
    return 0;
  }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesVoucherA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesVoucherA() throws Exception
  {
    return "CI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesVoucherA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesVoucherA() throws Exception
  {
    return "MM";
  }
  ...
  public boolean getRecToHTML(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, boolean plain, char dispOrEdit, byte[] code, String unm, String sid,
                              String uty, String men, String den, String dnm, String bnm, String workingDir, String localDefnsDir, String defnsDir,
                              char cad, String errStr, String cashOrNot, byte[] dataAlready, HttpServletRequest req, int[] bytesOut)
                              throws Exception
  {
    ...
    if(cad == 'A' && code[0] == '\000')
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "PaymentVoucher", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      return true;
    }
    ...
    {                            // in the correct order
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "voucher");
    }
    ...
    short[] fieldSizesVoucher = new short[70]; // plenty
    getFieldSizesVoucher(fieldSizesVoucher);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesVoucherL = new short[30]; // plenty
      getFieldSizesVoucherL(fieldSizesVoucherL);
      ...
      if(dispOrEdit == 'D')
      {  
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "117.htm", 2,
                                         getFieldNamesVoucher(), fieldSizesVoucher, getFieldNamesVoucherL(), fieldSizesVoucherL, null, null);
      }
      else
      {
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "117a.htm", 1,
                                         getFieldNamesVoucher(), fieldSizesVoucher, null, null, null, null);
      }
      ...
      {
        prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), date, "117a.htm", localDefnsDir,
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        stmt.executeUpdate("UPDATE voucher SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " 
        ...
        scoutln(headData, bytesOut, "voucher.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen
        ...
        scoutln(headData, bytesOut, "voucher.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 26); // rate
        scoutln(headData, bytesOut, "voucher.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)26) + "\001");
        ...
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "voucher.Attachments=" + attachments + "\001");
      }
      else // edit
      {
        ddlData = accountsUtils.getGLAccountsDDLData("voucher.AccountCr", unm, dnm, ddlData, ddlDataUpto, ddlDataLen, workingDir);
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "voucher.Currency", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
      ...
      screenLayout.bufferToBuffer(buf1, buf2, size1, size2, source, numFields, fieldNames, fieldTypes, fieldSizes, dispOrEdit, 'H',
                           headData, 5000, ddlData, ddlDataUpto[0], null, null);
    ...
    else // a new layout
    {
      numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir,
                                       "117a.htm", 1, getFieldNamesVoucher(), fieldSizesVoucher, null, null, null, null);

      if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but data's fields may (will) not be in the correct order
        sortFields(dataAlready, data, "voucher");
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "voucher", data);

        documentUtils.getNextCode(con, stmt, rs, "voucher", true, code);
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L), date, "117a.htm", localDefnsDir, defnsDir,
  ...
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=voucherl.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6072, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "voucher", date, unm))
  ...
  {
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6070, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      b[0]= '\000';
      scoutln(b, bytesOut, "<script language=\"JavaScript\">");
      scoutln(b, bytesOut, "function affect(line){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PaymentVoucherLine?unm=" + unm + "&sid=" + sid
                       ...
                       throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6068, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function fetch(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PaymentVoucherHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty="
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty="
                       + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=PV\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 8016, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/MailExternalUserCreate?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=PaymentVoucherPage&p2=" + code2
                         + "&p3=Voucher&bnm=" + bnm + "\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/TrailShow?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=V\";}");
    }
    ...
    scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PaymentVoucherPage?unm=" + unm + "&sid=" + sid + "&uty="
                         + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=A&p3=&p4=&p6=P\");}\n");
    ...
    if(plain)
      scoutln(b, bytesOut, "<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"" + cssDocumentDirectory + "documentPlain.css\">\n");
    else scoutln(b, bytesOut, "<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"" + cssDocumentDirectory + "document.css\">\n");

    outputPageFrame(con, stmt, rs, b, req, plain, ' ', ' ', "", "PaymentVoucherPage", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                           ...
                           HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/PaymentVoucherHeaderUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
    ...
    outputPageFrame(con, stmt, rs, b, req, false, ' ', cad.charAt(0), "", "PaymentVoucherHeaderEdit", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      String defnsDir, char cad, byte[] recData, int recDataLen, byte[] rtnLineBytes, int[] bytesOut) throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "voucherl", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "voucherl"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesVoucherL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "voucherl", fieldName, value) != -1) // entry exists
      {
        if(fieldCount == 1)
        {
          if(value[0] == '\000')
    ...
    getAVoucherFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir); // getCurrencyRateGivenCode
    ...
    if(searchDataString(recData, recDataLen, "voucherl", fieldName, value) != -1) // exists
    {
      ...
      else // strip only the first desc line for voucherL rec
      {
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE voucher SET SignOn = '" + unm + "', DateLastModified = NULL WHERE VoucherCode = '"
                                     ...
                                     String defnsDir) throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM voucherll WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) 
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE voucherll SET Text = '" + sanitisedDesc + "' WHERE VoucherCode = '"
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO voucherll (" + getFieldNamesVoucherLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L)
      ...
      {
        stmt.executeUpdate("DELETE FROM voucherll WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public void getAVoucherFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] voucherCode, byte[] value, String dnm, String localDefnsDir,
                                        String defnsDir) throws Exception
  {
    if(voucherCode[0] == '\000') // just-in-case
      return;

    generalUtils.toUpper(voucherCode, 0);

    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT " + fieldName + " FROM voucher WHERE VoucherCode = '"
                                   + generalUtils.stringFromBytes(voucherCode, 0L) + "'");
    if(! rs.next())
      value[0] = '\000';
    else
    {    
  ...
  public boolean buildHTMLLayoutForLine(Connection con, Statement stmt, ResultSet rs, PrintWriter out, byte[] code, byte[] line, String unm, String sid, String uty, String men,
                                        String den, String dnm, String bnm, String workingDir, String localDefnsDir, String defnsDir, String errStr,
                                        byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, layoutFile, 1,
                                     getFieldNamesVoucherL(), fieldSizesVoucherL, null, null, null, null);
    ...
    if(line[0] != '\000') // existing line
    {
      ...
      {
        if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but data's fields may (will) not be in correct order
          sortFields(dataAlready, data, "voucherl");
        else
        {
          ...
          try
          {
            generalUtils.dfsGivenSeparator(true, '\001', data, (short)4, b); // gstRate
            if(b[0] == '\000')
              generalUtils.repAlphaGivenSeparator('\001', data, 2000, (short)4, "<none>");
          }
          catch(Exception e) { }

          generalUtils.dfsGivenSeparator(true, '\001', data, (short)6, b); // accountDr
          if(b[0] != '\000')
          {
    ...
    else /// new line
    {
      ...
      {
        data[0]= '\000';
        scoutln(data, bytesOut, "voucherl.entry=" + generalUtils.intToStr(nextLine) + "\001");

        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "voucherl.gstrate=" + gstRateDefault + "\001");
      }
      
      newOrEdit = 'N';
    }

    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "voucherl.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
    ddlData = accountsUtils.getGLAccountsDDLData("voucherl.AccountDr", unm, dnm, ddlData, ddlDataUpto, ddlDataLen, workingDir);

    getAVoucherFieldGivenCode(con, stmt, rs, "Currency", code, b, dnm, localDefnsDir, defnsDir);
    scoutln(data, bytesOut, "voucherl.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "voucherl.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    byte[] prependCode = new byte[22000];
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(line, 0L), "117b.htm",
                               ...
                               throws Exception
  {
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/PaymentVoucherLineUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1="
    ...
    outputPageFrame(con, stmt, rs, b, req, false, newOrEdit, ' ', "", "PaymentVoucherLine", "", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      byte[] code, int[] bytesOut) throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "voucher", str, code) == 0)
      return 'N';
...
//    if(! generalUtils.validCode(code))
 //     return 'I';
    ...
    if(searchDataString(recData, recDataLen, "voucher", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "voucher", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "voucher", fldName, date); // assumes exists

        rate = accountsUtils.getApplicableRate(con, stmt, rs, generalUtils.stringFromBytes(currency, 0L), generalUtils.stringFromBytes(date, 0L), value, dnm, localDefnsDir,
                                       defnsDir);
    ...
    String fieldNamesVoucher = getFieldNamesVoucher();
    ...
    {
      getFieldName(fieldNamesVoucher, x, fldName);
      if(searchDataString(recData, recDataLen, "voucher", fldName, value) != -1) // entry exists
      {
        if(value[0] != '\000')
    ...
    len = fieldNamesVoucher.length();
    int x=0, y, fieldCount=0;
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesVoucher.charAt(x) != ',')
        fldName[y++] = (byte)fieldNamesVoucher.charAt(x++);
      fldName[y] = '\000';
      ++x;
    ...
    // just-in-case no value then need to insert a default
    if((generalUtils.dfsAsStr(buf, (short)15)).length() == 0) // GSTTotal origin-0
                              ...
                              int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM voucher WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      rs.close();
      stmt.close();
    ...
    String fieldTypes = getFieldTypesVoucher();
    ...
    {    
      String fieldNames = getFieldNamesVoucher();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "voucher." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO voucher (" + getFieldNamesVoucher() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE voucher SET " + opStr + " WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
                         ...
                         String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesVoucherL();
      int x=0, count=0;
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO voucherl (" + getFieldNamesVoucherL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE voucherl SET " + opStr + " WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" 
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM voucherl WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '"
                         + generalUtils.stringFromBytes(line, 0L) + "'");
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM voucherl WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "voucherl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "voucherl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
                                   ...
                                   String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM voucherll WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
                                ...
                                String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM voucherll WHERE VoucherCode = '" + generalUtils.stringFromBytes(code, 0L)
                                   + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
                                  ...
                                  int[] bytesOut) throws Exception
  {
    ...
    outputPageFrame(con, stmt, rs, b, req, false, ' ',  ' ', "", "OrderAcknowledgementListing", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  }
  ...
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("voucher"))
      fieldNames = getFieldNamesVoucher();
    else // if(which.equals("voucherl"))
      fieldNames = getFieldNamesVoucherL();
    int len = fieldNames.length();
                                         ...
                                         String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "117d.htm",
                                     2, getFieldNamesVoucher(), fieldSizesVoucher, getFieldNamesVoucherL(), fieldSizesVoucherL,
                                     null, null);
    ...
    int x=0, y, fieldCount=0;
    int len = fieldNamesVoucher.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesVoucher.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesVoucher.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "voucher", fieldName, value) != -1) // entry exists
      {
    ...
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "voucher.Attachments=" + attachments + "\001");
                               ...
                               String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM vouchera WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
                               ...
                               String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "6066", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);

    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Payment Voucher" + directoryUtils.buildHelp(6066) + "</td></tr></table>";
                                  ...
                                  String defnsDir, int[] hmenuCount) throws Exception
  {
    ...
    if(callingServlet.equals("PaymentVoucherPage"))
      s += drawOptions6066(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("PaymentVoucherHeaderEdit"))
      s += drawOptions6068(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("PaymentVoucherLine"))
      s += drawOptions6070(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions6066(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty,
                                 String dnm, String localDefnsDir, String defnsDir) throws Exception
  {      
    String s = "";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6068, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "voucher", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:fetch()\">Edit Details</a></dt></dl>\n";
 
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6070, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "voucher", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:add()\">Add New Line</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "voucher", date, unm))
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6092, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "voucher", date, unm))
    {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions6068(int[] hmenuCount, char cad, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions6070(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
