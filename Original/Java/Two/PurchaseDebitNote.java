// =======================================================================================================================================================================================================
// System: ZaraStar DocumentEngine: PDN Record Access
...
public class PurchaseDebitNote
{
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseDebitNote() throws Exception
  {  
    return "pdebit ( PDNCode char(20) not null, Date date not null,         CompanyCode char(20) not null, "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseDebitNote(String[] s) throws Exception
  {
    s[0] = "pdebitDateInx on pdebit (Date)";
    s[1] = "pdebitCompanyCodeInx on pdebit (CompanyCode)";
    
    return 2;
  }
      
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseDebitNote() throws Exception
  {  
    return "PDNCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseDebitNote() throws Exception
  {
    return "CDCCCCCCCCCCCDDCCFFFCCCFCCCCSCCIFFCFCCCDCCCDDCCFCFCCCCCCFCCCCCCC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesPurchaseDebitNote(short[] sizes) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseDebitNote() throws Exception
  {
    return "MMMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseDebitNoteL() throws Exception
  {  
    return "pdebitl ( PDNCode char(20) not null, ItemCode char(20) not null,     Description char(80), "
                   ...
                   + "Unused char(40),           ReceivedAmount decimal(19,8),   RefundedAmount decimal(19,8), "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseDebitNoteL(String[] s) throws Exception
  {
    s[0] = "pdebitlItemCodeInx on pdebitl(ItemCode)";
    
    return 1;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseDebitNoteL() throws Exception
  {  
    return "PDNCode, ItemCode, Description, UnitPrice, Quantity, Amount, GSTRate, Discount, DateLastModified, SignOn, Amount2, "
         + "ProfitCentre, AccCode, AppliedStatus, StockUpdated, DateOfStockUpdate, QuantityRequired, CustomerItemCode, UoM, Line, "
         + "Entry, Unused, ReceivedAmount, RefundedAmount, AltItemCode, PORefNum, DORefNum, Manufacturer, ManufacturerCode";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseDebitNoteL() throws Exception
  {
    return "CCCFFFCFSCFCCCCDFCCICCFFCCCCC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesPurchaseDebitNoteL(short[] sizes) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseDebitNoteL() throws Exception
  {
    return "OOOOOOOOOOOOOOOOOOOMOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseDebitNoteLL() throws Exception
  {  
    return "pdebitll ( PDNCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), "
                    + "unique(PDNCode, Entry, Line))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseDebitNoteLL(String[] s) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseDebitNoteLL() throws Exception
  {  
    return "PDNCode, Entry, Line, Text";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseDebitNoteLL() throws Exception
  {
    return "CCIC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesPurchaseDebitNoteLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseDebitNoteLL() throws Exception
  {
    return "MMMO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringPurchaseDebitNoteA() throws Exception
  {  
    return "pdebita ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsPurchaseDebitNoteA(String[] s) throws Exception
  {
    s[0]="\0"; // remove compiler warning
    return 0;
  }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesPurchaseDebitNoteA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesPurchaseDebitNoteA() throws Exception
  {
    return "CI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesPurchaseDebitNoteA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesPurchaseDebitNoteA() throws Exception
  {
    return "MM";
  }
                              ...
                              String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    if(cad == 'A' && code[0] == '\000')
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "PurchaseDebitNote", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      return true;
    }
    ...
    {                            // in the correct order
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "pdebit");
    }
    ...
    short[] fieldSizesPurchaseDebitNote = new short[70]; // plenty
    getFieldSizesPurchaseDebitNote(fieldSizesPurchaseDebitNote);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesPurchaseDebitNoteL = new short[30]; // plenty
      getFieldSizesPurchaseDebitNoteL(fieldSizesPurchaseDebitNoteL);
      ...
      if(dispOrEdit == 'D')
      {  
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "282.htm", 2, getFieldNamesPurchaseDebitNote(), fieldSizesPurchaseDebitNote,
                             getFieldNamesPurchaseDebitNoteL(), fieldSizesPurchaseDebitNoteL, null, null);
      }
      else
      {
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "282a.htm", 1, getFieldNamesPurchaseDebitNote(),
                             fieldSizesPurchaseDebitNote, null, null, null, null);
      }
      ...
      {
        prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), date, "282a.htm", 
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        stmt.executeUpdate("UPDATE pdebit SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " 
                         + totalGSTAmt2Lines + ", BaseTotalTotal = " + (totalAmtLines + totalGSTAmtLines) + ", BaseGSTTotal = "
                         + totalGSTAmtLines + " WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
        stmt.close();
        ...
        scoutln(headData, bytesOut, "pdebit.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen
        ...
        scoutln(headData, bytesOut, "pdebit.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 49); // rate
        scoutln(headData, bytesOut, "pdebit.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)49) + "\001");
        ...
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "pdebit.Attachments=" + attachments + "\001");
      }
      else // edit
      {
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "pdebit.Currency", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
        ddlData = documentUtils.getSalesPersonDDLData(con, stmt, rs, "pdebit.SalesPerson", ddlData, ddlDataUpto, ddlDataLen);
        ddlData = documentUtils.getCountryDDLData(con, stmt, rs, "pdebit.Country", ddlData, ddlDataUpto, ddlDataLen);
    ...
    {
      numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "282a.htm", 1, getFieldNamesPurchaseDebitNote(), fieldSizesPurchaseDebitNote,
                           null, null, null, null);

      if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not
      {                            // be in the correct order
        sortFields(dataAlready, data, "pdebit");
      }  
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "pdebit", data);

        documentUtils.getNextCode(con, stmt, rs, "dn", true, code);

        generalUtils.repAlphaUsingOnes(data, 5000, "PDNCode", generalUtils.stringFromBytes(code, 0L));
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L), date, "282a.htm",
                  localDefnsDir, defnsDir, prependCode, req, bytesOut);
  ...
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=pdebitl.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5042, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pdebit", date, unm))
                          ...
                          String den, String dnm, String bnm, byte[] b, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4115, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PurchaseDebitNoteLine?unm=" + unm + "&sid=" + sid
                       ...
                       throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5038, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/PurchaseDebitNoteHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty="
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty="
                       + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=PDN\";}");
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6098, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/DocumentChangeDiscounts?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
                           + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=PDN\";}");
      }
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5040, unm, uty, dnm, localDefnsDir, defnsDir))
    {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 8016, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/MailExternalUserCreate?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=PurchaseDebitNotePage&p2=" + code2
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/TrailShow?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=M\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5043, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function print(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/_5043?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=&p3=&p4=\";}");
    }
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', ' ', "", "PurchaseDebitNotePage", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                           ...
                           byte[] b, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/PurchaseDebitNoteHeaderUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1="
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', cad.charAt(0), "", "PurchaseDebitNoteHeaderEdit", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      char cad, byte[] recData, int recDataLen, byte[] rtnLineBytes, int[] bytesOut) throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "pdebitl", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "pdebitl"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesPurchaseDebitNoteL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "pdebitl", fieldName, value) != -1) // entry exists
      {
    ...
    getADebitNoteFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir); // getCurrencyRateGivenCode
    ...
    if(   searchDataString(recData, recDataLen, "pdebitl", fieldName, value) != -1 // exists
       && value[0] != '\000')
    {
    ...
    if(searchDataString(recData, recDataLen, "pdebitl", fieldName, value) != -1) // exists
    {
      if(value[0] == '\000') // description fld is blank
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, itemCode, '\000', data) != -1) // exists
        {
          ...
          if(! unitPriceGiven)
          {
            ...
            getADebitNoteFieldGivenCode(con, stmt, rs, "Currency", code, currency, dnm, localDefnsDir, defnsDir); 
      ...
      else // strip only the first desc line for pdebitL rec
      {
//        baseSellPrice = nonBaseSellPrice * rate;
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE pdebit SET SignOn = '" + unm + "', DateLastModified = NULL WHERE PDNCode = '"
                                   ...
                                   String defnsDir) throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM pdebitll WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) 
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE pdebitll SET Text = '" + sanitisedDesc + "' WHERE PDNCode = '"
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO pdebitll (" + getFieldNamesPurchaseDebitNoteLL() + ") VALUES ('"            
      ...
      {
        stmt.executeUpdate("DELETE FROM pdebitll WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getADebitNoteFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, String dnCode, String dnm, String localDefnsDir,
                                            String defnsDir) throws Exception
  {
    ...
    getADebitNoteFieldGivenCode(con, stmt, rs, fieldName, dnCodeB, value, dnm, localDefnsDir, defnsDir);
    
    return generalUtils.stringFromBytes(value, 0L);
  }
  public void getADebitNoteFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] dnCode, byte[] value, String dnm, String localDefnsDir,
                                          String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT " + fieldName + " FROM pdebit WHERE PDNCode = '" + generalUtils.stringFromBytes(dnCode, 0L)
                                   + "'");
    if(! rs.next())
      value[0] = '\000';
    else
                                        ...
                                        throws Exception
  {
    ...
    String layoutFile="282b.htm";

    short[] fieldSizesPurchaseDebitNoteL = new short[30]; // plenty
    getFieldSizesPurchaseDebitNoteL(fieldSizesPurchaseDebitNoteL);

    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, layoutFile, 1, getFieldNamesPurchaseDebitNoteL(), fieldSizesPurchaseDebitNoteL,
                         null, null, null, null);
    ...
    if(line[0] != '\000') // existing line
    {
      if(code[0] != '\000') // just-in-case
      {
        if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not
        {                            // be in the correct order
          sortFields(dataAlready, data, "pdebitl");
        }
        else
        {
    ...
    else /// new line
    {
      ...
      else
      {
        ...
        scoutln(data, bytesOut, "pdebitl.entry=" + generalUtils.intToStr(nextLine) + "\001");
  
        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "pdebitl.gstrate=" + gstRateDefault + "\001");
      }
      
      newOrEdit = 'N';
    }

    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "pdebitl.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);

    ddlData = inventory.getMfrsDDLData(con, stmt, rs, "pdebitl.manufacturer", ddlData, ddlDataUpto, ddlDataLen);

    getADebitNoteFieldGivenCode(con, stmt, rs, "Currency", code, b, dnm, localDefnsDir, defnsDir);
    scoutln(data, bytesOut, "pdebitl.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "pdebitl.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L),
                    generalUtils.stringFromBytes(line, 0L), "282b.htm", localDefnsDir, defnsDir, prependCode, newOrEdit, req,
                    bytesOut);
                               ...
                               throws Exception
  {
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/PurchaseDebitNoteLineUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1="
    ...
    outputPageFrame(con, stmt, rs, b, req, newOrEdit, ' ', "", "PurchaseDebitNoteLine", "", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      byte[] recData, int recDataLen, byte[] code, int[] bytesOut) throws Exception
  {
    ...
    generalUtils.catAsBytes("PDNCode", 0, str, true);

    if(searchDataString(recData, recDataLen, "pdebit", str, code) == 0)
      return 'N';
    ...
    if(searchDataString(recData, recDataLen, "pdebit", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "pdebit", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "pdebit", fldName, date); // assumes exists
    ...
    String fieldNamesPurchaseDebitNote = getFieldNamesPurchaseDebitNote();
    ...
    {
      getFieldName(fieldNamesPurchaseDebitNote, x, fldName);
      if(searchDataString(recData, recDataLen, "pdebit", fldName, value) != -1) // entry exists
      {
        if(value[0] != '\000')
    ...
    len = fieldNamesPurchaseDebitNote.length();
    int x=0, y, fieldCount=0;
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesPurchaseDebitNote.charAt(x) != ',')
        fldName[y++] = (byte)fieldNamesPurchaseDebitNote.charAt(x++);
      fldName[y] = '\000';
      ++x;
                             ...
                             int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM pdebit WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      rs.close();
      stmt.close();
    ...
    String fieldTypes = getFieldTypesPurchaseDebitNote();
    ...
    {    
      String fieldNames = getFieldNamesPurchaseDebitNote();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "pdebit." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO pdebit (" + getFieldNamesPurchaseDebitNote() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE pdebit SET " + opStr + " WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
                         ...
                         String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesPurchaseDebitNoteL();
      int x=0, count=0;
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO pdebitl (" + getFieldNamesPurchaseDebitNoteL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE pdebitl SET " + opStr + " WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" 
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM pdebitl WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '"
                         + generalUtils.stringFromBytes(line, 0L) + "'");
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM pdebitl WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "pdebitl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "pdebitl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
                                 ...
                                 String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM pdebitll WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
                                ...
                                String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM pdebitll WHERE PDNCode = '" + generalUtils.stringFromBytes(code, 0L)
                                   + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
  ...
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("pdebit"))
      fieldNames = getFieldNamesPurchaseDebitNote();
    else // if(which.equals("pdebitl"))
      fieldNames = getFieldNamesPurchaseDebitNoteL();
    int len = fieldNames.length();
  ...
  public void updatePrices(Connection con, Statement stmt, ResultSet rs, byte[] code, String band, String clear, String unm, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    byte[] rateB = new byte[30];
    getADebitNoteFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir);
    double rate = generalUtils.doubleFromBytesCharFormat(rateB, 0);
                                         ...
                                         String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "282d.htm", 2, getFieldNamesPurchaseDebitNote(), fieldSizesPurchaseDebitNote,
                         getFieldNamesPurchaseDebitNoteL(), fieldSizesPurchaseDebitNoteL, null, null);

    int recDataLen = generalUtils.lengthBytes(data, 0);

    String fieldNamesPDN = getFieldNamesPurchaseDebitNote();
    byte[] value     = new byte[1000]; // plenty - to cover notes
    byte[] fieldName = new byte[50];
    int x=0, y, fieldCount=0;
    int len = fieldNamesPDN.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesPDN.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesPDN.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "pdebit", fieldName, value) != -1) // entry exists
      {
    ...
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "pdebit.Attachments=" + attachments + "\001");
                               ...
                               String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM pdebita WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
                               ...
                               String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "5036", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);

    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Purchase Debit Note" + directoryUtils.buildHelp(5036) + "</td></tr></table>";
...
//    hmenuCount[0] = 1;
    ...
    if(callingServlet.equals("PurchaseDebitNotePage"))
      s += drawOptions5036(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("PurchaseDebitNoteHeaderEdit"))
      s += drawOptions5038(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("PurchaseDebitNoteLine"))
      s += drawOptions5040(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5036(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty, String dnm,
                                 String localDefnsDir, String defnsDir) throws Exception
  {      
    String s = "";
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5038, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pdebit", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:fetch()\">Edit Details</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5040, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pdebit", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:add()\">Add New Line</a></dt></dl>\n";

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "pdebit", date, unm))
    ...
    if(serverUtils.passLockCheck(con, stmt, rs, "pdebit", date, unm))
    {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5038(int[] hmenuCount, char cad, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5040(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
