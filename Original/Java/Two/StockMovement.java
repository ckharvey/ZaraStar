// =======================================================================================================================================================================================================
// System: ZaraStar Product: Stock Movement Report
// Module: StockMovement.java
// Author: C.K.Harvey
...
public class StockMovement extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "StockMovement", bytesOut);
                    ...
                    String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 3055, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "3055", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "3055", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    out.println("<html><head><title>Stock Movement</title></head>");
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "3055", "", "StockMovement", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
                                
    scoutln(out, bytesOut, "<form>");
  
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Stock ReOrder", "3055",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "<a href=\"/central/servlet/StockMovementGenerate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\">");
    ...
    for(int i=0;i<names.length;++i)
    {
      if(names[i].endsWith(".3055"))
      {
        ...
        {
          scoutln(out, bytesOut, "&nbsp;&nbsp;&nbsp;<a href=\"/central/servlet/StockMovementd?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + names[i] + "&bnm=" + bnm + "\">Screen</a>");
      
          scoutln(out, bytesOut, "&nbsp;&nbsp;&nbsp;<a href=\"/central/servlet/RemoveReport?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + names[i] + "&p2=StockMovement&bnm=" + bnm + "\">Remove</a>");
        }
    ...
    scoutln(out, bytesOut, "<tr><td></td><td><a href=\"/central/servlet/StockMovement?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm+"\">");
