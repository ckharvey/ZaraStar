...
public class RATRespondWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String p1, String p2, String p3, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "RATRespond", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "RATRespond", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "5908\001Issues\001Issue Response\001javascript:getHTML('RATRespondWave','')\001\001Y\001\001\003");
                   ...
                   String flashDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    issuesUtils.drawTitleW(con, stmt, rs, req, out, "Respond to Issue " + p1, "5908", p1, true, true, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
    ...
    if(p3.equals("E"))
    {
      ...
      scoutln(out, bytesOut, "<input type=hidden name=codeForEditor value=\"" + p1 + "\001" + p2 + "\">");
    }
    else // new entry, no need to fetch anything
    {
      scoutln(out, bytesOut, "<input type=hidden name=typeForEditor value=\"J\">");
