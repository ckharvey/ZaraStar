// =======================================================================================================================================================================================================
// System: ZaraStar Document: Proforma Invoice Record Access
// Module: ProformaInvoice.java
// Author: C.K.Harvey
// Copyright (c) 2001-15 Christopher Harvey. All Rights Reserved.
//
...
public class ProformaInvoice
{
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringProforma() throws Exception
  {  
    return "proforma ( ProformaCode char(20) not null, Date date not null,         CompanyCode char(20) not null, "
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsProforma(String[] s) throws Exception
  {
    s[0] = "proformaDateInx on proforma (Date)";
    s[1] = "proformaCompanyCodeInx on proforma (CompanyCode)";
    s[2] = "proformaProjectCodeInx on proforma (ProjectCode)";
   
    return 3;
  }
      
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesProforma() throws Exception
  {  
    return "ProformaCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
         ...
         + "ShipAddrCode, PrintCount, Status, unused7, unused8, RevisionOf, BOMCode, BaseGSTTotal, Currency, Rate, "
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesProforma() throws Exception
  {
    return "CDCCCCCCCCCCCDDCCFFFCCCFCCCCSCCIFFCFCCCDCICDDCCFCFCCCCCCFCCCCCCC";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesProforma(short[] sizes) throws Exception
  {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesProforma() throws Exception
  {
    return "MMMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringProformaL() throws Exception
  {  
    return "proformal ( ProformaCode char(20) not null, ItemCode char(20) not null,     Description char(80), "
                     ...
                     + "SignOn char(20),                Amount2 decimal(19,8),          ProfitCentre char(20), "
                     ...
                     + "AltItemCode char(20),           PORefNum char(40),              SOCode char(20), "
                     + "Manufacturer char(30),          ManufacturerCode char(60), " 
                     + "unique(ProformaCode, Line))";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsProformaL(String[] s) throws Exception
  {
    s[0] = "proformalItemCodeInx on proformal(ItemCode)";
    
    return 1;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesProformaL() throws Exception
  {  
    return "ProformaCode, ItemCode, Description, UnitPrice, Quantity, Amount, GSTRate, Discount, DateLastModified, SignOn, "
         + "Amount2, ProfitCentre, AccCode, AppliedStatus, StockUpdated, DateOfStockUpdate, QuantityRequired, CustomerItemCode, "
         + "UoM, Line, Entry, Unused, ReceivedAmount, RefundedAmount, AltItemCode, PORefNum, SOCode, Manufacturer, ManufacturerCode";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesProformaL() throws Exception
  {
    return "CCCFFFCFSCFCCCCDFCCICCFFCCCCC";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesProformaL(short[] sizes) throws Exception
  {
    ...
    sizes[21] = 40;  sizes[22] = 0;   sizes[23] = 0;   sizes[24] = 20;  sizes[25] = 40;  sizes[26] = 20;  sizes[27] = 30;
    sizes[28] = 60;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesProformaL() throws Exception
  {
    return "OOOOOOOOOOOOOOOOOOOMOOOOOOOOO";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringProformaLL() throws Exception
  {  
    return "proformall ( ProformaCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), "
                      + "unique(ProformaCode, Entry, Line))";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsProformaLL(String[] s) throws Exception
  {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesProformaLL() throws Exception
  {  
    return "ProformaCode, Entry, Line, Text";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesProformaLL() throws Exception
  {
    return "CCIC";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesProformaLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesProformaLL() throws Exception
  {
    return "MMMO";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringProformaA() throws Exception
  {  
    return "proformaa ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsProformaA(String[] s) throws Exception
  {
    s[0]="\0"; // remove compiler warning
    return 0;
  }
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesProformaA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesProformaA() throws Exception
  {
    return "CI";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesProformaA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesProformaA() throws Exception
  {
    return "MM";
  }
                              ...
                              char cad, String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    if(cad == 'A' && code[0] == '\000')
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "ProformaInvoice", imagesDir, localDefnsDir, defnsDir, bytesOut);
      return true;
    }
    ...
    {                            // in the correct order
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "proforma");
    }
    ...
    short[] fieldSizesProforma = new short[70]; // plenty
    getFieldSizesProforma(fieldSizesProforma);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesProformaL = new short[30]; // plenty
      getFieldSizesProformaL(fieldSizesProformaL);
      ...
      if(dispOrEdit == 'D')
      {  
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "229.htm", 2, getFieldNamesProforma(),
                                         fieldSizesProforma, getFieldNamesProformaL(), fieldSizesProformaL, null, null);
      }
      else
      {
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "229a.htm", 1, getFieldNamesProforma(),
                                         fieldSizesProforma, null, null, null, null);
      }
      ...
      {
        prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), date, "229a.htm", localDefnsDir, defnsDir,
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        multipleLinesData = getMultipleLines(con, stmt, rs, code, multipleLinesData, multipleListLen, multipleLinesCount, dnm, localDefnsDir,
                                             defnsDir);
        ...
        for(x=0;x<linesCount[0];++x)
        {
          if(generalUtils.getListEntryByNum(x, linesData, data)) // just-in-case
          {
            ...
            generalUtils.bytesDPsGivenSeparator(true, '\001', dpOnUnitPrice,  data, 5000, 6);  // amount
            generalUtils.bytesDPsGivenSeparator(true, '\001', dpOnUnitPrice,  data, 5000, 11); // amount2
            ...
            screenLayout.bufferToBuffer(buf1, buf2, size1, size2, source, numFields, fieldNames, fieldTypes, fieldSizes, 'D', 'L', data, 5000, ddlData, ddlDataUpto[0],
        ...
        stmt.executeUpdate("UPDATE proforma SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " 
                         + totalGSTAmt2Lines + ", BaseTotalTotal = " + (totalAmtLines + totalGSTAmtLines) + ", BaseGSTTotal = "
                         + totalGSTAmtLines + " WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
        stmt.close();
        ...
        scoutln(headData, bytesOut, "proforma.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen
        ...
        scoutln(headData, bytesOut, "proforma.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 49); // rate
        scoutln(headData, bytesOut, "proforma.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)49) + "\001");
        ...
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "proforma.Attachments=" + attachments + "\001");
      }
      else // edit
      {
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "proforma.Currency", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
        ddlData = documentUtils.getSalesPersonDDLData(con, stmt, rs, "proforma.SalesPerson", ddlData, ddlDataUpto, ddlDataLen);
        ddlData = documentUtils.getCountryDDLData(con, stmt, rs, "proforma.Country", ddlData, ddlDataUpto, ddlDataLen);
    ...
    {
      numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "229a.htm", 1,
                                       getFieldNamesProforma(), fieldSizesProforma, null, null, null, null);

      if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not
      {                            // be in the correct order
        sortFields(dataAlready, data, "proforma");
      }  
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "proforma", data);

        documentUtils.getNextCode(con, stmt, rs, "proforma", true, code);

        generalUtils.repAlphaUsingOnes(data, 5000, "ProformaCode", generalUtils.stringFromBytes(code, 0L));
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L), date, "229a.htm", localDefnsDir,
  ...
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=proformal.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4088, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "proforma", date, unm))
                          ...
                          String den, String dnm, String bnm, byte[] b, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4074, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/ProformaInvoiceLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                       ...
                       String code, String date, byte[] b, HttpServletRequest req, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4084, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function fetch(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/ProformaInvoiceHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty="
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty="
                           + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=PRO\";}");
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6098, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/DocumentChangeDiscounts?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
                           + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=PRO\";}");
      }
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4086, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function add(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/ProformaInvoiceLine?unm=" + unm + "&sid=" + sid
                         + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=&p3=&p4=\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 1025, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/DocumentTraceExecute?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                           + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=R\");}");
    }
    ...
    {
      String projectCode = getAProformaFieldGivenCode(con, stmt, rs, "ProjectCode", code);
      String companyCode = getAProformaFieldGivenCode(con, stmt, rs, "CompanyCode", code);
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/MailExternalUserCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm="
              + dnm + "&p6=C&p4=" + companyCode + "&p5=" + projectCode + "&p1=ProformaInvoiceRegisteredUser&p2=" + code2
                         + "&p3=Proforma%20Invoice&bnm=" + bnm + "\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4089, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function print(option){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControl?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=ProformaInvoicesPrint&p2=" + code2 + "&p3=\"+option;}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11200, unm, uty, dnm, localDefnsDir, defnsDir) && authenticationUtils.verifyAccess(con, stmt, rs, req, 4089, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PrintToPDFUtils?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
                         + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p3=" + code2 + "&p1=0.000&p5=ProformaInvoice&p2=ProformaInvoicesPrint\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4186, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/FaxCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men
                         + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=R&p3=ProformaInvoicesPrint&p4=&p5=Proforma%20Invoice\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 12708, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/ChannelSendDirect?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                         ...
                         + "&p2=Proforma_Invoice&p3=Requested%20Proforma%20Invoice%20Sent (" + generalUtils.sanitise(code2)+ ")\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4090, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function invoice(){var p1='CREATEBASEDONPROFORMA:'+'" + code + "';");
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', ' ', "", "ProformaInvoicePage", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                           ...
                           HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/ProformaInvoiceHeaderUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1="
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', cad.charAt(0), "", "ProformaInvoiceHeaderEdit", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      char cad, byte[] recData, int recDataLen, byte[] rtnLineBytes, int[] bytesOut) throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "proformal", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "proformal"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesProformaL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "proformal", fieldName, value) != -1) // entry exists
      {
    ...
    getAProformaFieldGivenCode(con, stmt, rs, "Rate", code, rateB); // getCurrencyRateGivenCode
    ...
    if(   searchDataString(recData, recDataLen, "proformal", fieldName, value) != -1 // exists
       && value[0] != '\000')
    {
    ...
    if(searchDataString(recData, recDataLen, "proformal", fieldName, value) != -1) // exists
    {
      if(value[0] == '\000') // description fld is blank
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, itemCode, '\000', data) != -1) // exists
        {
          ...
          if(! unitPriceGiven)
          {
            ...
            getAProformaFieldGivenCode(con, stmt, rs, "Currency", code, currency); 
      ...
      else // strip only the first desc line for proformaL rec
      {
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE proforma SET SignOn = '" + unm + "', DateLastModified = NULL WHERE ProformaCode = '"
                                     ...
                                     String defnsDir) throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM proformall WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) 
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE proformall SET Text = '" + sanitisedDesc + "' WHERE ProformaCode = '"
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO proformall (" + getFieldNamesProformaLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L)
      ...
      {
        stmt.executeUpdate("DELETE FROM proformall WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public String getAProformaFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, String proformaCode) throws Exception
  {
    byte[] value = new byte[300]; // plenty
    byte[] b     = new byte[21];
    generalUtils.strToBytes(b, proformaCode);
    
    getAProformaFieldGivenCode(con, stmt, rs, fieldName, b, value);
    
    return generalUtils.stringFromBytes(value, 0L);
  }
  public void getAProformaFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] proformaCode, byte[] value)
                                         throws Exception
  {
    if(proformaCode[0] == '\000') // just-in-case
      return;

    generalUtils.toUpper(proformaCode, 0);

    stmt = con.createStatement();
  
    rs = stmt.executeQuery("SELECT " + fieldName + " FROM proforma WHERE ProformaCode = '"
                                     + generalUtils.stringFromBytes(proformaCode, 0L) + "'");
    if(! rs.next())
      value[0] = '\000';
    else
    {    
                                        ...
                                        throws Exception
  {
    ...
    if(line[0] != '\000') // existing line
    {
      if(code[0] != '\000') // just-in-case
      {
        if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not
        {                            // be in the correct order
          sortFields(dataAlready, data, "proformal");
        }
        else
        {
    ...
    else /// new line
    {
      ...
      {
        data[0]= '\000';
        scoutln(data, bytesOut, "proformal.entry=" + generalUtils.intToStr(nextLine) + "\001");

        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "proformal.gstrate=" + gstRateDefault + "\001");
      }
      newOrEdit = 'N';
    }

    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "proformal.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);

    ddlData = inventory.getMfrsDDLData(con, stmt, rs, "proformal.manufacturer", ddlData, ddlDataUpto, ddlDataLen);

    getAProformaFieldGivenCode(con, stmt, rs, "Currency", code, b);
    scoutln(data, bytesOut, "proformal.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "proformal.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L),
                    generalUtils.stringFromBytes(line, 0L), "229b.htm", localDefnsDir, defnsDir, prependCode, newOrEdit, req,
                    bytesOut);
                               ...
                               throws Exception
  {
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/ProformaInvoiceLineUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1="
    ...
    outputPageFrame(con, stmt, rs, b, req, newOrEdit, ' ', "", "ProformaInvoiceLine", "", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      String defnsDir, char cad, byte[] recData, int recDataLen, byte[] code, int[] bytesOut) throws Exception
  {
    ...
    generalUtils.catAsBytes("ProformaCode", 0, str, true);

    if(searchDataString(recData, recDataLen, "proforma", str, code) == 0)
      return 'N';
    ...
    if(searchDataString(recData, recDataLen, "proforma", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "proforma", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "proforma", fldName, date); // assumes exists
    ...
    String fieldNamesProforma = getFieldNamesProforma();
    ...
    {
      getFieldName(fieldNamesProforma, x, fldName);
      if(searchDataString(recData, recDataLen, "proforma", fldName, value) != -1) // entry exists
      {
        if(value[0] != '\000')
    ...
    len = fieldNamesProforma.length();
    int x=0, y, fieldCount=0;
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesProforma.charAt(x) != ',')
        fldName[y++] = (byte)fieldNamesProforma.charAt(x++);
      fldName[y] = '\000';
      ++x;
                              ...
                              int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM proforma WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      rs.close();
      stmt.close();
    ...
    String fieldTypes = getFieldTypesProforma();
    ...
    {    
      String fieldNames = getFieldNamesProforma();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "proforma." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  public String getValue(int colNum, char type, ResultSet rs, ResultSetMetaData rsmd)
  {
    ...
    try
    {
      ...
      String str="";
//System.out.println(java.sql.Types.CHAR+ " "+java.sql.Types.INTEGER + " " + java.sql.Types.DECIMAL+">>> " + colNum + " " +rsmd.getColumnType(colNum));
  ...
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO proforma (" + getFieldNamesProforma() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE proforma SET " + opStr + " WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
                         ...
                         String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesProformaL();
      int x=0, count=0;
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO proformal (" + getFieldNamesProformaL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE proformal SET " + opStr + " WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" 
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM proformal WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '"
                         + generalUtils.stringFromBytes(line, 0L) + "'");
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM proformal WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "proformal." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "proformal." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
                                   ...
                                   String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM proformall WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
                                  ...
                                  String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM proformall WHERE ProformaCode = '" + generalUtils.stringFromBytes(code, 0L)
                                   + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void prependDisplayOnly(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, String code2, String date, String unm, String sid, String uty, String men, String den,
  ...
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("proforma"))
      fieldNames = getFieldNamesProforma();
    else // if(which.equals("proformal"))
      fieldNames = getFieldNamesProformaL();
    int len = fieldNames.length();
  ...
  public void updatePrices(Connection con, Statement stmt, ResultSet rs, byte[] code, String band, String clear, String unm, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    byte[] rateB = new byte[30];
    getAProformaFieldGivenCode(con, stmt, rs, "Rate", code, rateB);
    double rate = generalUtils.doubleFromBytesCharFormat(rateB, 0);
                                         ...
                                         String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "229d.htm", 2,
                                     getFieldNamesProforma(), fieldSizesProforma, getFieldNamesProformaL(), fieldSizesProformaL, null, null);
    ...
    int x=0, y, fieldCount=0;
    int len = fieldNamesProforma.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesProforma.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesProforma.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "proforma", fieldName, value) != -1) // entry exists
      {
    ...
    generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  data, 3000, 56); // baseTotalTotal
    generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  data, 3000, 47); // baseGSTTotal
    ...
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "proforma.Attachments=" + attachments + "\001");
                               ...
                               String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM proformaa WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
                               ...
                               String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "4080", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);

    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Proforma Invoice" + directoryUtils.buildHelp(4080) + "</td></tr></table>";
                                  ...
                                  int[] hmenuCount) throws Exception
  {
    ...
    if(callingServlet.equals("ProformaInvoicePage"))
      s += drawOptions4080(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("ProformaInvoiceHeaderEdit"))
      s += drawOptions4084(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("ProformaInvoiceLine"))
      s += drawOptions4086(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
    else
    if(callingServlet.equals("OrderAcknowledgementRegisteredUser"))
      s += drawOptions4127(con, stmt, rs, req, hmenuCount, unm, uty, dnm, localDefnsDir, defnsDir);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4080(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty, String dnm,
                                 String localDefnsDir, String defnsDir) throws Exception
  {      
    String s = "";
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4084, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "proforma", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:fetch()\">Edit Details</a></dt></dl>\n";
   
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4086, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "proforma", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:add()\">Add New Line</a></dt></dl>\n";
  
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "proforma", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:attach()\">Attachments</a></dt></dl>\n";
    
    boolean ProformaInvoicesPrint  = authenticationUtils.verifyAccess(con, stmt, rs, req, 4089, unm, uty, dnm, localDefnsDir, defnsDir);
    boolean _4186  = authenticationUtils.verifyAccess(con, stmt, rs, req, 4186, unm, uty, dnm, localDefnsDir, defnsDir);
    ...
    if(ProformaInvoicesPrint || _4186 || MailExternalUserCreate || PrintToPDFUtils || ChannelSendDirect)
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0] + "');\">Send</dt><dd id='hmenu" + hmenuCount[0]++ + "'><ul>";
      if(ProformaInvoicesPrint)
      {
        s += "<li><a href=\"javascript:print(' ')\">Print (Proforma)</a></li>";
        s += "<li><a href=\"javascript:print('2')\">Print (Shipping)</a></li>";
        s += "<li><a href=\"javascript:print('3')\">Print (Commercial)</a></li>";
        s += "<li><a href=\"javascript:print('4')\">Print (Packing)</a></li>";
        s += "<li><a href=\"javascript:print('5')\">Print (Temp-DO)</a></li>";
      }
      if(_4186)
    ...
    if(serverUtils.passLockCheck(con, stmt, rs, "proforma", date, unm))
    {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4084(int[] hmenuCount, char cad, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4086(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm)
                                 throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4127(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String unm, String uty, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {      
    boolean  ProformaInvoicesPrint = authenticationUtils.verifyAccess(con, stmt, rs, req, 4089,  unm, uty, dnm, localDefnsDir, defnsDir);
    boolean PrintToPDFUtils = authenticationUtils.verifyAccess(con, stmt, rs, req, 11200, unm, uty, dnm, localDefnsDir, defnsDir);
    ...
    if(ProformaInvoicesPrint || PrintToPDFUtils || SendToCSVUtils)
    {
      if(ProformaInvoicesPrint)
      {
        s += "<li><a href=\"javascript:print(' ')\">Print (Proforma)</a></li>";
