// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Stock Categories Definition - List by Manufacturer
// Module: AdminStockCategoryDefinitionManufacturer.java
// Author: C.K.Harvey
...
public class AdminStockCategoryDefinitionManufacturer extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 7071, bytesOut[0], 0, "ERR:");
                    ...
                    int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "7071d", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7071, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "7071d", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7071, bytesOut[0], 0, "SID:");
                      ...
                      String men, String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "function fetch(mfr){p1=sanitise(mfr);");
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/AdminStockCategoriesDefinition?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
    ...
    scoutln(out, bytesOut, "<form><table id=\"page\" border=0 width=100% cellpadding=2 cellspacing=2>");
    ...
    scoutln(out, bytesOut, "<td nowrap><p>Manufacturer &nbsp;</td></tr>");
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void list(Connection con, Statement stmt, ResultSet rs, PrintWriter out, String dnm, String localDefnsDir, String defnsDir,
                    int[] bytesOut) throws Exception
  {
    try
    {
      ...
      while(rs.next())                  
      {
        ...
        scoutln(out, bytesOut, "<td nowrap><a href=\"javascript:fetch('" + mfr + "')\">" + mfr + "</td></tr>");
      }
