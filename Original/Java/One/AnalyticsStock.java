// =======================================================================================================================================================================================================
// System: ZaraStar: Analytic: Stock
// Module: AnalyticsStock.java
// Author: C.K.Harvey
...
public class AnalyticsStock extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007b: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AnalyticsStock", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AnalyticsStock", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AnalyticsStock", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String uty, String men, String den, String dnm, String bnm, String workingDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, account, p2, p3, "", "", "AnalyticsStock", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    String year = generalUtils.getFromDefnFile(unm, "accounts.dfn", workingDir, "");

    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AnalyticsStock", account, dateFrom, dateTo, "", "", "GL Account: " + account + " - " + accountsUtils.getAccountDescriptionGivenAccCode(account, year, dnm, localDefnsDir, defnsDir) + " ("
  ...
  {
    String purchases = accountsUtils.getPurchasesAccCode(year, dnm, localDefnsDir, defnsDir);

    onPurchaseInvoiceLine(con, stmt, stmt2, rs, rs2, purchases, year, dateFrom, dateTo, tmpTable);

    boolean useWAC = false;
    if(miscDefinitions.inventoryCostingMethod(con, stmt, rs).equals("WAC"))
      useWAC = true;
    
    onInvoiceLine(useWAC, con, accCon, stmt, stmt2, rs, rs2, dateFrom, dateTo, financialYearStartDate, tmpTable, dnm);
    onSalesCreditNoteLine(useWAC, con, accCon, stmt, stmt2, rs, rs2, dateFrom, dateTo, previousFinancialYearStartDate, tmpTable, dnm);
