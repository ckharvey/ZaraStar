// =======================================================================================================================================================================================================
// System: ZaraStar: Accounts: GL Other Creditors
// Module: AccountsGLOtherCreditors.java
// Author: C.K.Harvey
...
public class AccountsGLOtherCreditors extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007x: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AccountsGLOtherCreditors", bytesOut);
                    ...
                    String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AccountsGLOtherCreditors", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AccountsGLOtherCreditors", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, HttpServletRequest req, String dateFrom, String dateTo, String p1, String p2, String p3, boolean plain,
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>GL Account: Other Creditors</title>");
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, "", p2, p3, "", "", "AccountsGLOtherCreditors", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AccountsGLOtherCreditors", otherCreditorsAccount, dateFrom, dateTo, "", "", "GL Account: " + otherCreditorsAccount + " - "
                                                                                                  + accountsUtils.getAccountDescriptionGivenAccCode(otherCreditorsAccount, year, dnm, localDefnsDir, defnsDir) + " ("
                                                                                                  + accountsUtils.getAccountCurrencyGivenAccCode(otherCreditorsAccount, year, dnm, localDefnsDir, defnsDir) + " "
                                                                                                  + accountsUtils.getAccountDrCrGivenAccCode(otherCreditorsAccount, year, dnm, localDefnsDir, defnsDir) + ")", "6007", unm, sid, uty, men, den, dnm, bnm,
                      hmenuCount, bytesOut);
    }
    else
    {
      pageFrameUtils.drawTitle(out, false, plain, "", "", "", "", "", "", "GL Account: " + otherCreditorsAccount + " - " + accountsUtils.getAccountDescriptionGivenAccCode(otherCreditorsAccount, year, dnm, localDefnsDir, defnsDir) + " ("
                                                               + accountsUtils.getAccountCurrencyGivenAccCode(otherCreditorsAccount, year, dnm, localDefnsDir, defnsDir) + " " + accountsUtils.getAccountDrCrGivenAccCode(otherCreditorsAccount, year, dnm, localDefnsDir, defnsDir) + ")", "",
    ...
    calc(con, stmt, stmt2, rs, rs2, p1, year, otherCreditorsAccount, dateFrom, dateTo, dnm, localDefnsDir, defnsDir, tmpTable);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public void calc(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, String account, String year, String otherCreditorsAccount, String dateFrom, String dateTo, String dnm, String localDefnsDir, String defnsDir,
                   String tmpTable) throws Exception
  {    
    onVoucherLines(con, stmt, stmt2, rs, otherCreditorsAccount, dateFrom, dateTo, tmpTable);
    onRVoucherLines(con, stmt, stmt2, rs, otherCreditorsAccount, dateFrom, dateTo, tmpTable);

    onPurchaseInvoice(con, stmt, stmt2, rs, rs2, dateFrom, dateTo, tmpTable);
    onPurchaseDebitNote(con, stmt, stmt2, rs, rs2, dateFrom, dateTo, tmpTable);
    onPurchaseCreditNote(con, stmt, stmt2, rs, rs2, dateFrom, dateTo, tmpTable);
    onPayment(con, stmt, stmt2, rs, rs2, dateFrom, dateTo, tmpTable);
    onIATCr(con, stmt, stmt2, rs, otherCreditorsAccount, dateFrom, dateTo, tmpTable);
    onIATDr(con, stmt, stmt2, rs, otherCreditorsAccount, dateFrom, dateTo, tmpTable);
    onBatchCr(con, stmt2, year, otherCreditorsAccount, dateFrom, dateTo, tmpTable, dnm, localDefnsDir, defnsDir);
    onBatchDr(con, stmt2, year, otherCreditorsAccount, dateFrom, dateTo, tmpTable, dnm, localDefnsDir, defnsDir);
  }

  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onVoucherLines(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String otherCreditorsAccount, String dateFrom,
                              String dateTo, String tmpTable) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT t2.VoucherCode, t1.CompanyName, t2.Amount2, t2.Amount, t1.Date, t1.Currency "
                         ...
                         + otherCreditorsAccount + "' AND t1.Status != 'C' AND t1.Date >= {d '" + dateFrom + "'} AND t1.Date <= {d '" + dateTo
                         + "'}");
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onRVoucherLines(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String otherCreditorsAccount, String dateFrom,
                               String dateTo, String tmpTable) throws Exception
  {
    stmt = con.createStatement();
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onPurchaseInvoice(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, String dateFrom, String dateTo,
                                 String tmpTable) throws Exception
  {
    stmt = con.createStatement();
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onPurchaseDebitNote(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, String dateFrom, String dateTo,
                                   String tmpTable) throws Exception
  {
    stmt = con.createStatement();
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onPurchaseCreditNote(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, String dateFrom, String dateTo,
                                    String tmpTable) throws Exception
  {
    stmt = con.createStatement();
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onPayment(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, String dateFrom, String dateTo,
                         String tmpTable) throws Exception
  {
    stmt = con.createStatement();
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      {    
        ...
        if(baseAmount != 0.0)
        {
          addToTmpTable(con, stmt2, "B", accRs.getString(1), accRs.getString(2), amount, baseAmount, accRs.getString(5), accRs.getString(6), "",
                        tmpTable);
        }
      }
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      {    
        ...
        if(baseAmount != 0.0)
        {
          addToTmpTable(con, stmt2, "C", accRs.getString(1), accRs.getString(2), amount, baseAmount, accRs.getString(5), accRs.getString(6), "",
                        tmpTable);
        }
      }
