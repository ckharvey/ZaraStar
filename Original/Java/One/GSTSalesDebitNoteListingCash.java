// =======================================================================================================================================================================================================
// System: ZaraStar Document: GST: DNs listing (cash)
// Module: GSTSalesDebitNoteListingCash.java
// Author: C.K.Harvey
...
public class GSTSalesDebitNoteListingCash extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "GSTSalesDebitNoteListingCash", bytesOut);
                    ...
                    String dnm, String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "GSTSalesDebitNoteListingCash", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
                        ...
                        String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT DISTINCT t1.DNCode, t1.Date, t1.CompanyCode, t1.BaseGSTTotal, t1.BaseTotalTotal, "
                                   + " t1.TotalTotal, t1.GSTTotal, t1.Currency FROM debitl AS t2 INNER JOIN debit AS t1 "
                                   + "ON t2.DNCode = t1.DNCode WHERE t1.Date >= {d '" + dateFrom
  ...
  private void setHead(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, boolean plain, String dateFrom, String dateTo, String gstRate, String unm, String sid, String uty, String men,
                       ...
                       throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>GST Debit Note Listing</title>");
    ...
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/SalesDebitNotePage?unm=" + unm + "&sid="
    ...
    outputPageFrame(con, stmt, rs, out, req, plain, dateFrom, dateTo, gstRate, "", "GST Reconciliation: Debit Note Listing", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, bytesOut);
  ...
  private String buildSubMenuText(boolean plain, String dateFrom, String dateTo, String gstRate, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] hmenuCount) throws Exception
  {
    ...
    if(! plain)
    {
      ...
      s += "<a href=\"/central/servlet/GSTSalesDebitNoteListingCash?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + dateFrom + "&p2=" + dateTo + "&p3=" + generalUtils.sanitise(gstRate) + "&p4=P\">Friendly</a></dt></dl>";
    }
