// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Country definition - fetch for edit
// Module: AdminCountryDefinitionEdit.java
// Author: C.K.Harvey
...
public class AdminCountryDefinitionEdit extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7057c: " + e));
      res.getWriter().write("Unexpected System Error: 7057c");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String name, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7057c";
  ...
  private boolean fetch(String dnm, String name, String[] posn) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Position FROM country WHERE Name = '" + name + "'"); 
