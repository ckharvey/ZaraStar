...
public class BlogsSave extends HttpServlet
{
  ...
  {
    URL url = new URL("http://" + serverUtils.serverToCall("INFO", localDefnsDir) + "/central/servlet/BlogsDisplay?unm=" + unm  + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + unm + "&topic=" + generalUtils.sanitise(topic)
