...
public class FaxCreateWave extends HttpServlet
{
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, String p5, int[] bytesOut) throws Exception
  {
    ...
    try
    {
      ...
      {
        messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "FaxCreate", imagesDir, localDefnsDir, defnsDir, bytesOut);
      ...
      {
        messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "FaxCreate", imagesDir, localDefnsDir, defnsDir, bytesOut);
      ...
      scoutln(out, bytesOut, "11002\001Fax\001Fax: " + p1 + "\001javascript:getHTML('FaxCreateWave','" + p1 + "')\001\001Y\001\001\003");
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String docCode, String docType, String servlet, String option, String docName, String unm, String sid, String uty, String men, String den,
                   String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "function send(){postFORM('FaxSendw','11002w');}");
    ...
    scoutln(out, bytesOut, "<form id=\"11002w\" enctype=\"application/x-www-form-urlencoded\" method=post>");
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void get(Connection con, Statement stmt, ResultSet rs, PrintWriter out, String docCode, String docType, String docName, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String localDefnsDir,
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<tr><td><p>Your Phone Number:</td><td><p><input type=text name=senderPhone size=30 maxlength=60 value=\"" + senderPhone[0] + "\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>Your Fax Number:</td><td><p><input type=text name=senderFax size=30 maxlength=60 value=\"" + senderFax[0] + "\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>Your Name:</td><td><p><input type=text name=senderName size=60 value=\"" + senderName + "\"></td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>Your Company:</td><td><p><input type=text name=senderCompany size=60 value=\"" + senderCompany[0] + "\"></td></tr>");
