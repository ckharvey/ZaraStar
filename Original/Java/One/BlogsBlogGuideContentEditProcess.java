...
public class BlogsBlogGuideContentEditProcess extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "BlogsBlogGuideContentEditProcess", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "BlogsBlogGuideContentEditProcess", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "BlogsBlogGuideContentEditProcess", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Blogs - Edit BlogGuide</title>");
    ...
    scoutln(out, bytesOut, "var url=\"http://" + men + "/central/servlet/BlogsBlogGuideContentUpdate?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "var url=\"http://" + men + "/central/servlet/BlogsBlogGuideContentDelete?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "var url=\"http://" + men + "/central/servlet/BlogsBlogGuideContentEditFetch?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
                         + den + "') + \"&bnm=\" + escape('" + bnm + "') + \"&p1=" + generalUtils.sanitise(name) + "&p2=\" + escape(section) + \"&dnm=\" + escape('" + dnm + "');");
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/BlogsBlogGuideContentEditProcess?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + generalUtils.sanitise(name) + "&bnm=" + bnm + "\");}");

    scoutln(out, bytesOut, "</script>");

    int[] hmenuCount = new int[1];

    blogGuideUtils.outputPageFrame(con, stmt, rs, out, req, "", "BlogsBlogGuideContentEdit", "8112", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    blogGuideUtils.drawTitle(con, stmt, rs, req, out, "Blogs - Edit BlogGuide Contents for " + name, "8112", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
