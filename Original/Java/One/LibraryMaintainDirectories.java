...
// Module: LibraryMaintainDirectories.java
// Author: C.K.Harvey
...
public class LibraryMaintainDirectories extends HttpServlet
{
                    ...
                    String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "LibraryMaintainDirectories", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryMaintainDirectories", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void display(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String option, String unm, String sid,
                       String uty, String men, String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) 
                       throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Library: Maintain Directories</title>");
    ...
    libraryUtils.drawTitle(con, stmt, rs, req, out, "Directory List: User Selection", "12014", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
