// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Person Positioning - update
// Module: AdminPersonPositioningUpdate.java
// Author: C.K.Harvey
...
public class AdminPersonPositioningUpdate extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7056a: " + e));
      res.getWriter().write("Unexpected System Error: 7056a");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String name, String posn, String newOrEdit, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7056a";
    ...
    serverUtils.totalBytes(req, unm, dnm, 7056, bytesOut[0], 0, name);
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // rtns: ' ' if rec added/updated ok
  //       'X' other error
  private char update(String dnm, String name, String posn) throws Exception
  {
    Connection con = null;
    Statement stmt = null;
    ResultSet rs   = null;
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT UserCode FROM personposition WHERE UserCode = '" + name + "'");
      if(rs.next())
        alreadyExists = true;
      if(rs   != null) rs.close();
      ...
      if(! alreadyExists)
      {
        ...
        String q = "INSERT INTO personposition ( UserCode, Position ) VALUES ('" + name + "','" + posn + "')";
      ...
      String q = "UPDATE personposition SET Position = '" + posn + "' WHERE UserCode = '" + name + "'";
