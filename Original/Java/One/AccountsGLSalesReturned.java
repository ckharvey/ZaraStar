// =======================================================================================================================================================================================================
// System: ZaraStar: Accounts: GL Sales Returned
// Module: AccountsGLSalesReturned.java
// Author: C.K.Harvey
...
public class AccountsGLSalesReturned extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007k: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AccountsGLSalesReturned", bytesOut);
                    ...
                    String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AccountsGLSalesReturned", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AccountsGLSalesReturned", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, account, p2, p3, "", "", "AccountsGLSalesReturned", unm, sid, uty, men, den, dnm, bnm,
    ...
    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AccountsGLSalesReturned", account, dateFrom, dateTo, "", "", "GL Account: " + account + " - " + accountsUtils.getAccountDescriptionGivenAccCode(account, year, dnm, localDefnsDir, defnsDir) + " ("
  ...
  {
    String salesReturnedAccount = accountsUtils.getSalesReturnedAccCode(year, dnm, localDefnsDir, defnsDir);

    onSalesCreditNote(con, stmt, stmt2, rs, salesReturnedAccount, dateFrom, dateTo, tmpTable);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onSalesCreditNote(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String salesReturnedAccount, String dateFrom, String dateTo, String tmpTable)
                            throws Exception
  {
    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT t2.CNCode, t1.CompanyName, t2.Amount2, t2.Amount, t1.Date, t1.Currency, t2.ItemCode, t2.Quantity "
                         + "FROM creditl AS t2 INNER JOIN credit AS t1 ON t1.CNCode = t2.CNCode WHERE Category = '" + salesReturnedAccount
    ...
    {    
      ...
      addToTmpTable(con, stmt2, "N", rs.getString(1), rs.getString(2), amount, baseAmount, rs.getString(5), rs.getString(6), tmpTable);
    }
