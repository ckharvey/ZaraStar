// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Country Definition
// Module: AdminCountryDefinition.java
// Author: C.K.Harvey
...
public class AdminCountryDefinition extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AdminCountryDefinition", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7057, bytesOut[0], 0, "ERR:");
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "7057", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7057, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "7057", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7057, bytesOut[0], 0, "SID:");
      if(con != null) con.close();
      if(out != null) out.flush();
      return;
    }
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 7057, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
    if(con != null) con.close();
    if(out != null) out.flush();
  }
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Admin - Country Definition</title>");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminCountryDefinitionUpdate?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminCountryDefinitionDelete?unm=\" + escape('" + unm
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminCountryDefinitionEdit?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "messageElement.innerHTML='<p><a href=\"javascript:updateE()\">Update the Country</a>';");
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/AdminCountryDefinition?unm=" + unm + "&sid=" + sid + "&uty="
    ...
    dashboardUtils.drawTitle(out, "Countries", "7057", unm, sid, uty, men, den, dnm, bnm, bytesOut);
    ...
    scoutln(out, bytesOut, "<td align=center><p>&nbsp; Country Name &nbsp;</td>");
    ...
    scoutln(out, bytesOut, "<td><input type=text name=posn size=4 maxlength=4></td></tr>");
    
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=3><span id=\"option\"><p><a href=\"javascript:updateN()\">Add the Country</a></span></td></tr>");
  ...
  private void list(Connection con, Statement stmt, ResultSet rs, PrintWriter out, int[] bytesOut) throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT * FROM country ORDER BY Position");

      String name, count, cssFormat = "";
      ...
      while(rs.next())                  
      {
        ...
        scoutln(out, bytesOut, "<td nowrap align=center>" + name + "</td><td nowrap align=center>" + count + "</td>");
