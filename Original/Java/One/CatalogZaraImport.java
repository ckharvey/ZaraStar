// =======================================================================================================================================================================================================
// System: ZaraStar Product: Import Zara-format Catalog
// Module: CatalogZaraImport.java
// Author: C.K.Harvey
...
public class CatalogZaraImport extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "CatalogZaraImport", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 2010, bytesOut[0], 0, "ERR:");
                    ...
                    String bnm, int[] bytesOut) throws Exception
  {
   ...
   Statement stmt = null;
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "CatalogZaraImport", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 2010, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "CatalogZaraImport", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 2010, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 2010, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
                   ...
                   String bnm, String workingDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<form enctype=\"multipart/form-data\" action=\"" + directoryUtils.getScriptsDirectory() + "importSCcatalog.php\"" + "method=\"post\">");
    ...
    scoutln(out, bytesOut, "The import process will overwrite any existing entries for the manufacturer.</td></tr>");

    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");

    scoutln(out, bytesOut, "<tr><td><p>Manufacturer</td>");
    scoutln(out, bytesOut, "<td><p><input type=text name=\"mfr\" size=30 maxsize=30></td></tr>");
