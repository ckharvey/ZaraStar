...
// Module: AdminBankAccountDefinitionDelete.java
// Author: C.K.Harvey
...
public class AdminBankAccountDefinitionDelete extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7067b: " + e));
      res.getWriter().write("Unexpected System Error: 7067b");
    }
  }
                    ...
                    String code, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7067b";
  ...
  private boolean deleteRec(String dnm, String code, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM bankaccount WHERE BankAccountName = '" + code + "'");
