...
public class AdminServicesAccessUpdateWave extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    String unm="", sid="", uty="", men="", den="", dnm="", bnm="", service="", option="", previousService="";
    ...
    try
    {
      ...
      while(en.hasMoreElements())
      {
        ...
        if(name.equals("previousService"))
          previousService = value[0];
        else
        {
      ...
      doIt(out, req, unm, sid, uty, men, den, dnm, bnm, numUsers, users, service, option, previousService, bytesOut);
    }
    catch(Exception e)
    {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int numUsers, String[] users, String service, String option, String previousService, int[] bytesOut)
                    throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AdminServicesAccessUpdate", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AdminServicesAccessUpdate", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    refetch(out, unm, sid, uty, dnm, men, den, bnm, localDefnsDir, option, previousService, bytesOut);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void refetch(PrintWriter out, String unm, String sid, String uty, String dnm, String men, String den, String bnm, String localDefnsDir, String option, String previousService, int[] bytesOut) throws Exception
  {
    URL url = new URL("http://" + serverUtils.serverToCall("OFSA", localDefnsDir) + "/central/servlet/OptionTabsWave?p1=" + option + "&p2=" + previousService + "&unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm
                    + "&bnm=" + bnm);
