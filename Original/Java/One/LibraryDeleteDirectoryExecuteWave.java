...
// Module: LibraryDeleteDirectoryExecuteWave.java
// Author: C.K.Harvey
...
public class LibraryDeleteDirectoryExecuteWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String p1, String p2, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "LibraryDeleteDirectorya", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryDeleteDirectorya", imagesDir, localDefnsDir, defnsDir, bytesOut);
...
////    generalUtils.directoryHierarchyDelete(p1); // deletes entire hierarchy!
