...
// Module: LibraryFileCheckInWave.java
// Author: C.K.Harvey
...
public class LibraryFileCheckInWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "12005\001Documents\001Document CheckIn\001javascript:getHTML('LibraryFileCheckInw','&p1=" + p1 + "')\001\001Y\001\001\003");
                   ...
                   int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "function checkin(docName,directory,userName){p2=sanitise(docName);p3=sanitise(directory);p4=sanitise(userName);getHTML('LibraryFileCheckInaw','&p2='+p2+'&p3='+p3+'&p4='+p4+'&p1=" + docCode + ");");
    ...
    scoutln(out, bytesOut, "<tr><td colspan=2><p><a href=\"javascript:checkin('" + docName[0] + "','" + directory[0] + "','" + userName[0] + "')\">Check-In</a> the Document</td></tr>");
