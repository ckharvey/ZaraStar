// =======================================================================================================================================================================================================
// System: ZaraStar Utils: fetch Carousel
// Module: FetchCarousel.java
// Author: C.K.Harvey
...
public class FetchCarousel extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 12603a: " + e));
      res.getWriter().write("Unexpected System Error: 12603a");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    String rtn = "Unexpected System Error: 12603aw";
    ...
    serverUtils.totalBytes(req, unm, dnm, 12603, bytesOut[0], 0, "");
  }
  ...
  private void mergeData(HttpServletResponse res, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    String s = "{ items: ["
             ...
             + "{ \"thumb\" : \"http://www.zarastar.org/Zara/Support/Images/1100.gif\","
	         + "\"large\":\"http://www.zarastar.org/Zara/Support/Images/1100.gif\","
	         + "\"title\":\"Drink Coffee - Dont make me kill you\","
