// =======================================================================================================================================================================================================
// System: ZaraStar Blog: Edit page
...
public class BlogsEdit extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String p1, String p2, String p3, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "BlogsEdit", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "BlogsEdit", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Edit Blog Entry</title>");
    ...
    scoutln(out, bytesOut, "function topics(){");
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/BlogsTopicDefinition?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\";}");
    
    scoutln(out, bytesOut, "function lib(){");
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/ImagesMaintainDirectories?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\";}");
    ...
    blogsUtils.outputPageFrame(con, stmt, rs, out, req, "BlogsEdit", "", "document.getElementById('wikiview').contentWindow.document.designMode='on';", "8102", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    blogsUtils.drawTitle(con, stmt, rs, req, out, "Edit Blog Entry", "8102", p1, false, true, false, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "<input type=hidden name=callingServlet value=\"BlogsEdit\">");
    ...
    scoutln(out, bytesOut, text[0] + "</textarea><script language=\"JavaScript\">drawEditor('text1', 'wikiview', '100%', '400', '#FF8888', '#F0F0F0', '#880000','" + unm + "','" + sid + "','" + uty + "','" + men + "','" + den + "','" + dnm + "','"
                         + bnm + "');</script>");
    scoutln(out, bytesOut, "</td></tr>");
