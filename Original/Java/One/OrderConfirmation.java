// =======================================================================================================================================================================================================
// System: ZaraStar Document: OC Record Access
// Module: orderConfirmation.java
// Author: C.K.Harvey
...
public class OrderConfirmation
{
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringOC() throws Exception
  {  
    return "oc ( OCCode char(20) not null, Date date not null,           CompanyCode char(20) not null, "
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsOC(String[] s) throws Exception
  {
    s[0] = "ocDateInx on oc (Date)";
    s[1] = "ocCompanyCodeInx on oc (CompanyCode)";
    s[2] = "ocCustPOCodeInx on oc (CustomerPOCode)";
    s[3] = "ocProjectCodeInx on oc (ProjectCode)";
    
    return 4;
  }
      
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesOC() throws Exception
  {  
    return "OCCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
         + "unused1, Status, Misc1, Misc2, GSTTotal, TotalTotal, unused2, unused3, unused4, AllSupplied, SignOn, "
         + "DateLastModified, LocationCode, unused6, BOMCode, ShipAddrCode, Terms, ProjectCode, Rate, Currency, "
         + "ShipName, ShipAddress1, ShipAddress2, ShipAddress3, ShipAddress4, ShipAddress5, SalesPerson, CustomerPOCode, "
         + "BaseTotalTotal, BaseGSTTotal, SOCode, GroupDiscount, GroupDiscountType";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesOC() throws Exception
  {
    return "CDCCCCCCCCCCCCCCFFDDFCCSCCCCCCFCCCCCCCCCFFCFC";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesOC(short[] sizes) throws Exception
  {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesOC() throws Exception
  {
    return "MMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringOCL() throws Exception
  {  
    return "ocl ( OCCode char(20) not null,    ItemCode char(20) not null,    Description char(80), "
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsOCL(String[] s) throws Exception
  {
    s[0] = "oclItemCodeInx on ocl(ItemCode)";
    s[1] = "oclStatusInx on ocl(Status)";
    
    return 2;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesOCL() throws Exception
  {  
    return "OCCode, ItemCode, Description, UnitPrice, Quantity, Amount, GSTRate, ActualUnitPrice, ActualQuantity, ActualAmount, Status, SignOn, DateLastModified, unused9, unused4, unused5, unused6, unused7, unused8, Amount2, UoM, Line, Entry, "
         + "unused10, DeliveryDate, Remark, CustomerItemCode, Discount, Manufacturer, ManufacturerCode";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesOCL() throws Exception
  {
    return "CCCFFFCFFFCCSCCCCCCFCICFDCCFCC";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesOCL(short[] sizes) throws Exception
  {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesOCL() throws Exception
  {
    return "OOOOOOOOOOOOOOOOOOOOOMOOOOOOOO";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringOCLL() throws Exception
  {  
    return "ocll ( OCCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), unique(OCCode, Entry, Line))";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsOCLL(String[] s) throws Exception
  {
    return 0;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesOCLL() throws Exception
  {  
    return "OCCode, Entry, Line, Text";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesOCLL() throws Exception
  {
    return "CCIC";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesOCLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesOCLL() throws Exception
  {
    return "MMMO";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringOCA() throws Exception
  {  
    return "oca ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsOCA(String[] s) throws Exception
  {
    return 0;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesOCA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesOCA() throws Exception
  {
    return "CI";
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesOCA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesOCA() throws Exception
  {
    return "MM";
  }
                              ...
                              String localDefnsDir, String defnsDir, char cad, String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    if(cad == 'A' && code[0] == '\000')
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "OrderConfirmation", imagesDir, localDefnsDir, defnsDir, bytesOut);
      return true;
    }
    ...
    {                          // in the correct order
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "oc");
    }
    ...
    short[] fieldSizesOC = new short[60]; // plenty
    getFieldSizesOC(fieldSizesOC);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesOCL = new short[40]; // plenty
      getFieldSizesOCL(fieldSizesOCL);
      ...
      if(dispOrEdit == 'D')
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "116.htm", 2, getFieldNamesOCL(), fieldSizesOCL, getFieldNamesOCL(), fieldSizesOCL, null, null);
      else numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "116a.htm", 1, getFieldNamesOC(), fieldSizesOC, null, null, null, null);
      ...
      else prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), date, "116a.htm", localDefnsDir, defnsDir, prependCode, req, bytesOut);
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        stmt.executeUpdate("UPDATE oc SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " + totalGSTAmt2Lines + ", BaseTotalTotal = " + (totalAmtLines + totalGSTAmtLines) + ", BaseGSTTotal = "
                         + totalGSTAmtLines + " WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
        stmt.close();
        ...
        scoutln(headData, bytesOut, "oc.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen
        ...
        scoutln(headData, bytesOut, "oc.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 30); // rate
        scoutln(headData, bytesOut, "oc.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)30) + "\001");
        ...
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "oc.Attachments=" + attachments + "\001");        
      }
      else // edit
      {
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "oc.Currency", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
        ddlData = documentUtils.getSalesPersonDDLData(con, stmt, rs, "oc.SalesPerson", ddlData, ddlDataUpto, ddlDataLen);
    ...
    {
      numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "116a.htm", 1, getFieldNamesOC(), fieldSizesOC, null, null, null, null);

      if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not 
      {                            // be in the correct order
        sortFields(dataAlready, data, "oc");
      }
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "oc", data);

        documentUtils.getNextCode(con, stmt, rs, "oc", true, code);
        
        generalUtils.repAlphaUsingOnes(data, 5000, "OCCode", generalUtils.stringFromBytes(code, 0L));
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L), date, "116a.htm", localDefnsDir, defnsDir, prependCode, req, bytesOut);
  ...
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=ocl.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4048, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "oc", date, unm))
  ...
  {
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4048, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      b[0]= '\000';
      scoutln(b, bytesOut, "<script language=\"JavaScript\">");
      scoutln(b, bytesOut, "function affect(line){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/OrderConfirmationLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code + "&p2=\"+line+\"&p3=&p4=\");}</script>");
    }
    else b[0] = '\000';
  }
                       ...
                       String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4046, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function fetch(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/OrderConfirmationHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=A&p3=&p4=\");}\n");

      scoutln(b, bytesOut, "function gst(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=OC\";}");
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6093, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PricgrChange?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=OC\";}");
      }
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6098, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/DocumentChangeDiscounts?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=OC\";}");
      }
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4048, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/OrderConfirmationLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=&p3=&p4=\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 1025, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/DocumentTraceExecute?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=O\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/DocumentAttachments?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=oca\");}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 8016, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      String projectCode = getAnOCFieldGivenCode(con, stmt, rs, "ProjectCode", code);
      String companyCode = getAnOCFieldGivenCode(con, stmt, rs, "CompanyCode", code);
      scoutln(b, bytesOut, "function mail(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/MailExternalUserCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p6=C&p4=" + companyCode + "&p5=" + projectCode + "&p1=OrderConfirmationRegisteredUser&p2=" + code2
                         + "&p3=Order%20Confirmation&bnm=" + bnm + "\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/TrailShow?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=O\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4051, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControl?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=OrderConfirmationPrint&p2=" + code2 + "&p3=\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 12708, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/ChannelSendDirect?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + generalUtils.sanitise(code2)
                         + "&p2=Order_Confirmation&p3=Requested%20Order%20Confirmation%20Sent (" + generalUtils.sanitise(code2)+ ")\";}");
    }

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4182, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/FaxCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=O&p3=OrderConfirmationPage&p4=&p5=Order%20Confirmation\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11200, unm, uty, dnm, localDefnsDir, defnsDir) && authenticationUtils.verifyAccess(con, stmt, rs, req, 4051, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PrintToPDFUtils?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p3=" + code2
                         + "&p1=0.000&p5=OrderConfirmation&p2=OrderConfirmationPrint\";}");
    }
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', ' ', "", "OrderConfirmationPage", date, unm, sid, uty, men, dnm, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
    scoutln(b, bytesOut, "<form>");
  }
                           ...
                           String localDefnsDir, String defnsDir, byte[] b, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/BlogsDateBase7?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + cad + "&p2=" + code2
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', cad.charAt(0), "", "OrderConfirmationHeaderEdit", date, unm, sid, uty, men, dnm, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "ocl", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "ocl"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesOCL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "ocl", fieldName, value) != -1) // entry exists
      {
    ...
    if((generalUtils.dfsAsStr(buf, (short)4)).length() == 0) // qty
      generalUtils.putAlpha(buf, 1000, (short)4, "0");

    if((generalUtils.dfsAsStr(buf, (short)8)).length() == 0) // actual qty
      generalUtils.putAlpha(buf, 1000, (short)8, "0");
    ...
    getAnOCFieldGivenCode(con, stmt, rs, "Rate", code, rateB);
    ...
    if(   searchDataString(recData, recDataLen, "ocl", fieldName, value) != -1 // exists
       && value[0] != '\000')
    {
    ...
    if(searchDataString(recData, recDataLen, "ocl", fieldName, value) != -1) // exists
    {
      if(value[0] == '\000') // description fld is blank
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, itemCode, '\000', data) != -1) // exists
        {
          ...
          if(! unitPriceGiven)
          {
            ...
            getAnOCFieldGivenCode(con, stmt, rs, "Currency", code, currency);
      ...
      else // strip only the first desc line for OCL rec
      {
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE oc SET SignOn = '" + unm + "', DateLastModified = NULL WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
  ...
  {
    String s = generalUtils.dfsAsStr(buf, (short)8);

    double qty = generalUtils.doubleFromStr(s);
    if(s.length() == 0)
    {
      qty = 0.0;
      generalUtils.repDoubleGivenSeparator('2', '\000', buf, dataBufLen, (short)8, 0.0); // actual
    }
  ...
  private void updateMultipleLines(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, byte[] descData)
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM ocll WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
      rs.next();
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE ocll SET Text = '" + sanitisedDesc + "' WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "' AND Line = '" + lineCount + "'");
        ++lineCount;
      }
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO ocll (" + getFieldNamesOCLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L) + "','" + generalUtils.stringFromBytes(line, 0L) + "','" + lineCount + "','" + sanitisedDesc + "')");
        ++lineCount;
      }

      while(lineCount <= numLinesAtPresent) // remove any 'excess' lines
      {
        stmt.executeUpdate("DELETE FROM ocll WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L)  + "' AND Line = '" + lineCount + "'");
        ++lineCount;
      }
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getAnOCFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, String ocCode) throws Exception
  {
    byte[] value = new byte[300]; // plenty
    byte[] b     = new byte[21];
    generalUtils.strToBytes(b, ocCode);
    
    getAnOCFieldGivenCode(con, stmt, rs, fieldName, b, value);
    
    return generalUtils.stringFromBytes(value, 0L);
  }
  public void getAnOCFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] ocCode, byte[] value) throws Exception
  {
    if(ocCode[0] == '\000') // just-in-case
      return;

    generalUtils.toUpper(ocCode, 0);

    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT " + fieldName + " FROM oc WHERE OCCode = '" + generalUtils.stringFromBytes(ocCode, 0L) + "'");
    if(! rs.next())
      value[0] = '\000';
    else
    {    
                                        ...
                                        String defnsDir, String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    String layoutFile="116b.htm";

    short[] fieldSizesOCL = new short[40]; // plenty
    getFieldSizesOCL(fieldSizesOCL);

    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, layoutFile, 1, getFieldNamesOCL(), fieldSizesOCL, null, null, null, null);
    ...
    if(line[0] != '\000') // existing line
    {
      if(code[0] != '\000') // just-in-case
      {
        if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not 
        {                           //  be in the correct order
          sortFields(dataAlready, data, "ocl");
        }
        else
        {
    ...
    else /// new line
    {
      ...
      {
        data[0]= '\000';
        scoutln(data, bytesOut, "ocl.entry=" + generalUtils.intToStr(nextLine) + "\001");

        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "ocl.gstrate=" + gstRateDefault + "\001");
      }

      newOrEdit = 'N';
    }

    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "ocl.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);

    ddlData = inventory.getMfrsDDLData(con, stmt, rs, "ocl.manufacturer", ddlData, ddlDataUpto, ddlDataLen);

    getAnOCFieldGivenCode(con, stmt, rs, "Currency", code, b);
    scoutln(data, bytesOut, "ocl.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "ocl.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    byte[] prependCode = new byte[22000];
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L), generalUtils.stringFromBytes(line, 0L), "116b.htm", localDefnsDir, defnsDir, prependCode, newOrEdit, req, bytesOut);
                               ...
                               String localDefnsDir, String defnsDir, byte[] b, char newOrEdit, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/OrderConfirmationUpdateLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + cad + "&p2=" + code2
    ...
    outputPageFrame(con, stmt, rs, b, req, newOrEdit, ' ', "", "OrderConfirmationLine", "", unm, sid, uty, men, dnm, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  ...
  public char putHead(Connection con, Statement stmt, ResultSet rs, byte[] originalCode, String unm, String dnm, String localDefnsDir, String defnsDir, char cad, byte[] recData, int recDataLen, byte[] code, int[] bytesOut) throws Exception
  {
    ...
    generalUtils.catAsBytes("OCCode", 0, str, true);

    if(searchDataString(recData, recDataLen, "oc", str, code) == -1)
      return 'N';
    ...
    if(searchDataString(recData, recDataLen, "oc", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "oc", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "oc", fldName, date); // assumes exists
    ...
    String fieldNamesOC = getFieldNamesOC();
    ...
    for(x=3;x<10;++x)
    {
      getFieldName(fieldNamesOC, x, fldName);
      if(searchDataString(recData, recDataLen, "oc", fldName, value) != -1) // entry exists
      {
        if(value[0] != '\000')
    ...
    len = fieldNamesOC.length();
    int y, fieldCount=0;
    x=0;
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesOC.charAt(x) != ',')
    ...
    if(rtn == ' ') // head saved ok
    {
      ...
      if(searchDataString(recData, recDataLen, "oc", fldName, value) != -1) // entry exists
      {
        ...
        {
          if(newOrEdit == 'N')
            serverUtils.syncToIW(con, generalUtils.stringFromBytes(code, 0L), "", generalUtils.stringFromBytes(value, 0L), 'O', generalUtils.todaySQLFormat(localDefnsDir, defnsDir), unm, companyCode, dnm);
          else serverUtils.updateNewWavechannelsRec(con, stmt, rs, generalUtils.stringFromBytes(code, 0L), "O", companyCode);
        }
      }
    }
  ...
  public int getRecGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char separator, byte[] data, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM oc WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      rs.close();
      stmt.close();
    ...
    String fieldTypes = getFieldTypesOC();
    ...
    {    
      String fieldNames = getFieldNamesOC();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "oc." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO oc (" + getFieldNamesOC() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE oc SET " + opStr + " WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
  ...
  public char putRecLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesOCL();
      int x=0, count=0;
      if(newOrEdit == 'N')
      {
        // change: abc\0def\0... format into: 'abc','def',...
        ...
        q = "INSERT INTO ocl (" + getFieldNamesOCL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE ocl SET " + opStr + " WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" + generalUtils.stringFromBytes(line, 0L)
          + "'";
      }
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM ocl WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" + generalUtils.stringFromBytes(line, 0L) + "'");
      ...
      stmt = con.createStatement();
      stmt.executeUpdate("DELETE FROM ocll WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
  ...
  public byte[] getLines(Connection con, Statement stmt, ResultSet rs, byte[] code, char separator, byte[] linesData, int[] listLen, int[] linesCount, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM ocl WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "ocl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
  ...
  private int getLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char separator, byte[] data, int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM ocl WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "ocl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
  ...
  public byte[] getMultipleLines(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] linesData, int[] listLen, int[] linesCount, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM ocll WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
  ...
  public byte[] getMultipleLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, byte[] linesData, int[] listLen, int[] linesCount, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM ocll WHERE OCCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '" + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
                                  ...
                                  String defnsDir, byte[] b, int[] bytesOut) throws Exception
  {
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ',  ' ', "", "OrderConfirmationRegisteredUser", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  }

  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // picks-up the list of fieldnames for the OC or OCL file, and fetches the data value for that field; and rebuilds the data string
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("oc"))
      fieldNames = getFieldNamesOC();
    else // if(which.equals("ocl"))
      fieldNames = getFieldNamesOCL();
    int len = fieldNames.length();
                                         ...
                                         String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "116d.htm", 2, getFieldNamesOC(), fieldSizesOC, getFieldNamesOCL(), fieldSizesOCL, null, null);
    ...
    int x=0, y, fieldCount=0;
    int len = fieldNamesOC.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesOC.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesOC.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "oc", fieldName, value) != -1) // entry exists
      {
    ...
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "oc.Attachments=" + attachments + "\001");
                               ...
                               throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM oca WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
                               ...
                               String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "4043", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);

    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Order Confirmation" + directoryUtils.buildHelp(4043) + "</td></tr></table>";
                                  ...
                                  String bnm, String localDefnsDir, String defnsDir, int[] hmenuCount) throws Exception
  {
    ...
    if(callingServlet.equals("OrderConfirmationPage"))
      s += drawOptions4043(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("OrderConfirmationHeaderEdit"))
      s += drawOptions4046(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("OrderConfirmationLine"))
      s += drawOptions4048(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
    else
    if(callingServlet.equals("OrderConfirmationRegisteredUser"))
      s += drawOptions4126(con, stmt, rs, req, hmenuCount, unm, uty, dnm, localDefnsDir, defnsDir);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4043(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {      
    String s = "";
    
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4046, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "oc", date, unm))
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "oc", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:attach()\">Attachments</a></dt></dl>\n";

    boolean OrderConfirmationPrint  = authenticationUtils.verifyAccess(con, stmt, rs, req, 4051, unm, uty, dnm, localDefnsDir, defnsDir);
    boolean _4182  = authenticationUtils.verifyAccess(con, stmt, rs, req, 4182, unm, uty, dnm, localDefnsDir, defnsDir);
    ...
    if(OrderConfirmationPrint || _4182 || MailExternalUserCreate || PrintToPDFUtils || ChannelSendDirect)
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0] + "');\">Send</dt><dd id='hmenu" + hmenuCount[0]++ + "'><ul>";
      if(OrderConfirmationPrint)
    ...
    if(serverUtils.passLockCheck(con, stmt, rs, "oc", date, unm))
    {
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4046(int[] hmenuCount, char cad, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm) throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4048(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty, String men, String mainDNM, String dnm, String bnm) throws Exception
  {      
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions4126(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String unm, String uty, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {      
    boolean  OrderConfirmationPrint = authenticationUtils.verifyAccess(con, stmt, rs, req, 4051,  unm, uty, dnm, localDefnsDir, defnsDir);
    boolean PrintToPDFUtils = authenticationUtils.verifyAccess(con, stmt, rs, req, 11200, unm, uty, dnm, localDefnsDir, defnsDir);
    ...
    if(OrderConfirmationPrint || PrintToPDFUtils || SendToCSVUtils)
    {
      if(OrderConfirmationPrint)
        s += "<li><a href=\"javascript:print()\">Print</a></li>\n";
      if(PrintToPDFUtils)
  ...
  public void putMultipleLine(Connection con, Statement stmt, ResultSet rs, byte[] code, int line, byte[] descData, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    try
    {
      ...
      stmt.executeUpdate("INSERT INTO ocll (" + getFieldNamesOCLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L) + "','" + line + "','" + generalUtils.dfsAsStr(descData, (short)2)  + "','" + opStr + "')");
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public boolean getOCDetailsGivenSOCode(Connection con, Statement stmt, ResultSet rs, String soCode, String[] date, String[] signOn) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Date, SignOn FROM oc WHERE SOCode = '" + soCode + "'");
