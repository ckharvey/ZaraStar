// =======================================================================================================================================================================================================
// System: ZaraStar Library: Shows Stats for Library DataBase
// Module: LibraryStats.java
// Author: C.K.Harvey
...
public class LibraryStats extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "LibraryStats", bytesOut);
                      ...
                      String men, String den, String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(serverUtils.isSysAdmin(con, stmt, rs, unm, dnm, sid, uty, localDefnsDir, defnsDir))
    {
      ...
      {
        messagePage.msgScreen(true, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryStats", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(true, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "LibraryStats", imagesDir, localDefnsDir, defnsDir, bytesOut);
    }
                       ...
                       throws Exception
  {
    ...
    dashboardUtils.drawTitle(out, "DataBase Statistics", "403", unm, sid, uty, men, den, dnm, bnm, bytesOut);
    ...
    libraryUtils.showStats(out, dnm, localDefnsDir, defnsDir, bytesOut);
