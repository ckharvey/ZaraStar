// =======================================================================================================================================================================================================
// System: ZaraStar AdminEngine: Delivery Driver definition - fetch for edit
// Module: AdminDeliveryDriverDefinitionEdit.java
// Author: C.K.Harvey
// Copyright (c) 2006-2009 Christopher Harvey. All Rights Reserved.
//
...
public class AdminDeliveryDriverDefinitionEdit extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7012c: " + e));
      res.getWriter().write("Unexpected System Error: 7012c");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String name, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7012c";
  ...
  private boolean fetch(String dnm, String name, String[] note, String[] type) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Type, Note FROM driver WHERE Name = '" + name + "'");
