...
public class AdminSalesPeople extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AdminSalesPeople", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AdminSalesPeople", imagesDir, localDefnsDir, defnsDir, bytesOut);
                      ...
                      int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminSalesPersonEdit?unm=\" + escape('" + unm
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/AdminSalesPeople?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\");}");
