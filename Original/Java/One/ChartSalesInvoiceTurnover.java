...
// Module: ChartSalesInvoiceTurnover.java
// Author: C.K.Harvey
...
public class ChartSalesInvoiceTurnover extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 1103, bytesOut[0], 0, "ERR:");
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "ChartSalesInvoiceTurnover", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1103, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "ChartSalesInvoiceTurnover", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1103, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 1103, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
                   ...
                   int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/ChartSalesInvoiceTurnoverExecute?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=\"+p1+\"&p2=\"+p2+\"&p3=\"+p3+\"&bnm=" + bnm + "\";}");
    ...
    scoutln(out, bytesOut, "<tr><td colspan=5><p>Generates a chart using Sales Invoice data, for an optional SalesPerson, over a specified date range.</td></tr>");
