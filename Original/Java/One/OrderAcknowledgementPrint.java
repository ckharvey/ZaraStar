// =======================================================================================================================================================================================================
// System: ZaraStar: Document: OA Print
// Module: OrderAcknowledgementPrint.java
// Author: C.K.Harvey
...
public class OrderAcknowledgementPrint extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "OrderAcknowledgementPrint", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 4138, bytesOut[0], 0, "ERR:" + p1);
                    ...
                    String p1, int[] bytesOut) throws Exception
  {
    ...
    try
    {
      ...
      {
        messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "4138", imagesDir, localDefnsDir, defnsDir, bytesOut);
        serverUtils.etotalBytes(req, unm, dnm, 4138, bytesOut[0], 0, "ACC:" + p1);
      ...
      {
        messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "4138", imagesDir, localDefnsDir, defnsDir, bytesOut);
        serverUtils.etotalBytes(req, unm, dnm, 4138, bytesOut[0], 0, "SID:" + p1);
        if(con != null) con.close();
        if(out != null) out.flush();
        return;
      }
      ...
      switch(numPages)
      {
        case -1 : // Definition File Not Found
                  messagePage.msgScreen(false, out, req, 17, unm, sid, uty, men, den, dnm, bnm, "4138", imagesDir, localDefnsDir, defnsDir, bytesOut);
                  break;
        case -2 : // cannot create report output file
                  messagePage.msgScreen(false, out, req, 18, unm, sid, uty, men, den, dnm, bnm, "4138", imagesDir, localDefnsDir, defnsDir, bytesOut);
                  break;
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 4138, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), p1);
    if(con  != null) con.close();
    if(out != null) out.flush();
  }
  ...
  byte[] oBuf;
    ...
    linesData = orderAcknowledgement.getLines(con, stmt, rs, code, '\001', linesData, listLen, linesCount, dnm, localDefnsDir, defnsDir);
    ...
    {
      multipleLinesData = orderAcknowledgement.getMultipleLines(con, stmt, rs, code, multipleLinesData, multipleListLen, multipleLinesCount);
    }

    if((fhPPR[0] = generalUtils.fileOpenD("118.ppr", localDefnsDir)) == null)
    {
      if((fhPPR[0] = generalUtils.fileOpenD("118.ppr", defnsDir)) == null)
      {
    ...
    generalUtils.putAlpha(fldNames, 6500, (short)0,  "OA.OACode");
    generalUtils.putAlpha(fldNames, 6500, (short)1,  "OA.Date");
    generalUtils.putAlpha(fldNames, 6500, (short)2,  "OA.CompanyCode");
    generalUtils.putAlpha(fldNames, 6500, (short)3,  "OA.CompanyName");
    generalUtils.putAlpha(fldNames, 6500, (short)4,  "OA.Address1");
    generalUtils.putAlpha(fldNames, 6500, (short)5,  "OA.Address2");
    generalUtils.putAlpha(fldNames, 6500, (short)6,  "OA.Address3");
    generalUtils.putAlpha(fldNames, 6500, (short)7,  "OA.Address4");
    generalUtils.putAlpha(fldNames, 6500, (short)8,  "OA.Address5");
    generalUtils.putAlpha(fldNames, 6500, (short)9,  "OA.PostCode");
    generalUtils.putAlpha(fldNames, 6500, (short)10, "OA.FAO");
    generalUtils.putAlpha(fldNames, 6500, (short)11, "OAL.Entry");
    generalUtils.putAlpha(fldNames, 6500, (short)12, "OA.Misc1");
    generalUtils.putAlpha(fldNames, 6500, (short)13, "OA.Misc2");
    generalUtils.putAlpha(fldNames, 6500, (short)14, "OA.GSTTotal");
    generalUtils.putAlpha(fldNames, 6500, (short)15, "OA.TotalTotal");
    generalUtils.putAlpha(fldNames, 6500, (short)16, "OA.GroupDiscount");
    generalUtils.putAlpha(fldNames, 6500, (short)17, "OA.GroupDiscountType");
    generalUtils.putAlpha(fldNames, 6500, (short)18, "OA.TotalWithoutGST");
    generalUtils.putAlpha(fldNames, 6500, (short)19, "OA.SOAode");
    generalUtils.putAlpha(fldNames, 6500, (short)20, "OA.SODate");
    generalUtils.putAlpha(fldNames, 6500, (short)21, "OA.SignOn");
    generalUtils.putAlpha(fldNames, 6500, (short)22, "OA.Terms");
    generalUtils.putAlpha(fldNames, 6500, (short)23, "OA.Comment");
    generalUtils.putAlpha(fldNames, 6500, (short)24, "OA.Rate");
    generalUtils.putAlpha(fldNames, 6500, (short)25, "OA.Currency");
    generalUtils.putAlpha(fldNames, 6500, (short)26, "OA.ShipName");
    generalUtils.putAlpha(fldNames, 6500, (short)27, "OA.ShipAddress1");
    generalUtils.putAlpha(fldNames, 6500, (short)28, "OA.ShipAddress2");
    generalUtils.putAlpha(fldNames, 6500, (short)29, "OA.ShipAddress3");
    generalUtils.putAlpha(fldNames, 6500, (short)30, "OA.ShipAddress4");
    generalUtils.putAlpha(fldNames, 6500, (short)31, "OA.ShipAddress5");
    generalUtils.putAlpha(fldNames, 6500, (short)32, "OA.SalesPerson");
    generalUtils.putAlpha(fldNames, 6500, (short)33, "OA.CustomerPOAode");
    generalUtils.putAlpha(fldNames, 6500, (short)34, "OAL.LineNumber");
    generalUtils.putAlpha(fldNames, 6500, (short)35, "OAL.ItemCode");
    generalUtils.putAlpha(fldNames, 6500, (short)36, "OAL.Description");
    generalUtils.putAlpha(fldNames, 6500, (short)37, "OAL.UnitPrice");
    generalUtils.putAlpha(fldNames, 6500, (short)38, "OAL.Quantity");
    generalUtils.putAlpha(fldNames, 6500, (short)39, "OAL.Amount");
    generalUtils.putAlpha(fldNames, 6500, (short)40, "OAL.GSTRate");
    generalUtils.putAlpha(fldNames, 6500, (short)41, "OAL.UoM");
    generalUtils.putAlpha(fldNames, 6500, (short)42, "OAL.DeliveryDate");
    generalUtils.putAlpha(fldNames, 6500, (short)43, "OAL.Remark");
    generalUtils.putAlpha(fldNames, 6500, (short)44, "OAL.CustomerItemCode");
    generalUtils.putAlpha(fldNames, 6500, (short)45, "OAL.ActualQuantity");
    generalUtils.putAlpha(fldNames, 6500, (short)46, "OAL.Discount");
    generalUtils.putAlpha(fldNames, 6500, (short)47, "OA.NoteLine1");
    generalUtils.putAlpha(fldNames, 6500, (short)48, "OA.NoteLines");
    ...
    if(orderAcknowledgement.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut) != -1L) // just-in-case
    {
      ...
      generalUtils.dfs(tmp, (short)39, b); generalUtils.putAlpha(data, 6500, (short)33, b); // custPOAode
    ...
    reportGenDetails.processSection("PH", data, fldNames, (short)51, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                         across2Coord, oBuf, gstRates);
    ...
    lineCount[0] = 1;
    int docSizeMax = miscDefinitions.docSizeMax(con, stmt, rs, "oa");
      ...
      if(generalUtils.getListEntryByNum(xx, linesData, tmp)) // just-in-case
      {
        ...
        {  
          outputDetailLine(con, stmt, rs, data, fldNames, lineNumB, itemCode, mfrCode, unitPrice, quantity, actualQuantity, amount, gstRate, discountPercentage, uom,
                           custItemCode, entry, lastEntry, lineCount, numPages, docSizeMax, dpOnQuantities, unm, dnm, localDefnsDir, defnsDir, tm,
        ...
        while(llCount != -1)
        {
          ...
          while(! quit1)
          {
            ...
            generalUtils.repAlpha(data, 6500, (short)36, b); // desc
            reportGenDetails.processSection("BL1", data, fldNames, (short)51, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                         across2Coord, oBuf, gstRates);
            ++lineCount[0];
            ...
            {
              b[0] = '\000';
              reportGenDetails.outputLine('E', b, data, fldNames, (short)51, ' ', dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0],
    ...
    orderAcknowledgement.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut);
    ...
    reportGenDetails.processSection("BL2", data, fldNames, (short)51, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                         across2Coord, oBuf, gstRates);
    ...
    while(b[x] != '\000')
    {
      ...
      reportGenDetails.processSection("BL3", data, fldNames, (short)51, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                           across2Coord, oBuf, gstRates);
    ...
    reportGenDetails.processSection("PF", data, fldNames, (short)51, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                         across2Coord, oBuf, gstRates);
    ...
    {
      reportGenDetails.processSection("RF1", data, fldNames, (short)51, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                           across2Coord, oBuf, gstRates);
    }   
    ...
    {   
      reportGenDetails.processSection("RF2", data, fldNames, (short)51, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                           across2Coord, oBuf, gstRates);
    }
  ...
  private void outputDetailLine(Connection con, Statement stmt, ResultSet rs, byte[] data, byte[] fldNames, byte[] lineNumB, byte[] itemCode, byte[] desc, byte[] unitPrice, byte[] quantity,
                                ...
                                byte[] entry, byte[] lastEntry, int[] lineCount, int[] numPages, int docSizeMax, char dpOnQuantities, String unm,
                                String dnm,String localDefnsDir, String defnsDir, double[] tm, double[] bm, double[] lm, double[] rm, double[] pageSizeWidth,
                                ...
                                char[] fontDefItalic, int[] fontDefSize, double[] down2Coord, double[] across2Coord, byte[] oBuf, String[] gstRates) throws Exception
  {
    ...
    {
      b[0] = '\000';
      reportGenDetails.outputLine('E', b, data, fldNames, (short)51, ' ', dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord,
                         across2Coord, oBuf, gstRates);
      ++ numPages[0];
