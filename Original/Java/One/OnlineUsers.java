...
public class OnlineUsers extends HttpServlet
{
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut)
                   throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Online Users</title>");
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "12601", "", false, false, "", "", "", "", "", "OnlineUsers", unm, sid, uty, men, den, dnm, bnm, " olInitializeTimer(100);", localDefnsDir, defnsDir, hmenuCount, bytesOut);
 
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Online Users", "12601", unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
