// =================================================================================================================================
// System: ZaraStar AdminEngine: Industry Type definition - update
// Module: AdminIndustryTypeDefinitionUpdate.java
// Author: C.K.Harvey
...
public class AdminIndustryTypeDefinitionUpdate extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7059a: " + e));
      res.getWriter().write("Unexpected System Error: 7059a");
    }
  }
                     ...
                     String name, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7059a";
    ...
    else
    {
      ...
      if(name.length() == 0)
        rtn = "No Industry Type Name Entered";
      else
      {
        switch(update(dnm, name, localDefnsDir, defnsDir))
        {
          case ' ' : rtn = ".";                            break;
          case 'E' : rtn = "Industry Type Already Exists"; break;
        }
      }
    }
    ...
    serverUtils.totalBytes(req, unm, dnm, 7059, bytesOut[0], 0, name);
  }
  ...
  private char update(String dnm, String name, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Name FROM industrytype WHERE Name = '" + name + "'"); 
      if(rs.next())
        alreadyExists = true;
      rs.close() ;
      ...
      String q = "INSERT INTO industrytype ( Name ) VALUES ('" + name + "')";
