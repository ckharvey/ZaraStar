...
// Module: LibraryInsertDirectory.java
// Author: C.K.Harvey
...
public class LibraryInsertDirectory extends HttpServlet
{ 
                      ...
                      String den, String dnm, String bnm, String p1, String p2, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryInsertDirectory", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String p1, String p2, String unm, String sid, String uty,
                     String men, String den, String dnm, String bnm, String imagesDir, String libraryDir, String localDefnsDir,
                     String defnsDir, int[] bytesOut) throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Library: Insert Directory</title>");
    ...
    libraryUtils.drawTitle(con, stmt, rs, req, out, "Insert Directory", "12008", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
