...
public class AdminPrintControlWave extends HttpServlet
{
                    ...
                    throws Exception
  {
    ...
    set(con, stmt, rs, out, req, unm, sid, uty, men, den, dnm, bnm, p1, p2, p3, p4, p5, p6, p7, localDefnsDir, defnsDir, bytesOut);
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4,
                   String returnServletAndParams, String returnMsg, String p7, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    String numPages;
    ...
    if(p7.length() > 0) // coming-in with printer alredy known
    {
      call7400a(out, unm, sid, uty, men, den, dnm, bnm, "0.000", p4, p7, returnServletAndParams, returnMsg, bytesOut);
      return;
    }
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void call7400a(PrintWriter out, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String fileName, String numPages, String ptr, String returnServletAndParams, String returnMsg, int[] bytesOut)
                         throws Exception
  {
    URL url = new URL("http://" + men + "/central/servlet/AdminPrintControlNetworkWave?unm=" + unm + "&sid=" + sid + "&&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + fileName + "&p2=" + numPages + "&p3=" + generalUtils.sanitise(ptr) + "&p4="
            + generalUtils.sanitise(returnServletAndParams) + "&p5=" + generalUtils.sanitise(returnMsg) + "&dnm=" + dnm + "&bnm=" + bnm);
