// =======================================================================================================================================================================================================
// System: ZaraStar: Contacts: Upload address book
// Module: ContactsAddressBookUpload.java
// Author: C.K.Harvey
...
public class ContactsAddressBookUpload extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ContactsAddressBookUpload", bytesOut);
                    ...
                    String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "ContactsAddressBookUpload", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "ContactsAddressBookUpload", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    set(con, stmt, rs, out, req, unm, sid, uty, men, den, dnm, bnm, workingDir, imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm,
                   String bnm, String workingDir, String imagesDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Upload Address Book</title>");
    ...
    scoutln(out, bytesOut, "<form enctype=\"multipart/form-data\" action=\"" + directoryUtils.getScriptsDirectory() + "upload4addressbook.php\"" + "method=\"post\">");

    int[] hmenuCount = new int[1];
 
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "8812", "", "ContactsAddressBookUpload", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Upload Address Book", "8812", unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
