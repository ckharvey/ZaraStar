// =================================================================================================================================
// System: ZaraStar AdminEngine: Store definition - delete
// Module: AdminStoreDefinitionDelete.java
// Author: C.K.Harvey
...
public class AdminStoreDefinitionDelete extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println(("Unexpected System Error: 7060b: " + e));
      res.getWriter().write("Unexpected System Error: 7060b");
    }
  }
                      ...
                      String code, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7060b";
  ...
  private boolean deleteRec(String dnm, String name, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM store WHERE Name = '" + name + "'");
