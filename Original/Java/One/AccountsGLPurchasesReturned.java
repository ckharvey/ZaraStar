// =======================================================================================================================================================================================================
// System: ZaraStar: Accounts: GL Purchases Returned
// Module: AccountsGLPurchasesReturned.java
// Author: C.K.Harvey
...
public class AccountsGLPurchasesReturned extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007l: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AccountsGLPurchasesReturned", bytesOut);
                    ...
                    String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AccountsGLPurchasesReturned", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AccountsGLPurchasesReturned", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, account, p2, p3, "", "", "AccountsGLPurchasesReturned", unm, sid, uty, men, den, dnm, bnm,
    ...
    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AccountsGLPurchasesReturned", account, dateFrom, dateTo, "", "", "GL Account: " + account + " - " + accountsUtils.getAccountDescriptionGivenAccCode(account, year, dnm, localDefnsDir, defnsDir) + " ("
  ...
  {
    String purchasesReturnedAccount = accountsUtils.getPurchasesReturnedAccCode(year, dnm, localDefnsDir, defnsDir);

    onPurchasesCreditNote(con, stmt, stmt2, rs, purchasesReturnedAccount, dateFrom, dateTo, tmpTable);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onPurchasesCreditNote(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String purchasesReturnedAccount, String dateFrom, String dateTo, String tmpTable)
                                     throws Exception
  {
    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT t2.PCNCode, t1.CompanyName, t2.Amount2, t2.Amount, t1.Date, t1.Currency, t2.ItemCode, t2.Quantity "
                         + "FROM pcreditl AS t2 INNER JOIN pcredit AS t1 ON t1.PCNCode = t2.PCNCode WHERE Category = '" + purchasesReturnedAccount
