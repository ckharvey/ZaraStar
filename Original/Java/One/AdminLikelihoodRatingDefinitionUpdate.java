// =================================================================================================================================
// System: ZaraStar AdminEngine: Likelihood Rating definition - update
// Module: AdminLikelihoodRatingDefinitionUpdate.java
// Author: C.K.Harvey
...
public class AdminLikelihoodRatingDefinitionUpdate extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7063a: " + e));
      res.getWriter().write("Unexpected System Error: 7063a");
    }
  }
                     ...
                     String name, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7063a";
    ...
    else
    {
      ...
      if(name.length() == 0)
        rtn = "No Likelihood Rating Entered";
      else
      {
        switch(update(dnm, name, localDefnsDir, defnsDir))
        {
          case ' ' : rtn = ".";                                break;
          case 'E' : rtn = "Likelihood Rating Already Exists"; break;
        }
      }
    }
    ...
    serverUtils.totalBytes(req, unm, dnm, 7063, bytesOut[0], 0, name);
  }
  ...
  private char update(String dnm, String name, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Name FROM quolike WHERE Name = '" + name + "'"); 
      if(rs.next())
        alreadyExists = true;
      rs.close() ;
      ...
      String q = "INSERT INTO quolike ( Name ) VALUES ('" + name + "')";
