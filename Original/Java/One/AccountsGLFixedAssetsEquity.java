// =======================================================================================================================================================================================================
// System: ZaraStar: Accounts: GL Fixed Assets, Equity
// Module: AccountsGLFixedAssetsEquity.java
// Author: C.K.Harvey
...
public class AccountsGLFixedAssetsEquity extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007m: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AccountsGLFixedAssetsEquity", bytesOut);
                    ...
                    String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AccountsGLFixedAssetsEquity", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AccountsGLFixedAssetsEquity", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, account, p2, p3, "", "", "AccountsGLFixedAssetsEquity", unm, sid, uty, men, den, dnm, bnm,
    ...
    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AccountsGLFixedAssetsEquity", account, dateFrom, dateTo, "", "", "GL Account: " + account + " - " + accountsUtils.getAccountDescriptionGivenAccCode(account, year, dnm, localDefnsDir, defnsDir) + " ("
  ...
  {    
    onPurchaseInvoiceLine(con, stmt, stmt2, rs, rs2, account, year, dateFrom, dateTo, tmpTable);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onPurchaseInvoiceLine(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, String accCode, String year,
                                     String dateFrom, String dateTo, String tmpTable) throws Exception
  {
    ...
    String itemCode, invoiceCode, companyName="", date="", currency="", lastCurrency="", lastDate="", lastCompanyName="", lastInvoiceCode = "",
           groupDiscountType;
    boolean first = true;
                       ...
                       String tmpTable) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT IATCode, Remark, AmountCr, TransactionDate, CurrencyCr, RateDr "
                                        ...
                                        double[] across2Coord, byte[] oBuf, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    double baseAmount, balance = 0.0, monthBalance = 0.0, amount;
  ...
  private void addToTmpTable(Connection con, Statement stmt, String type, String code, String desc, double amount, double baseAmount, String date, String currency, String tmpTable) throws Exception
  {
    ...
    String q = "INSERT INTO " + tmpTable + " ( Type, Code, Description, Total, BaseTotal, Date, Currency ) VALUES ( '" + type + "', '" + code + "', '" + generalUtils.sanitiseForSQL(desc) + "', '" + amount + "', '" + baseAmount + "', {d '" + date
             + "'}, '" + currency + "' )";
