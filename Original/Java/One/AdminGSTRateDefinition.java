...
public class AdminGSTRateDefinition extends HttpServlet
{
                      ...
                      String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "7061", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "7061", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  private void create(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men,
                        ...
                        throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Admin - GST Rate Definition</title>");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminGSTRateDefinitionUpdate?unm=\" + escape('" + unm
                         + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty
                         + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
                         + "') + \"&p1=\" + code + \"&p2=\" + rate + \"&p3=\" + type + \"&p4=\" + newOrEdit + \"&dnm=\" + escape('"
                         + dnm + "');");
    ...
    scoutln(out, bytesOut, "{");
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminGSTRateDefinitionDelete?unm=\" + escape('" + unm
                         + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty
                         + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
    ...
    scoutln(out, bytesOut, "{");
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminGSTRateDefinitionEdit?unm=\" + escape('" + unm
                         + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty
                         + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
                           + "') + \"&p1=\" + escape(code) + \"&dnm=\" + escape('" + dnm + "');");
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/AdminGSTRateDefinition?unm=" + unm + "&sid=" + sid + "&uty="
    ...
    adminUtils.outputPageFrame(con, stmt, rs, out, req, "AdminGSTRateDefinition", "", "7061", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    adminUtils.drawTitle(con, stmt, rs, req, out, "Administration - GST Rate Definition", "7061", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    list(con, stmt, rs, out, dnm, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void list(Connection con, Statement stmt, ResultSet rs, PrintWriter out, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    try
    {
