...
// Module: AdminAccessRefinementsWave.java
// Author: C.K.Harvey
...
public class AdminAccessRefinementsWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "7508\001Admin\001Admin\001javascript:getHTML('AdminAccessRefinementsWave','')\001\001\001\001\003");
