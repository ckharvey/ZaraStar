...
// Module: LibraryTransactionsWave.java
// Author: C.K.Harvey
...
public class LibraryTransactionsWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "LibraryTransactions", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryTransactions", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "12017\001Documents\001Documents Main\001javascript:getHTML('LibraryTransactionsw','')\001\001Y\001\001\003");
                   ...
                   throws Exception
  {
    ...
    libraryUtils.drawTitleW(con, stmt, rs, req, out, "Document Transactions", "12017", unm, uty, dnm, localDefnsDir, defnsDir, bytesOut);
