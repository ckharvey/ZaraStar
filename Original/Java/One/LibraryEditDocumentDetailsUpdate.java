...
public class LibraryEditDocumentDetailsUpdate extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    String unm="", sid="", uty="", men="", den="", dnm="", bnm="", p1="", userName="", docName="", directory="",
           projectCode="", internalOrExternal="", status="";
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men,
                    String den, String dnm, String bnm, String p1, String userName, String docName, String directory,
                    String projectCode, String internalOrExternal, String status, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryEditDocumentDetailsUpdate", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void set(String unm, String dnm, String docCode, String userName, String docName, String directory, String projectCode,
                   String internalOrExternal, String status, String localDefnsDir, String defnsDir) throws Exception
  { 
    ...
    libraryUtils.getDocumentDetails(docCode, existingUserName, existingDocName, existingDocType, existingInOrOut, existingLastDateIn,
                             existingDirectory, existingProjectCode, existingInternalOrExternal, existingArchivedDate, 
                             existingArchivedBy, existingFileSize, dnm, localDefnsDir, defnsDir);
    ...
    if(toBeUpdated)
    {
      libraryUtils.updateDocuments(docCode, existingUserName[0], existingDocName[0], existingDocType[0], existingInOrOut[0],
                            existingLastDateIn[0], existingDirectory[0], existingProjectCode[0], existingInternalOrExternal[0],
                            "1970-01-01", "", existingFileSize[0], dnm, localDefnsDir, defnsDir);
    }
