// =============================================================================================================================================================
// System: ZaraStar Consolidation: List companies Sales Invoices Lines for SalesPerson
// Module: ConsolidationInvoicesSalesPerson.java
// Author: C.K.Harvey
...
public class ConsolidationInvoicesSalesPerson extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 6907, bytesOut[0], 0, "ERR:");
                    ...
                    String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(! serverUtils.checkSID(unm, sid, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 6907, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 6907, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
    if(con != null) con.close();
    if(out != null) out.flush();
  }
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut)
                   throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Sales Invoices Lines for SalesPerson</title>");
    ...
    scoutln(out, bytesOut, "<form action=\"ConsolidationInvoicesSalesPersonExecute\" name=go enctype=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Sales Invoice Lines for SalesPerson", "6907",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);

    scoutln(out, bytesOut, "<table id=\"page\" width=100% border=0>");

    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=5><p>Select the SalesPerson:</td></tr>");
    ...
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>Date From <input name='dateFrom' size='10' value='01.01.14'></td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>Date To <input name='dateTo' size='10' value='" + generalUtils.today(localDefnsDir, defnsDir) + "'></td></tr>");
