...
// Module: AdminAccessUpdateWave.java
// Author: C.K.Harvey
...
public class AdminAccessUpdateWave extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      p2  = req.getParameter("p2"); // previousService
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AdminAccessUpdate", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AdminAccessUpdate", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "7502\001Admin\001Admin\001javascript:getHTML('AdminAccessUpdateWave','')\001\001\001\001\003");

    set(con, stmt, stmt2, rs, rs2, out, p1, p4, p2, p3, unm, sid, uty, men, den, dnm, bnm, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, String service, String option, String previousService, String desc, String unm, String sid, String uty, String men, String den,
                   String dnm, String bnm, String defnsDir, int[] bytesOut) throws Exception
  {
    scoutln(out, bytesOut, "<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"" + directoryUtils.getCssGeneralDirectory(con, stmt, rs, unm, dnm, defnsDir) + "general.css\">");

    scoutln(out, bytesOut, "<script language=\"JavaScript\">");

    scoutln(out, bytesOut, "function update(){postForm('AdminServicesAccessUpdateWave','7502w');}");
    ...
    scoutln(out, bytesOut, "<form id=\"7502w\" name=users ENCTYPE=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    scoutln(out, bytesOut, "<INPUT TYPE=hidden name=option value=" + option + ">");
    scoutln(out, bytesOut, "<INPUT TYPE=hidden name=previousService value=" + previousService + ">");

    dashboardUtils.drawTitleW(out, "Access Rights: " + desc, "7502", unm, sid, uty, men, den, dnm, bnm, bytesOut);
