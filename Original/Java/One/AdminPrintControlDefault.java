...
public class AdminPrintControlDefault extends HttpServlet
{
                   ...
                   String returnServletAndParams, String returnMsg, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    if(uty.equals("I"))
    {
      ...
      scoutln(out, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControlNetwork?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=" + numPages + "&p4="
                           + generalUtils.sanitise(returnServletAndParams)
                           + "&p5=" + generalUtils.sanitiseReplacingNewlines(returnMsg) + "&p1=0.000&p3=\"+ptr;}");
