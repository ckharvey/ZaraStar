...
// Module: LibraryCreateRecordCheckedIn.java
// Author: C.K.Harvey
...
public class LibraryCreateRecordCheckedIn extends HttpServlet implements SingleThreadModel
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men,
                      String den, String dnm, String bnm, String p1, String p2, String p3, String p5, int[] bytesOut)
                      throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryCreateRecordCheckedIn", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {   
      bytesIn = analyze(out, req, p1, p2, p3, p5, unm, sid, uty, men, den, dnm, bnm, imagesDir, localDefnsDir, defnsDir, bytesOut);
    }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private int analyze(PrintWriter out, HttpServletRequest req, String tmpFile, String fileName, String fullDirectory,
                        String docCode, String unm, String sid, String uty, String men, String den, String dnm,
  ...
  {   
    ...
    if(libraryUtils.checkOutOrInDocument(docCode, "In", generalUtils.todaySQLFormat(localDefnsDir, defnsDir), fileSize, dnm, localDefnsDir,
                                  defnsDir))
    {
      messagePage.msgScreen(false, out, req, 4, unm, sid, uty, men, den, dnm, bnm, "LibraryCreateRecordCheckedIn", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
    }
    else
    {
      messagePage.msgScreen(false, out, req, 39, unm, sid, uty, men, den, dnm, bnm, "LibraryCreateRecordCheckedIn", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
    }
