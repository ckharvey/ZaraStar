...
public class BlogsTopicDefinitionWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "8107\001Blogs\001Select Topics\001javascript:getHTML('BlogsTopicDefinitionWave','')\001\001Y\001\001\003");
                      ...
                      String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "var url=\"http://" + men + "/central/servlet/BlogsTopicDefinitionUpdateWave?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "var url=\"http://" + men + "/central/servlet/BlogsTopicDefinitionDeleteWave?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "function refetchPage(){getHTML('BlogsTopicDefinitionWave','');}");

    scoutln(out, bytesOut, "</script>");

    blogsUtils.drawTitleW(con, stmt, rs, req, out, "Topic Definition", "8107", "", false, false, false, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
