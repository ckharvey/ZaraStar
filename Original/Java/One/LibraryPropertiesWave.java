...
// Module: LibraryPropertiesWave.java
// Author: C.K.Harvey
...
public class LibraryPropertiesWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryProperties", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "12015\001Documents\001Document Properties\001javascript:getHTML('LibraryPropertiesw','')\001\001Y\001\001\003");
                   ...
                   String libraryDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    libraryUtils.drawTitleW(con, stmt, rs, req, out, "Directory Properties", "12015", unm, uty, dnm, localDefnsDir, defnsDir, bytesOut);

    scoutln(out, bytesOut, "<script javascript=\"JavaScript\">");
    scoutln(out, bytesOut, "function update(){postForm('LibraryPropertiesaw','12015w');}");
    scoutln(out, bytesOut, "</script>");

    scoutln(out, bytesOut, "<form id=\"12015w\" enctype=\"application/x-www-form-urlencoded\" method=post>");
    ...
    scoutln(out, bytesOut, "<tr><td nowrap><p>Company Code &nbsp;</td><td><p><input type=text name=companyCode size=20 maxsize=20 value='" + companyCode[0] + "'></td></tr>");
    ...
    scoutln(out, bytesOut, "<tr><td colspan=2><p><a href=\"javascript:update()\">Update</a> Properties</td></tr>");
