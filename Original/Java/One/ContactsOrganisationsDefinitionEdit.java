// =======================================================================================================================================================================================================
// System: ZaraStar Contacts: Organzations definition - fetch for edit
// Module: ContactsOrganisationsDefinitionEdit.java
// Author: C.K.Harvey
...
public class ContactsOrganisationsDefinitionEdit extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 8860c: " + e));
      res.getWriter().write("Unexpected System Error: 8860c");
    }
  }
                    ...
                    int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 8860c";
    ...
    {
      if(fetch(dnm, code, name, localDefnsDir, defnsDir))
        rtn = ".";
    }
    ...
    String s = "<msg><res>" + rtn + "</res><code>" + code + "</code><name>" + name[0] + "</name></msg>";
  ...
  //       'X' other error
  private boolean fetch(String dnm, String code, String[] name, String localDefnsDir, String defnsDir) throws Exception
  {
    Connection con = null;
    Statement stmt = null;
    ResultSet rs   = null;
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Name FROM organizations WHERE Code = '" + code + "'"); 
