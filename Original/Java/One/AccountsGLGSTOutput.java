// =======================================================================================================================================================================================================
// System: ZaraStar: Accounts: GL GST Output
// Module: AccountsGLGSTOutput.java
// Author: C.K.Harvey
...
public class AccountsGLGSTOutput extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007i: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AccountsGLGSTOutput", bytesOut);
                    ...
                    String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AccountsGLGSTOutput", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AccountsGLGSTOutput", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>GL Account: GST Output</title>");
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, "", p2, p3, "", "", "AccountsGLGSTOutput", unm, sid, uty, men, den, dnm, bnm,
    ...
    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AccountsGLGSTOutput", p1, dateFrom, dateTo, "", "", "GL Account: " + p1 + " - " + accountsUtils.getAccountDescriptionGivenAccCode(p1, year, dnm, localDefnsDir, defnsDir) + " ("
  ...
  {
    onInvoice(con, stmt, stmt2, rs, dateFrom, dateTo, tmpTable);
    onDebitNote(con, stmt, stmt2, rs, dateFrom, dateTo, tmpTable);
    onSalesCreditNote(con, stmt, stmt2, rs, dateFrom, dateTo, tmpTable);
    onReceiptVoucherNotStrictGST(con, stmt, stmt2, rs, dateFrom, dateTo, tmpTable);
    onReceiptVoucherStrictGST(con, stmt, stmt2, rs, dateFrom, dateTo, tmpTable);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onInvoice(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String dateFrom, String dateTo, String tmpTable)
                         throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onDebitNote(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String dateFrom, String dateTo, String tmpTable)
                           throws Exception
  {
    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT DNCode, CompanyName, GSTTotal, BaseGSTTotal, Date, Currency "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onSalesCreditNote(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String dateFrom, String dateTo, String tmpTable)
                            throws Exception
  {
    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT CNCode, CompanyName, GSTTotal, BaseGSTTotal, Date, Currency "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onReceiptVoucherNotStrictGST(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String dateFrom, String dateTo,
                                            String tmpTable) throws Exception
  {
    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT VoucherCode, CompanyName, GSTTotal, BaseGSTTotal, Date, Currency "
                         + "FROM rvoucher WHERE Status != 'C' AND Type != 'C' AND Date >= {d '" + dateFrom + "'} AND Date <= {d '" + dateTo + "'}");
    double gstAmount, baseGSTAmount;           
    ...
    {    
      ...
      if(baseGSTAmount != 0.0)
        addToTmpTable(con, stmt2, "R", rs.getString(1), rs.getString(2), gstAmount, baseGSTAmount, rs.getString(5), rs.getString(6), tmpTable);
    }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onReceiptVoucherStrictGST(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String dateFrom, String dateTo,
                                         String tmpTable) throws Exception
  {
    stmt = con.createStatement();
