// =======================================================================================================================================================================================================
// System: ZaraStar Analytic: Manufacturer Sales from Invoice Lines params
// Module: ManufacturerSalesByInvoiceInput.java
// Author: C.K.Harvey
...
public class ManufacturerSalesByInvoiceInput extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ManufacturerSalesByInvoiceInput", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1038, bytesOut[0], 0, "ERR:");
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm,
                    String bnm, int[] bytesOut) throws Exception
   {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "1038", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1038, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "1038", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 1038, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 1038, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Manufacturer Sales from Invoice Lines Parameters</title>");

    scoutln(out, bytesOut, "<SCRIPT LANGUAGE=\"JavaScript\">");

    scoutln(out, bytesOut, "function generate(){");
    scoutln(out, bytesOut, "var p1=sanitise(document.forms[0].effectiveDate.value);");
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/ManufacturerSalesByInvoiceExecute?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "1038", "", "ManufacturerSalesByInvoiceInput", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
