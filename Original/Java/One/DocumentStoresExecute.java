// =======================================================================================================================================================================================================
// System: ZaraStar Document: Change Stores for a Document - update
// Module: DocumentStoresExecute.java
// Author: C.K.Harvey
...
public class DocumentStoresExecute extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "DocumentStoresExecute", bytesOut);
                   ...
                   String sid, String uty, String men, String den, String dnm, String bnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    if(docType.equals("SO"))
    {
      ...
      salesOrder.updateStores(con, stmt, rs, code, gstRate, unm, dnm, localDefnsDir, defnsDir);
    ...
    if(docType.equals("GRN"))
    {
      ...
      goodsReceivedNote.updateStores(con, stmt, rs, code, gstRate, unm, dnm, localDefnsDir, defnsDir);
      servletToCall = "GoodsReceivedPage";
    }
    else
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void getRec(PrintWriter out, String servletToCall, String unm, String sid, String uty, String men, String den,
                      String dnm, String bnm, String localDefnsDir, String code, String errStr, byte[] dataAlready, char cad)
                      throws Exception
  {
