// =======================================================================================================================================================================================================
// System: ZaraStar Admin: SalesPeople Definition
// Module: AdminSalesPeople.java
// Author: C.K.Harvey
...
public class AdminSalesPeopleWave extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AdminSalesPeople", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7001, bytesOut[0], 0, "ERR:");
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AdminSalesPeople", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7001, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AdminSalesPeople", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7001, bytesOut[0], 0, "SID:");
      if(con != null) con.close();
      if(out != null) out.flush();
      return;
    }

    scoutln(out, bytesOut, "7001\001Admin\001Admin: SalesPeople\001javascript:getHTML('AdminSalesPeopleWave','')\001\001Y\001\001\003");

    create(con, stmt, rs, out, unm, sid, uty, men, den, dnm, bnm, defnsDir, bytesOut);

    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 7001, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
    if(con != null) con.close();
    if(out != null) out.flush();
  }
  ...
  {
//    scoutln(out, bytesOut, "<html><head><title>Admin - SalesPeople Definition</title>");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminSalesPersonUpdate?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminSalesPersonEditWave?unm=\" + escape('" + unm
    ...
    scoutln(out, bytesOut, "messageElement.innerHTML='<p><a href=\"javascript:updateE()\">Update the SalesPerson</a>';");
    ...
    scoutln(out, bytesOut, "function refetchPage(){getHTML('AdminSalesPeopleWave','');}");

    scoutln(out, bytesOut, "</script>");

    dashboardUtils.drawTitle(out, "SalesPeople", "7001", unm, sid, uty, men, den, dnm, bnm, bytesOut);
    ...
    scoutln(out, bytesOut, "<td nowrap><p>&nbsp; SalesPerson Name &nbsp;</td>");
    ...
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=3><span id=\"option\"><p><a href=\"javascript:updateN()\">Add the SalesPerson</a></span></td></tr>");
  ...
  private void list(PrintWriter out, String dnm, int[] bytesOut) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT * FROM salesper ORDER BY Name");
