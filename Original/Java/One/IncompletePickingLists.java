...
// Module: IncompletePickingLists.java
// Author: C.K.Harvey
...
public class IncompletePickingLists extends HttpServlet
{
                    ...
                    throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 3064, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3064, bytesOut[0], 0, "ACC:");
    ...
    if(! serverUtils.checkSID(unm, sid, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      serverUtils.etotalBytes(req, unm, dnm, 3064, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 3064, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
                   ...
                   String den, String dnm, String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/IncompletePickingListExecute?p1=\"+p1+\"&unm=" + unm + "&uty=" + uty + "&sid=" + sid + "&men=" + men
