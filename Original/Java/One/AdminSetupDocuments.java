// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Setup - Documents
// Module: AdminControlb.java
// Author: C.K.Harvey
...
public class AdminSetupDocuments extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AdminControlb", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "7500\001Admin\001Setup: Documents\001javascript:getHTML('AdminControlWave','')\001\001\001\001\003");
  ...
  private void create(Connection con, Statement stmt, ResultSet rs, PrintWriter out, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    dashboardUtils.drawTitleW(out, "Administration - Documents", "7500", unm, sid, uty, men, den, dnm, bnm, bytesOut);

    scoutln(out, bytesOut, "<table id=\"page\" border=0>");

    scoutln(out, bytesOut, "<tr><td nowrap><h1>Feature Access</td></tr>");

    scoutln(out, bytesOut, "<tr><td></td><td nowrap><p><a href=\"javascript:getHTML('OptionTabsWave','&p1=A&p2=7523')\">Modify</a> Central Library Access</td></tr>");
