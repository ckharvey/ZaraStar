// =======================================================================================================================================================================================================
// System: ZaraStar Blogs: Shows Stats for DataBase
// Module: BlogsStats.java
// Author: C.K.Harvey
...
public class BlogsStats extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "BlogsStats", bytesOut);
                      ...
                      String men, String den, String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(serverUtils.isSysAdmin(con, stmt, rs, unm, dnm, sid, uty, localDefnsDir, defnsDir))
    {
      ...
      {
        messagePage.msgScreen(true, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "BlogsStats", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(true, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "BlogsStats", imagesDir, localDefnsDir, defnsDir, bytesOut);
    }
                       ...
                       throws Exception
  {
    ...
    dashboardUtils.drawTitle(out, "DataBase Statistics", "404", unm, sid, uty, men, den, dnm, bnm, bytesOut);

    scoutln(out, bytesOut, "<table id=\"serviceTitleTable\" width=100%>");

    scoutln(out, bytesOut, "<tr><td colspan=2 nowrap><span id=\"serviceTitle\">Blogs DataBase Statistics</span></td></tr></table>");
    ...
    blogsUtils.showStats(out, dnm, localDefnsDir, defnsDir, bytesOut);
