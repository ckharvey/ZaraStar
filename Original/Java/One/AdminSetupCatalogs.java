// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Setup - Catalogs
// Module: AdminControle.java
// Author: C.K.Harvey
...
public class AdminSetupCatalogs extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AdminControle", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "7500\001Admin\001Setup: Catalogs\001javascript:getHTML('AdminControlWave','')\001\001\001\001\003");
                      ...
                      int[] bytesOut) throws Exception
  {
    ...
    dashboardUtils.drawTitleW(out, "Administration - Catalogs", "7500", unm, sid, uty, men, den, dnm, bnm, bytesOut);

    scoutln(out, bytesOut, "<table id=\"page\" border=0>");

    scoutln(out, bytesOut, "<tr><td nowrap><h1>Feature Access</td></tr>");

    scoutln(out, bytesOut, "<tr><td></td><td nowrap><p><a href=\"javascript:getHTML('OptionTabsWave','&p1=A&p2=7521')\">Modify</a> Catalog Access</td></tr>");

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6400, unm, uty, dnm, localDefnsDir, defnsDir))
      scoutln(out, bytesOut, "<tr><td></td><td nowrap><p><a href=\"javascript:getHTML('CatalogsSteelclawsListw','')\">SC Catalogs</a></td></tr>");

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 114, unm, uty, dnm, localDefnsDir, defnsDir))
      scoutln(out, bytesOut, "<tr><td></td><td nowrap><p><a href=\"javascript:getHTML('CatalogDefinitionServicesw','')\">Catalogs</a></td></tr>");

    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 7024, unm, uty, dnm, localDefnsDir, defnsDir))
      scoutln(out, bytesOut, "<tr><td></td><td nowrap><p><a href=\"javascript:getHTML('_7024dw','')\">Buyer Catalogs</a></td></tr>");
