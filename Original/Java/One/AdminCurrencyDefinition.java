...
public class AdminCurrencyDefinition extends HttpServlet
{
                    ...
                    throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "7054", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "7054", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Admin - Currency Definition</title>");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminCurrencyDefinitionUpdate?unm=\" + escape('" + unm
                         + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty
                         + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
                         + "') + \"&p1=\" + code + \"&p2=\" + desc + \"&p3=\" + type + \"&p4=\" + newOrEdit + \"&dnm=\" + escape('"
                         + dnm + "');");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminCurrencyDefinitionDelete?unm=\" + escape('" + unm
                         + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty
                         + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminCurrencyDefinitionEdit?unm=\" + escape('" + unm
                         + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty
                         + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
                           + "') + \"&p1=\" + escape(code) + \"&dnm=\" + escape('" + dnm + "');");
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/AdminCurrencyDefinition?unm=" + unm + "&sid=" + sid + "&uty="
    ...
    adminUtils.outputPageFrame(con, stmt, rs, out, req, "AdminCurrencyDefinition", "", "7054", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    adminUtils.drawTitle(con, stmt, rs, req, out, "Administration - Currency Definition", "7054", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
