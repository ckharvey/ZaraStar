// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Directory definition - delete
// Module: AdminDirectoryDefinitionDelete.java
// Author: C.K.Harvey
...
public class AdminDirectoryDefinitionDelete extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7068b: " + e));
      res.getWriter().write("Unexpected System Error: 7068b");
    }
  }
                    ...
                    String code, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7068b";
  ...
  private boolean deleteRec(String dnm, String code, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM directory WHERE ZPN = '" + code + "'");
