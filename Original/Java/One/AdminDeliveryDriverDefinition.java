// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Delivery Driver Definition
// Module: AdminDeliveryDriverDefinition.java
// Author: C.K.Harvey
...
public class AdminDeliveryDriverDefinition extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AdminDeliveryDriverDefinition", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7012, bytesOut[0], 0, "ERR:");
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AdminDeliveryDriverDefinition", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7012, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AdminDeliveryDriverDefinition", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 7012, bytesOut[0], 0, "SID:");
      if(con != null) con.close();
      if(out != null) out.flush();
      return;
    }
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 7012, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
    if(con != null) con.close();
    if(out != null) out.flush();
  }
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Admin - Delivery Driver Definition</title>");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminDeliveryDriverDefinitionUpdate?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('"
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/AdminDeliveryDriverDefinitionEdit?unm=\" + escape('" + unm
    ...
    scoutln(out, bytesOut, "messageElement.innerHTML='<p><a href=\"javascript:updateE()\">Update the Driver</a>';");
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/AdminDeliveryDriverDefinition?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "\");}");

    scoutln(out, bytesOut, "</script>");

    signOnAdministrator.heading(out, true, unm, sid, uty, bnm, dnm, men, den, imagesDir, bytesOut);

    dashboardUtils.drawTitle(out, "Delivery Drivers", "7012", unm, sid, uty, men, den, dnm, bnm, bytesOut);
    ...
    scoutln(out, bytesOut, "<td nowrap><p>&nbsp; Delivery Driver Name &nbsp;</td>");
    ...
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=3><span id=\"option\"><p><a href=\"javascript:updateN()\">Add the Delivery Driver</a></span></td></tr>");
  ...
  private void list(Connection con, Statement stmt, ResultSet rs, PrintWriter out, int[] bytesOut) throws Exception
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT * FROM driver ORDER BY Name");
