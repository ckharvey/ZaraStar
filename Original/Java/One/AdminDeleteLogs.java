// =======================================================================================================================================================================================================
// System: ZaraStar AdminEngine - Delete log(s)
// Module: AdminDeleteLogs.java
// Author: C.K.Harvey
...
public class AdminDeleteLogs extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AdminDeleteLogs", bytesOut);
                    ...
                    String bnm, String p1, int[] bytesOut) throws Exception
  {
    ...
    deleteEntries(p1, dnm, localDefnsDir, defnsDir);

    messagePage.msgScreen(false, out, req, 21, unm, sid, uty, men, den, dnm, bnm, "AdminLogManager", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void deleteEntries(String externalCode, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    if(externalCode.startsWith("Demo"))
      stmt.executeUpdate("DELETE FROM trail WHERE UserCode LIKE '%" + externalCode + "'");
    else stmt.executeUpdate("DELETE FROM trail WHERE UserCode LIKE '%" + externalCode + "_'");

    if(stmt != null) stmt.close();
    stmt = con.createStatement();
    
    if(externalCode.startsWith("Demo"))
      stmt.executeUpdate("DELETE FROM lasttrail WHERE UserCode = '" + externalCode + "'");
    else stmt.executeUpdate("DELETE FROM lasttrail WHERE UserCode = '" + externalCode + "_'");
