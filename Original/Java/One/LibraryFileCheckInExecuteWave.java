...
// Module: LibraryFileCheckInExecuteWave.java
// Author: C.K.Harvey
...
public class LibraryFileCheckInExecuteWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryFileCheckIna", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String docCode, String docName, String directory, String userName, String unm, String sid, String uty, String men, String den, String dnm,
                   String bnm, String libraryDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "function update(){postForm('" + directoryUtils.getScriptsDirectory() + "checkin4lib.php','12005aw');}");
    scoutln(out, bytesOut, "</script>");

    scoutln(out, bytesOut, "<form id=\"12005aw\" enctype=\"multipart/form-data\" action=\"" + directoryUtils.getScriptsDirectory() + "checkin4lib.php\" method=\"post\">");

    libraryUtils.drawTitleW(con, stmt, rs, req, out, "File CheckIn", "12005", unm, uty, dnm, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "<tr><td><p>Find the File <input type=file name=\"userfile[]\"  value='" + docName + "' size=60 maxsize=100></td></tr>");

//    scoutln(out, bytesOut, "<tr><td><p><input type=\"submit\" value=Upload></td></tr>");
    scoutln(out, bytesOut, "<tr><td><p><a href=\"javascript:update()\">Upload</a></td></tr>");
