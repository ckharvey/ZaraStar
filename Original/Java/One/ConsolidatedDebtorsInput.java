// =======================================================================================================================================================================================================
// System: ZaraStar Analytic: Consolidated debtors params 
// Module: ConsolidatedDebtorsInput.java
// Author: C.K.Harvey
...
public class ConsolidatedDebtorsInput extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ConsolidatedDebtorsInput", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den,
                    String dnm, String bnm, int[] bytesOut) throws Exception
   {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "1029", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "1029", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Consolidated Debtors Parameters</title>");
    ...
    scoutln(out, bytesOut, "window.location.href='/central/servlet/ConsolidatedDebtorsExecute?unm=" + unm + "&sid=" + sid + "&uty="
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "1029", "", "ConsolidatedDebtorsInput", unm, sid, uty, men, den, dnm, bnm, localDefnsDir,
