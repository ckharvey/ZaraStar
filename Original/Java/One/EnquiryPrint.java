// =======================================================================================================================================================================================================
// System: ZaraStar Document: Enquiry: Print
// Module: EnquiryPrint.java
// Author: C.K.Harvey
...
public class EnquiryPrint extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "EnquiryPrint", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 4528, bytesOut[0], 0, "ERR:" + p1);
                    ...
                    String p1, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "4528", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 4528, bytesOut[0], 0, "ACC:" + p1);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "4528", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 4528, bytesOut[0], 0, "SID:" + p1);
      if(con != null) con.close();
      if(out != null) out.flush();
      return;
    }
    ...
    switch(numPages)
    {
      case -1 : // Definition File Not Found
                messagePage.msgScreen(false, out, req, 17, unm, sid, uty, men, den, dnm, bnm, "4528", imagesDir, localDefnsDir, defnsDir, bytesOut);
                break;
      case -2 : // cannot create report output file
                messagePage.msgScreen(false, out, req, 18, unm, sid, uty, men, den, dnm, bnm, "4528", imagesDir, localDefnsDir, defnsDir, bytesOut);
                break;
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 4528, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), p1);
    if(con  != null) con.close();
    if(out != null) out.flush();
  }
                       ...
                       String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    int docSizeMax  = miscDefinitions.docSizeMax(con, stmt, rs, "enquiry");
    int docSizeMaxA = 0;/////////miscDefinitions.docSizeMax('Q', '1', localDefnsDir, defnsDir);
    int docSizeMaxB = 0;//////////miscDefinitions.docSizeMax('Q', '2', localDefnsDir, defnsDir);
    int docSizeMaxC = 0;///////////////////////miscDefinitions.docSizeMax('Q', '3', localDefnsDir, defnsDir);

    // fetch lines data in one go
    byte[] linesData  = new byte[2000];
    int[]  listLen    = new int[1];  listLen[0] = 2000;
    int[]  linesCount = new int[1];
    linesData = enquiry.getLines(con, stmt, rs, code, '\001', linesData, listLen, linesCount, dnm, localDefnsDir, defnsDir);
    ...
    if(linesCount[0] > 0) // get all the multiple lines for this document
      multipleLinesData = enquiry.getMultipleLines(con, stmt, rs, code, multipleLinesData, multipleListLen, multipleLinesCount);
    ...
    // one page layout  = 231.ppr
    // two page laypout = 231a and 231c
    // three or more    = 231a, 231b, and 231c

    String pprFile;
    if(onePager)
      pprFile = "231.ppr";
    else pprFile = "231a.ppr";
    ...
    generalUtils.putAlpha(fldNames, 4000, (short)0,  "Enquiry.EnquiryCode");
    generalUtils.putAlpha(fldNames, 4000, (short)1,  "Enquiry.Date");
    generalUtils.putAlpha(fldNames, 4000, (short)2,  "Enquiry.CompanyCode");
    generalUtils.putAlpha(fldNames, 4000, (short)3,  "Enquiry.CompanyName");
    generalUtils.putAlpha(fldNames, 4000, (short)4,  "Enquiry.Address1");
    generalUtils.putAlpha(fldNames, 4000, (short)5,  "Enquiry.Address2");
    generalUtils.putAlpha(fldNames, 4000, (short)6,  "Enquiry.Address3");
    generalUtils.putAlpha(fldNames, 4000, (short)7,  "Enquiry.Address4");
    generalUtils.putAlpha(fldNames, 4000, (short)8,  "Enquiry.Address5");
    generalUtils.putAlpha(fldNames, 4000, (short)9,  "Enquiry.PostCode");
    generalUtils.putAlpha(fldNames, 4000, (short)10, "Enquiry.FAO");
    generalUtils.putAlpha(fldNames, 4000, (short)11, "Enquiry.Misc1");
    generalUtils.putAlpha(fldNames, 4000, (short)12, "Enquiry.Misc2");
    generalUtils.putAlpha(fldNames, 4000, (short)13, "Enquiry.DateRange");
    generalUtils.putAlpha(fldNames, 4000, (short)14, "Enquiry.Attention");
    generalUtils.putAlpha(fldNames, 4000, (short)15, "EnquiryL.Entry");
    generalUtils.putAlpha(fldNames, 4000, (short)16, "EnquiryL.ItemCode");
    generalUtils.putAlpha(fldNames, 4000, (short)17, "EnquiryL.Description");
    generalUtils.putAlpha(fldNames, 4000, (short)18, "EnquiryL.UnitPrice");
    generalUtils.putAlpha(fldNames, 4000, (short)19, "EnquiryL.Quantity");
    generalUtils.putAlpha(fldNames, 4000, (short)20, "EnquiryL.DiscountPercentage");
    generalUtils.putAlpha(fldNames, 4000, (short)21, "EnquiryL.Amount");
    generalUtils.putAlpha(fldNames, 4000, (short)22, "EnquiryL.GSTRate");
    generalUtils.putAlpha(fldNames, 4000, (short)23, "EnquiryL.UoM");
    generalUtils.putAlpha(fldNames, 4000, (short)24, "EnquiryL.AltItemCode");
    generalUtils.putAlpha(fldNames, 4000, (short)25, "Enquiry.GSTTotal");
    generalUtils.putAlpha(fldNames, 4000, (short)26, "Enquiry.TotalTotal");
    generalUtils.putAlpha(fldNames, 4000, (short)27, "Enquiry.GroupDiscount");
    generalUtils.putAlpha(fldNames, 4000, (short)28, "Enquiry.GroupDiscountType");
    generalUtils.putAlpha(fldNames, 4000, (short)29, "Enquiry.TotalWithoutGST");
    generalUtils.putAlpha(fldNames, 4000, (short)30, "Enquiry.SalesPerson");
    generalUtils.putAlpha(fldNames, 4000, (short)31, "Enquiry.EnquiryCode");
    generalUtils.putAlpha(fldNames, 4000, (short)32, "Enquiry.Currency");
    generalUtils.putAlpha(fldNames, 4000, (short)33, "Enquiry.NoteLine1");
    generalUtils.putAlpha(fldNames, 4000, (short)34, "Enquiry.NoteLines");
    generalUtils.putAlpha(fldNames, 4000, (short)35, "EnquiryL.CustomerItemCode");
    generalUtils.putAlpha(fldNames, 4000, (short)36, "Enquiry.Terms");
    generalUtils.putAlpha(fldNames, 4000, (short)37, "Enquiry.Validity");
    generalUtils.putAlpha(fldNames, 4000, (short)38, "Enquiry.Delivery");
    generalUtils.putAlpha(fldNames, 4000, (short)39, "Enquiry.Packaging");
    generalUtils.putAlpha(fldNames, 4000, (short)40, "Enquiry.Fax");
    generalUtils.putAlpha(fldNames, 4000, (short)41, "Enquiry.Country");
    generalUtils.putAlpha(fldNames, 4000, (short)42, "Enquiry.RemarkLine");
    generalUtils.putAlpha(fldNames, 4000, (short)43, "Enquiry.DeliveryLeadTime");
    generalUtils.putAlpha(fldNames, 4000, (short)44, "Enquiry.Manufacturer");
    generalUtils.putAlpha(fldNames, 4000, (short)45, "EnquiryL.Text1");
    generalUtils.putAlpha(fldNames, 4000, (short)46, "EnquiryL.Text2");
    generalUtils.putAlpha(fldNames, 4000, (short)47, "Enquiry.Phone");
    generalUtils.putAlpha(fldNames, 4000, (short)48, "Enquiry.SignOn");
    generalUtils.putAlpha(fldNames, 4000, (short)49, "EnquiryL.ManufacturerCode");

    double groupDiscount=0.0;
    String remarkType="";
    byte[] customerCode = new byte[21];

    if(enquiry.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut) != -1L) // just-in-case
    {
    ...
    reportGenDetails.processSection("RH", null, null, (short)0, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         ...
                         oBuf, gstRates);
    reportGenDetails.processSection("PH", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                         oBuf, gstRates);
    ...
    for(int xx=0;xx<linesCount[0];++xx)
    {
      if(generalUtils.getListEntryByNum(xx, linesData, tmp)) // just-in-case
      {
        ...
        {  
          outputDetailLine(con, stmt, rs, data, fldNames, lineNumB, itemCode, mfrCode, unitPrice, quantity, amount2, gstRate, discountPercentage, uom, custItemCode, 
                           entry, lastEntry, lineCount, pageCount, mfrCode, numPages, docSizeMax, docSizeMaxA, docSizeMaxB, onePager, twoPager,
                           threePager, dpOnQuantities, unm, dnm, localDefnsDir, defnsDir, tm, bm, lm, rm, pageSizeWidth, pageSizeLength, currDown,
                           currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle, userFontItalic, userFontSize,
                           fhPPR, fhO, fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord, oBuf, gstRates);

          entry[0] = '\000'; unitPrice[0] = '\000'; quantity[0] = '\000'; discountPercentage[0] = '\000'; amount2[0] = '\000';
          gstRate[0] = '\000'; uom[0] = '\000';
        }

        outputDetailLine(con, stmt, rs, data, fldNames, lineNumB, itemCode, desc, unitPrice, quantity, amount2, gstRate, discountPercentage, uom, custItemCode, 
                         entry, lastEntry, lineCount, pageCount, mfrCode, numPages, docSizeMax, docSizeMaxA, docSizeMaxB, onePager, twoPager,
                         threePager, dpOnQuantities, unm, dnm, localDefnsDir, defnsDir, tm, bm, lm, rm, pageSizeWidth, pageSizeLength, currDown,
                         currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle, userFontItalic, userFontSize,
                         fhPPR, fhO, fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord, oBuf, gstRates);
        ...
        while(llCount != -1)
        {
          ...
          while(! quit1)
          {
            ...
            generalUtils.repAlpha(data, 4000, (short)17, b); // desc
            reportGenDetails.processSection("BL1", data, fldNames, (short)47, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                                 pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName,
                                 userFontStyle, userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize,
                                 down2Coord, across2Coord, oBuf, gstRates);
            ++lineCount[0];
            if(chkForPageThrow(lineCount, pageCount, numPages, docSizeMax, docSizeMaxA, docSizeMaxB, onePager, twoPager, threePager, data, fldNames,
                               unm, dnm, localDefnsDir, defnsDir, tm, bm, lm, rm, pageSizeWidth, pageSizeLength, currDown, currAcross, currFont,
                               currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle, userFontItalic, userFontSize, fhPPR, fhO,
                               fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord, oBuf, gstRates) == -1)
            {
              return -1;
            } 
        ...
        {
          generalUtils.repAlpha(data, 4000, (short)35, custItemCode); // custitemcode
          reportGenDetails.processSection("BL2", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                         oBuf, gstRates);
          ++lineCount[0];
    ...
    if(pageCount[0] < numPages)
    {
      ...
      b[0] = '\000';
      reportGenDetails.outputLine('F', b, data, fldNames, (short)48, ' ', dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                         oBuf, gstRates);
    ...
    enquiry.getRecGivenCode(con, stmt, rs, code, '\000', tmp, dnm, localDefnsDir, defnsDir, bytesOut);
    ...
    while(b[x] != '\000')
    {
      ...
      reportGenDetails.processSection("BL3", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                           oBuf, gstRates);
    ...
    reportGenDetails.processSection("PF", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                         oBuf, gstRates);
    ...
    {
      reportGenDetails.processSection("RF1", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                           oBuf, gstRates);
    }
    ...
    {
      reportGenDetails.processSection("RF2", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                           oBuf, gstRates);
    }
    ...
    // posn cursor
    reportGenDetails.processSection("RF7", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                         oBuf, gstRates);
    
    outputRemark(remarkType, data, fldNames, dnm, unm, localDefnsDir, defnsDir, tm, bm, lm, rm, pageSizeWidth, pageSizeLength, currDown,
                 currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle, userFontItalic, userFontSize, fhPPR,
                 fhO, fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord, oBuf, gstRates);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void outputRemark(String remarkType, byte[] data, byte[] fldNames, String dnm, String unm, String localDefnsDir, String defnsDir, 
                            double[] tm, double[] bm, double[] lm, double[] rm, double[] pageSizeWidth, double[] pageSizeLength, double[] currDown,
                            double[] currAcross, short[] currFont, short[] currPage, short[] oPtr, short oBufLen, boolean[] lastOperationPF,
                            String[] userFontName, String[] userFontStyle, String[] userFontItalic, String[] userFontSize, RandomAccessFile[] fhPPR,
                            ...
                            double[] down2Coord, double[] across2Coord, byte[] oBuf, String[] gstRates) throws Exception
  {
    ...
    while(! s.equals(" "))
    {
      ...
      reportGenDetails.processSection("RF8", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                           oBuf, gstRates);
    }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private int chkForPageThrow(int[] lineCount, int[] pageCount, int numPages, int docMaxSize, int docMaxSizeA, int docMaxSizeB, boolean onePager,
                              boolean twoPager, boolean threePager, byte[] data, byte[] fldNames, String unm, String dnm, String localDefnsDir,
                              String defnsDir, double[] tm, double[] bm, double[] lm, double[] rm, double[] pageSizeWidth, double[] pageSizeLength,
                              double[] currDown, double[] currAcross, short[] currFont, short[] currPage, short[] oPtr, short oBufLen,
                              boolean[] lastOperationPF, String[] userFontName, String[] userFontStyle, String[] userFontItalic, String[] userFontSize,
                              RandomAccessFile[] fhPPR, RandomAccessFile[] fhO, char[] fontDefType, char[] fontDefStyle, char[] fontDefItalic,
                              int[] fontDefSize, double[] down2Coord, double[] across2Coord, byte[] oBuf, String[] gstRates) throws Exception
  {
    ...
    if(twoPager)
    {
      ...
      else // pageCount must be 1
      {
        ...
        {       
          reportGenDetails.outputLine('F', b, data, fldNames, (short)50, ' ', dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                           pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                           userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                           oBuf, gstRates);
          lineCount[0] = 1;
    ...
    else // more than 3 pages
    {
      ...
      else // not on first, nor penultimate, nor last
      {
        if(lineCount[0] >= docMaxSizeB)
        {       
          reportGenDetails.outputLine('E', b, data, fldNames, (short)50, ' ', dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
                         userFontItalic, userFontSize, fhPPR[0], fhO[0], fontDefType, fontDefStyle, fontDefItalic, fontDefSize, down2Coord, across2Coord,
                         oBuf, gstRates);
          lineCount[0] = 1;
  ...
  private void outputDetailLine(Connection con, Statement stmt, ResultSet rs, byte[] data, byte[] fldNames, byte[] lineNumB, byte[] itemCode, byte[] desc, byte[] unitPrice, byte[] quantity,
                                byte[] amount2, byte[] gstRate, byte[] discountPercentage, byte[] uom, byte[] custItemCode, byte[] entry,
                                byte[] lastEntry, int[] lineCount, int[] pageCount, byte[] mfrCode, int numPages, int docSizeMax, int docSizeMaxA,
                                int docSizeMaxB, boolean onePager, boolean twoPager, boolean threePager, char dpOnQuantities, String unm, String dnm,
                                String localDefnsDir, String defnsDir, double[] tm, double[] bm, double[] lm, double[] rm, double[] pageSizeWidth,
                                double[] pageSizeLength, double[] currDown, double[] currAcross, short[] currFont, short[] currPage, short[] oPtr,
                                short oBufLen, boolean[] lastOperationPF, String[] userFontName, String[] userFontStyle, String[] userFontItalic,
                                String[] userFontSize, RandomAccessFile[] fhPPR, RandomAccessFile[] fhO, char[] fontDefType, char[] fontDefStyle,
                                char[] fontDefItalic, int[] fontDefSize, double[] down2Coord, double[] across2Coord, byte[] oBuf, String[] gstRates) throws Exception
  {
    byte[] b = new byte[100];
    ...
    reportGenDetails.processSection("BL1", data, fldNames, (short)50, dnm, unm, localDefnsDir, defnsDir, tm[0], bm[0], lm[0], rm[0], pageSizeWidth[0],
                         pageSizeLength[0], currDown, currAcross, currFont, currPage, oPtr, oBufLen, lastOperationPF, userFontName, userFontStyle,
    ...
    ++lineCount[0];
    if(chkForPageThrow(lineCount, pageCount, numPages, docSizeMax, docSizeMaxA, docSizeMaxB, onePager, twoPager, threePager, data, fldNames, unm, dnm,
                       localDefnsDir, defnsDir, tm, bm, lm, rm, pageSizeWidth, pageSizeLength, currDown, currAcross, currFont, currPage, oPtr,
                       oBufLen, lastOperationPF, userFontName, userFontStyle, userFontItalic, userFontSize, fhPPR, fhO, fontDefType, fontDefStyle,
                       fontDefItalic, fontDefSize, down2Coord, across2Coord, oBuf, gstRates) == -1)
    {
      ;
    } 
  }
