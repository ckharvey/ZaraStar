...
public class BlogsEditRaw extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String p1, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "BlogsEditRaw", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "BlogsEditRaw", imagesDir, localDefnsDir, defnsDir, bytesOut);
                   ...
                   String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    blogsUtils.outputPageFrame(con, stmt, rs, out, req, "BlogsEditRaw", "", "", "8102", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    blogsUtils.drawTitle(con, stmt, rs, req, out, "Edit Blog Entry", "8102", p1, false, true, true, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "<input type=hidden name=callingServlet value=\"BlogsEditRaw\">");
...
//    else scoutln(out, bytesOut, "<input type=hidden name=serviceCode value=\"" + serviceCode[0] + "\">");
    ...
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td><p>Date:</p></td><td colspan=3><p><input type=text size=10 maxlength=10 name=date value=\"" + date[0] + "\"></p></td></tr>");
