...
public class BlogsGuideDefinitionWave extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 13, unm, sid, uty, men, den, dnm, bnm, "BlogsGuideDefinition", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "BlogsGuideDefinition", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "8108\001Blogs\001Blog Guide Definition\001javascript:getHTML('BlogsGuideDefinitionWave','')\001\001Y\001\001\003");
                      ...
                      int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "var url=\"http://" + men + "/central/servlet/BlogsGuideDefinitionUpdateWave?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men
                         + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm + "') + \"&p1=\" + name + \"&dnm=\" + escape('" + dnm + "');");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/BlogsGuideDefinitionDeleteWave?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men
                         + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm + "') + \"&p1=\" + escape(name) + \"&dnm=\" + escape('" + dnm + "');");
    ...
    scoutln(out, bytesOut, "function refetchPage(){getHTML('BlogsGuideDefinitionWave','');}");
    ...
    blogGuideUtils.drawTitleW(con, stmt, rs, req, out, "Guide Definition", "8108", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
