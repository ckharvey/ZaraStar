// =======================================================================================================================================================================================================
// System: ZaraStar: Accounts: GL Sales
// Module: AccountsGLSales.java
// Author: C.K.Harvey
...
public class AccountsGLSales extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      p5  = req.getParameter("p5"); // salesAccount, or Commission, or not
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007c: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AccountsGLSales", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, String p5, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AccountsGLSales", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AccountsGLSales", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, Statement stmt2, ResultSet rs2, ResultSet rs, PrintWriter out, HttpServletRequest req,
                   ...
                   String men, String den, String dnm, String bnm, String workingDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, account, p2, p3, p5, "", "AccountsGLSales", unm, sid, uty, men, den,
    ...
    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AccountsGLSales", account, dateFrom, dateTo, p5, "", "GL Account: " + account + " - " + accountsUtils.getAccountDescriptionGivenAccCode(account, year, dnm, localDefnsDir, defnsDir) + " ("
    ...
    calc(con, stmt, stmt2, rs, account, year, dateFrom, dateTo, p5, dnm, localDefnsDir, defnsDir, tmpTable);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  public void calc(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String account, String year, String dateFrom, String dateTo, String p5, String dnm, String localDefnsDir, String defnsDir, String tmpTable) throws Exception
  {
    ...
    if(p5.equals("S") && (account.equals(accountsUtils.getSalesAccCode(year, dnm, localDefnsDir, defnsDir)))) // salesAccount
                             ...
                             String dateTo, String tmpTable) throws Exception
  {
    ...
    {    
      ...
      baseAmount        = generalUtils.doubleDPs(generalUtils.doubleFromStr(rs.getString(4)), '2');
      date              = rs.getString(5);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private void onSalesCreditNoteLine(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String accCode, String dateFrom, String dateTo, String tmpTable)
                                throws Exception
  {
    stmt = con.createStatement();
  ...
  private void onDebitNote(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String dateFrom, String dateTo, String tmpTable) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT DNCode, CompanyName, TotalTotal, BaseTotalTotal, GSTTotal, BaseGSTTotal, Date, Currency FROM debit WHERE Status != 'C' AND Date >= {d '" + dateFrom + "'} AND Date <= {d '" + dateTo + "'}");
