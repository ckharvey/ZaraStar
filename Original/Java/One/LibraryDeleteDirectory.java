...
// Module: LibraryDeleteDirectory.java
// Author: C.K.Harvey
...
public class LibraryDeleteDirectory extends HttpServlet
{
                    ...
                    String bnm, String p1, String p2, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "LibraryDeleteDirectory", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryDeleteDirectory", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String p1, String p2, String unm, String sid, String uty, String men,
                   String den, String dnm, String bnm, String imagesDir, String libraryDir, String localDefnsDir, String defnsDir, int[] bytesOut)
                   throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>Library: Delete Directory</title>");
    ...
    libraryUtils.drawTitle(con, stmt, rs, req, out, "Delete Directory", "12009", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    scoutln(out, bytesOut, "<form action=\"LibraryDeleteDirectorya\" enctype=\"application/x-www-form-urlencoded\" method=POST>");
    ...
    scoutln(out, bytesOut, "<tr><td colspan=2><span id=\"textErrorLarge\">WARNING: This operation will delete the files in the directory ("
              + p1.substring(len) + "). The directory itself will only be deleted if it has no sub-directories</span></td></tr>");
