...
public class BlogsDisplayBlogGuideDisplay extends HttpServlet
{
                   ...
                   String imageLibraryDir, String flashDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    blogsUtils.outputPageFrame(con, stmt, rs, out, req, "BlogsDisplayBlogGuide", "", "", "8110", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);

    blogsUtils.drawTitle(con, stmt, rs, req, out, "", "8110", "", false, false, false, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
    ...
    while(x < len)
    {
      ...
      getForAService(conInfo, stmtInfo, rsInfo, con, stmt, rs, out, service, unm, sid, uty, men, den, dnm, bnm, imageLibraryDir, flashDir, localDefnsDir, defnsDir, bytesOut);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private String getForAService(Connection conInfo, Statement stmtInfo, ResultSet rsInfo, Connection con, Statement stmt, ResultSet rs, PrintWriter out, String service, String unm, String sid, String uty, String men, String den, String dnm,
                                String bnm, String imageLibraryDir, String flashDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    while(rsInfo.next())
    {
      ...
      t1 = wiki.convertLinks(text, unm, sid, uty, men, den, dnm, bnm, imageLibraryDir, flashDir, localDefnsDir);
