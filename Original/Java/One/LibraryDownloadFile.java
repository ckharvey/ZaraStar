...
public class LibraryDownloadFile extends HttpServlet
{
                   ...
                   int[] bytesOut) throws Exception
  {
    ...
    libraryUtils.outputPageFrame(con, stmt, rs, out, req, "LibraryDownloadFile", "12003", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);

    libraryUtils.drawTitle(con, stmt, rs, req, out, "File Download", "12003", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
