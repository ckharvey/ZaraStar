// =======================================================================================================================================================================================================
// System: ZaraStar Document: GST: Purchase Invoices listing
// Module: GSTPurchaseInvoiceListing.java
// Author: C.K.Harvey
...
public class GSTPurchaseInvoiceListing extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "GSTPurchaseInvoiceListing", bytesOut);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void doIt(PrintWriter out, HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "GSTPurchaseInvoiceListing", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    String fName = "Data_InputGST_Terms.csv";
    ...
    if(p4.equals("X"))
    {
      ...
      writeEntry(fh, "SupplierInvoiceCode", ' ', ' ', true, false);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void generate(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, boolean isCSV, RandomAccessFile fh, String unm, String sid, String uty, String men, String den, String dnm, String bnm,
                        String dateFrom, String dateTo, String gstRate, boolean plain, String imagesDir, String localDefnsDir, String defnsDir, int[] bytesOut, double[] baseGrandTotal, double[] baseGSTGrandTotal, double[] baseExclusiveGrandTotal)
                        throws Exception
  {
    if(! isCSV)
    {
    ...
    rs = stmt.executeQuery("SELECT DISTINCT t1.InvoiceCode, t1.Date, t1.CompanyCode, t1.BaseGSTTotal, t1.BaseTotalTotal, t1.TotalTotal, t1.GSTTotal, t1.Currency, t1.CompanyName, t1.SupplierInvoiceCode FROM pinvoicel AS t2 "
                         + "INNER JOIN pinvoice AS t1 "
    ...
    String invoiceCode, date, companyCode, baseGSTTotal, baseTotalTotal, totalTotal, gstTotal, currency, name, suppInvoiceCode, baseExclusiveTotal, issueExclusiveTotal;
    String cssFormat = "";
    ...
    while(rs.next())                  
    {
      ...
      if(isCSV)
      {
        ...
        writeEntry(fh, suppInvoiceCode, ' ', '2', true, false);
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void setHead(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, boolean plain, String dateFrom, String dateTo, String gstRate, String unm, String sid, String uty, String men, String den, String dnm,
                       String bnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>GST Purchase Invoice Listing</title>");
    ...
    outputPageFrame(con, stmt, rs, out, req, plain, dateFrom, dateTo, gstRate, "", "GST Reconciliation: Purchase Invoice Listing", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, bytesOut);
  ...
  private void startBody(boolean first, PrintWriter out, String imagesDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<td nowrap><p>Supplier Code &nbsp;</td>");
  ...
  private String buildSubMenuText(boolean plain, String dateFrom, String dateTo, String gstRate, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] hmenuCount) throws Exception
  {
    ...
    if(! plain)
    {
      ...
      s += "<a href=\"/central/servlet/GSTPurchaseInvoiceListing?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + dateFrom + "&p2=" + dateTo + "&p3=" + generalUtils.sanitise(gstRate)
