...
public class DocumentAttachmentsDelete extends HttpServlet
{
                      ...
                      String code, String libraryDocCode, String fileName, int[] bytesOut) throws Exception
  {
    ...
    {
      if(deleteRec(dnm, code, libraryDocCode, fileName, localDefnsDir, defnsDir))
        rtn = ".";
    }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private boolean deleteRec(String dnm, String code, String libraryDocCode, String fileName, String localDefnsDir,
                              String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM " + fileName + " WHERE Code = '" + code + "' AND LibraryDocCode = '"
                                               + libraryDocCode + "'"); 
