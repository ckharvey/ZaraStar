...
// Module: LibraryCreateRecordUpload.java
// Author: C.K.Harvey
...
public class LibraryCreateRecordUpload extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      while(en.hasMoreElements())
      {
        ...
        if(name.equals("p4")) // target dir (stripped)
          p4 = value[0];
        else
        if(name.equals("p5")) // fromWhere
          p5 = value[0];
        else
        if(name.equals("p6")) // fromWhereDocCode
          p6 = value[0];
      }
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, String p5, String p6, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryCreateRecordUpload", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {   
      bytesIn = analyze(con, stmt, rs, out, req, p1, p2, p3, p4, p5, p6, unm, sid, uty, men, den, dnm, bnm, referenceDir, imagesDir, localDefnsDir, defnsDir, bytesOut);
    }
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private int analyze(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String tmpFile, String fileName, String fullDirectory, String directory, String fromWhere, String fromWhereDocCode, String unm,
                      String sid, String uty, String men, String den, String dnm, String bnm, String referenceDir, String imagesDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {   
    ...
    if(fullDirectory.startsWith(referenceDir))
    {
      ...
      if(docNum.length() > 0)
      {
        ...
        messagePage.msgScreen(false, out, req, 0, unm, sid, uty, men, den, dnm, bnm, "12002", "", "", "Uploaded as Library Document: " + docNum, imagesDir, localDefnsDir, defnsDir, bytesOut);
      }
      else messagePage.msgScreen(false, out, req, 39, unm, sid, uty, men, den, dnm, bnm, "LibraryCreateRecordUpload", imagesDir, localDefnsDir, defnsDir, bytesOut);
    }  
