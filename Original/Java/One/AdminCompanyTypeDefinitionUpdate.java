// =======================================================================================================================================================================================================
// System: ZaraStar AdminEngine: Company Type definition - update
// Module: AdminCompanyTypeDefinitionUpdate.java
// Author: C.K.Harvey
...
public class AdminCompanyTypeDefinitionUpdate extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7058a: " + e));
      res.getWriter().write("Unexpected System Error: 7058a");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String name, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7058a";
    ...
    else
    {
      ...
      if(name.length() == 0)
        rtn = "No Company Type Name Entered";
      else
      {
        switch(update(dnm, name))
        {
          case ' ' : rtn = ".";                           break;
          case 'E' : rtn = "Company Type Already Exists"; break;
        }
      }
    }
    ...
    serverUtils.totalBytes(req, unm, dnm, 7058, bytesOut[0], 0, "");
  }
  ...
  //       'X' other error
  private char update(String dnm, String name) throws Exception
  {
    Connection con = null;
    Statement stmt = null;
    ResultSet rs   = null;
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Name FROM companytype WHERE Name = '" + name + "'"); 
      if(rs.next())
        alreadyExists = true;
      rs.close() ;
      ...
      String q = "INSERT INTO companytype ( Name ) VALUES ('" + name + "')";
