// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Storeman definition - fetch for edit
// Module: AdminStorePersonDefinitionEdit.java
// Author: C.K.Harvey
...
public class AdminStorePersonDefinitionEdit extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7013c: " + e));
      res.getWriter().write("Unexpected System Error: 7013c");
    }
  }
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String name, int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7013c";
  ...
  private boolean fetch(String dnm, String name, String[] note, String[] type) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Type, Note FROM storeman WHERE Name = '" + name + "'");
