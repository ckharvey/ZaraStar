// =======================================================================================================================================================================================================
// System: ZaraStar Info: Consolidations Purchases by Supplier
// Module: ConsolidationsPurchasesSupplier.java
// Author: C.K.Harvey
...
public class ConsolidationsPurchasesSupplier extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ConsolidationsPurchasesSupplier", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 6912, bytesOut[0], 0, "ERR:");
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm,
                    String bnm, int[] bytesOut) throws Exception
   {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "6912", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 6912, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "6912", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 6912, bytesOut[0], 0, "SID:");
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 6912, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
                   ...
                   String bnm, String imagesDir, String reportsDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "window.location.href=\"/central/servlet/ConsolidationsPurchasesSupplierExecute?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=\"+which;}");
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6912", "", "ConsolidationsPurchasesSupplier", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
                                
    scoutln(out, bytesOut, "<form>");
  
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Purchases by Supplier", "6912",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
