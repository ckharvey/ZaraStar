// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Edit Mail Accounts
// Module: MailAccounts.java
// Author: C.K.Harvey
...
public class MailAccounts extends HttpServlet implements SingleThreadModel
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "MailAccounts", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String dnm, String men, String den, String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(serverUtils.isSysAdmin(con, stmt, rs, unm, dnm, sid, uty, localDefnsDir, defnsDir) || serverUtils.isDBAdmin(con, stmt, rs, unm))
    {
      ...
      {
        messagePage.msgScreen(true, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "MailAccounts", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(true, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "MailAccounts", imagesDir, localDefnsDir, defnsDir, bytesOut);
    }
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Mail Users</title>");
    ...
    dashboardUtils.drawTitle(out, "Mail Users", "402", unm, sid, uty, men, den, dnm, bnm, bytesOut);
    ...
    try
    {
      ...
      while(rs.next())
      {
        ...
        else
        {
          ...
          scoutln(out, bytesOut, "<tr id=\"" + cssFormat + "\"><td nowrap><p><a href=\"javascript:edit('" + userCode + "')\">" + userName + "</td>");

          if(status.equals("S"))
            scoutln(out, bytesOut, "<td width=99%><p>&nbsp;&nbsp; (suspended)</td></tr>");
          else scoutln(out, bytesOut, "<td width=99%></td></tr>");
        }
      }
