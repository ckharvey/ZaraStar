...
public class DocumentAttachmentExecuteWave extends HttpServlet
{
  ...
  private void doIt(HttpServletRequest req, HttpServletResponse res, String unm, String sid, String uty, String dnm, String code, String libraryDocCode, String fileName, int[] bytesOut) throws Exception
  {
    ...
    else
    {
      ...
      {
        switch(update(dnm, code, libraryDocCode, fileName))
        {
          case ' ' : rtn = ".";                         break;
  ...
  //       'X' other error
  private char update(String dnm, String code, String libraryDocCode, String fileName) throws Exception
  {
    Connection con = null;
    Statement stmt = null;
    ResultSet rs   = null;
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM " + fileName + " WHERE Code = '" + code + "' AND LibraryDocCode = '" + libraryDocCode + "'");
      if(rs.next())
        alreadyExists = true;
      rs.close();
