...
// Module: LocalAccessExecute.java
// Author: C.K.Harvey
...
public class LocalAccessExecute extends HttpServlet
{
  ...
  MainPageDisplay mainPageDisplay = new MainPageDisplay();
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String atunm, String p1, String p2, String p3, String p4, String which, String unm, String pwd, String bnm, String dnm, String men, String den, int[] bytesOut) throws Exception
  {
    ...
    try
    {
      ...
      {
        messagePage.msgScreen(false, out, req, 13, unm, sid[0], "", men, den, dnm, bnm, "MainPageUtilsd", "", "", "", bytesOut);
     ...
     if(! systemStatus[0].equals("L")) // ! live
        {
          messagePage.msgScreen(false, out, req, 1, unm, "", "", men, den, dnm, bnm, "MainPageUtilsd", "", "", "", bytesOut);
     ...
     mainPageDisplay.doIt(out, req, unm, sid[0], ""+userType[0], men, den, dnm, bnm, p1, p2, p3, p4, which, bytesOut);
    }
    catch(Exception e) { } 
