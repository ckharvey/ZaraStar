...
public class ImagesMaintainDirectories extends HttpServlet
{
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String p1, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "ImagesMaintainDirectories", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Image Library: Maintain Directories</title>");
    ...
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/ImagesListDirectory?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=\"+userName+\"&p1=\"+p1;}");
    ...
    imageLib.outputPageFrame(con, stmt, rs, out, req, "6500", "ImagesMaintainDirectories", "", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);
     
    imageLib.drawTitle(con, stmt, rs, req, out, "Image Library Directory List", "6500", "ImagesMaintainDirectories", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
