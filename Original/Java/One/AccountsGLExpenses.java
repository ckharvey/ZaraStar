// =======================================================================================================================================================================================================
// System: ZaraStar: Accounts: GL Expenses (except bank charges)
// Module: AccountsGLExpenses.java
// Author: C.K.Harvey
...
public class AccountsGLExpenses extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      System.out.println("6007g: " + e);
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "AccountsGLExpenses", bytesOut);
                    ...
                    String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "AccountsGLExpenses", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "AccountsGLExpenses", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  private void set(Connection con, Statement stmt, Statement stmt2, ResultSet rs, ResultSet rs2, PrintWriter out, HttpServletRequest req,
                   String dateFrom, String dateTo, String account, String p2, String p3, boolean plain, String unm, String sid, String uty,
                   String men, String den, String dnm, String bnm, String workingDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6077, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(out, bytesOut, "this.location.href=\"/central/servlet/InterAccountTransferPage?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den
                           + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=A&p3=&p4=&p1=\"+p1;}");
    }
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "6007", "", true, plain, account, p2, p3, "", "", "AccountsGLExpenses", unm, sid, uty, men, den,
    ...
    if(! plain)
    {
      pageFrameUtils.drawTitle(out, true, plain, "AccountsGLExpenses", account, dateFrom, dateTo, "", "", "GL Account: " + account + " - " + accountsUtils.getAccountDescriptionGivenAccCode(account, year, dnm, localDefnsDir, defnsDir) + " ("
                   ...
                   String dnm, String localDefnsDir, String defnsDir, String tmpTable) throws Exception
  {
    ...
    onPaymentVoucherHeader(con, stmt, stmt2, rs, account, year, dateFrom, dateTo, tmpTable); // for the nonsense case where header has expense a/c
    onReceiptVoucherHeader(con, stmt, stmt2, rs, account, year, dateFrom, dateTo, tmpTable); // for the nonsense case where header has expense a/c
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onPaymentVoucherHeader(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String accCode, String year, String dateFrom,
                                      String dateTo, String tmpTable) throws Exception
  {
    stmt = con.createStatement();
  ...
  // -------------------------------------------------------------------------------------------------------------------------------------------------
  private void onReceiptVoucherHeader(Connection con, Statement stmt, Statement stmt2, ResultSet rs, String accCode, String year, String dateFrom,
                                      String dateTo, String tmpTable) throws Exception
  {
    stmt = con.createStatement();
                             ...
                             String dateTo, String tmpTable) throws Exception
  {
    ...
    {    
      ...
      {
      amt = generalUtils.doubleDPs(generalUtils.doubleDPs(bAmt, '2') - generalUtils.doubleDPs((generalUtils.doubleDPs(bAmt, '2') * lastGroupDiscount), '2'), '2');
                             ...
                             double baseAmount, String date, String currency, String tmpTable) throws Exception
  {
    ...
    String q = "INSERT INTO " + tmpTable + " ( Type, Code, Reference, Description, Total, BaseTotal, Date, Currency ) "
             + "VALUES ( '" + type + "', '" + code + "', '" + generalUtils.sanitiseForSQL(reference) + "', '" + generalUtils.sanitiseForSQL(desc) + "', '" + amount + "', '" + baseAmount + "', {d '" + date + "'}, '" + currency + "' )";
