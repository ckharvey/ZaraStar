...
public class LibraryCheckoutFileExecuteWave extends HttpServlet
{
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4, String libDir, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreenW(out, req, 12, unm, sid, uty, men, den, dnm, bnm, "LibraryCheckoutFileExecute", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    scoutln(out, bytesOut, "12004\001Documents\001Document Checkout\001javascript:getHTML('LibraryCheckoutFileWave','')\001\001Y\001\001\003");
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String docCode, String docName, String directory, String unm, String sid, String uty, String men, String den, String dnm, String bnm,
                   String libDir, /* libraryDir, */ String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<FORM name=doit ACTION=\"LibraryDownloadFileExecuteWave\" ENCTYPE=\"application/x-www-form-urlencoded\" METHOD=POST>");
    ...
    scoutln(out, bytesOut, "<tr><td><input type=hidden name=\"libDir\" value='" + libDir  + "/'></td></tr>");
    ...
    scoutln(out, bytesOut, "<script>document.doit.submit();</script>");
  }
