// =======================================================================================================================================================================================================
// System: ZaraStar Analytic: Create DAA report page
// Module: DAAReport.java
// Author: C.K.Harvey
...
public class DAAReport extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "MainPageUtils4", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm,
                    String bnm, int[] bytesOut) throws Exception
   {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "1004", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "1004", imagesDir, localDefnsDir, defnsDir, bytesOut);
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Debtors Ageing</title></head>");
    ...
    pageFrameUtils.drawTitle(out, false, false, "", "", "", "", "", "", "Debtors Ageing", "1004",  unm, sid, uty, men, den, dnm, bnm, hmenuCount, bytesOut);
    ...
    scoutln(out, bytesOut, "<a href=\"/central/servlet/MainPageUtils4a?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den="
    ...
    for(int i=0;i<names.length;++i)
    {
      if(names[i].endsWith("065"))
      {
        ...
        scoutln(out, bytesOut, "<td width=90% align=left><p><a href=\"/central/servlet/OnscreenReport?unm=" + unm + "&sid=" + sid + "&uty="
                              + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + names[i] + "&bnm=" + bnm + "\">Screen</a>");

        scoutln(out, bytesOut, "&nbsp;&nbsp;&nbsp;<a href=\"/central/servlet/MainPageUtils4c?unm=" + unm + "&sid=" + sid + "&uty=" + uty
                             + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + names[i] + "&bnm=" + bnm + "\">Printer</a>");

        scoutln(out, bytesOut, "&nbsp;&nbsp;&nbsp;<a href=\"/central/servlet/RemoveReport?unm=" + unm + "&sid=" + sid + "&uty=" + uty
                             + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + names[i] + "&p2=MainPageUtils4&bnm=" + bnm + "\">Remove</a></td></tr>");
      }
    }

    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");

    scoutln(out, bytesOut, "<tr><td></td><td><a href=\"/central/servlet/MainPageUtils4?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
