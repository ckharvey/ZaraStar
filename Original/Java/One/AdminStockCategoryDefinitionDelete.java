// =======================================================================================================================================================================================================
// System: ZaraStar Admin: Stock category definition - delete
// Module: AdminStockCategoryDefinitionDelete.java
// Author: C.K.Harvey
...
public class AdminStockCategoryDefinitionDelete extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    {
      System.out.println(("Unexpected System Error: 7071b: " + e));
      res.getWriter().write("Unexpected System Error: 7071b");
    }
  }
                    ...
                    int[] bytesOut) throws Exception
  {
    ...
    String rtn="Unexpected System Error: 7071b";
  ...
  private boolean deleteRec(String dnm, String code, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      int numRecsDeleted = stmt.executeUpdate("DELETE FROM stockcat WHERE CategoryCode= '" + code + "'");
