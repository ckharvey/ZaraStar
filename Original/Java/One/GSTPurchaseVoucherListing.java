// =======================================================================================================================================================================================================
// System: ZaraStar Document: GST: PV listing
// Module: GSTPurchaseVoucherListing.java
// Author: C.K.Harvey
...
public class GSTPurchaseVoucherListing extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "GSTPurchaseVoucherListing", bytesOut);
                    ...
                    String dnm, String bnm, String p1, String p2, String p3, String p4, int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "GSTPurchaseVoucherListing", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
                        ...
                        String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String voucherCode, date, companyCode, baseGSTTotal, baseTotalTotal, totalTotal, gstTotal, currency, type;
     
    rs = stmt.executeQuery("SELECT DISTINCT t1.VoucherCode, t1.Date, t1.CompanyCode, t1.BaseGSTTotal, t1.BaseTotalTotal, t1.TotalTotal, t1.GSTTotal, t1.Currency, t1.Type FROM voucherl AS t2 INNER JOIN voucher AS t1 "
                         + "ON t2.VoucherCode = t1.VoucherCode WHERE t1.Date >= {d '" + dateFrom + "'} AND t1.Date <= {d '" + dateTo + "'} AND t1.Status != 'C' AND t2.GSTRate = '" + gstRate + "'");
    ...
    while(rs.next())                  
    {
      ...
      appendBodyLine(out, voucherCode, date, companyCode, baseGSTTotal, baseTotalTotal, totalTotal, gstTotal, currency, type, cssFormat, bytesOut);
    }
  ...
  private void setHead(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, boolean plain, String dateFrom, String dateTo, String gstRate, String unm, String sid, String uty, String men,
                       ...
                       throws Exception
  {
    scoutln(out, bytesOut, "<html><head><title>GST Payment Voucher Listing</title>");
    ...
    scoutln(out, bytesOut, "this.location.href=\"/central/servlet/PaymentVoucherPage?unm=" + unm + "&sid=" + sid + "&uty=" + uty
    ...
    outputPageFrame(con, stmt, rs, out, req, plain, dateFrom, dateTo, gstRate, "", "GST Reconciliation: Payment Voucher Listing", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, bytesOut);
  ...
  private void startBody(boolean first, PrintWriter out, String imagesDir, int[] bytesOut) throws Exception
  {
    ...
    scoutln(out, bytesOut, "<tr id=\"pageColumn\"><td nowrap><p>Voucher Code &nbsp;</td>");
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private void appendBodyLine(PrintWriter out, String voucherCode, String date, String companyCode, String baseGSTTotal, String baseTotalTotal, String totalTotal, String gstTotal, String currency, String type, String cssFormat, int[] bytesOut)
                              throws Exception
  {
    ...
    if(type.equals("C"))
      scoutln(out, bytesOut, "<td nowrap><p> &nbsp;&nbsp;Strict GST</td></tr>");
  ...
  private String buildSubMenuText(boolean plain, String dateFrom, String dateTo, String gstRate, String unm, String sid, String uty, String men, String den, String dnm, String bnm, int[] hmenuCount) throws Exception
  {
    ...
    if(! plain)
    {
      ...
      s += "<a href=\"/central/servlet/GSTPurchaseVoucherListing?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + dateFrom + "&p2=" + dateTo + "&p3=" + generalUtils.sanitise(gstRate) + "&p4=P\">Friendly</a></dt></dl>";
    }
