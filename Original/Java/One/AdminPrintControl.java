// =======================================================================================================================================================================================================
// System: ZaraStar Utils: Print Control
// Module: AdminPrintControl.java
// Author: C.K.Harvey
...
public class AdminPrintControl extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      p7  = req.getParameter("p7"); // printer name iff called as direct from queue
      p8  = req.getParameter("p8"); // docType
                    ...
                    int[] bytesOut) throws Exception
  {
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "7400", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    set(con, stmt, rs, out, req, unm, sid, uty, men, den, dnm, bnm, p1, p2, p3, p4, p5, p6, p7, p8, localDefnsDir, defnsDir, bytesOut);
  ...
  private void set(Connection con, Statement stmt, ResultSet rs, PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String p1, String p2, String p3, String p4,
                   String returnServletAndParams, String returnMsg, String p7, String p8, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  { 
    String numPages;
    ...
    if(p7.length() > 0) // coming-in with printer already known
    {
      call7400a(out, unm, sid, uty, men, den, dnm, bnm, "0.000", p4, p7, returnServletAndParams, returnMsg, p8, p2, bytesOut);
      return;
    }

    scoutln(out, bytesOut, "<html><head><title>Print Options</title>");
    ...
    if(uty.equals("I"))
    {
      ...
      scoutln(out, bytesOut, "function netprint(ptr){");
      scoutln(out, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControlNetwork?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=" + numPages + "&p4="
                           + generalUtils.sanitise(returnServletAndParams) + "&p5=" + generalUtils.sanitiseReplacingNewlines(returnMsg) + "&p8=" + p8 + "&p9=" + p2 + "&p1=0.000&p3=\"+ptr;}");
    ...
    pageFrameUtils.outputPageFrame(con, stmt, rs, out, req, "7400", "", "AdminPrintControl", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount, bytesOut);
  ...
  private void getCUPSPrinters(PrintWriter out)
  {
    try
    {
      ...
      String commandArray = "/usr/bin/lpstat -a";
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  private void call7400a(PrintWriter out, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String fileName, String numPages, String ptr, String returnServletAndParams, String returnMsg, String p8,
                         String p9, int[] bytesOut) throws Exception
  {
    URL url = new URL("http://" + men + "/central/servlet/AdminPrintControlNetwork?unm=" + unm + "&sid=" + sid + "&&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=" + fileName + "&p2=" + numPages + "&p3=" + generalUtils.sanitise(ptr) + "&p4="
                    + generalUtils.sanitise(returnServletAndParams) + "&p5=" + generalUtils.sanitise(returnMsg) + "&dnm=" + dnm + "&p8=" + p8 + "&p9=" + p9 + "&bnm=" + bnm);
