// =======================================================================================================================================================================================================
// System: ZaraStar Forum: Shows Stats for DataBase
// Module: ForumStats.java
// Author: C.K.Harvey
...
public class ForumStats extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ForumStats", bytesOut);
  ...
  private void doIt(PrintWriter out, HttpServletRequest req, String unm, String sid, String uty, String dnm, String men, String den, String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(serverUtils.isSysAdmin(con, stmt, rs, unm, dnm, sid, uty, localDefnsDir, defnsDir))
    {
      ...
      {
        messagePage.msgScreen(true, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "ForumStats", imagesDir, localDefnsDir, defnsDir, bytesOut);
    ...
    {
      messagePage.msgScreen(true, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "ForumStats", imagesDir, localDefnsDir, defnsDir, bytesOut);
    }
  ...
  private void analyze(Connection con, Statement stmt, ResultSet rs, PrintWriter out, String unm, String sid, String uty, String men, String den, String dnm, String bnm, String imagesDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    dashboardUtils.drawTitle(out, "DataBase Statistics", "407", unm, sid, uty, men, den, dnm, bnm, bytesOut);

    scoutln(out, bytesOut, "<table id=\"serviceTitleTable\" width=100%>");

    scoutln(out, bytesOut, "<tr><td colspan=2 nowrap><span id=\"serviceTitle\">Forum DataBase Statistics</span></td></tr></table>");
    ...
    issuesUtils.showStats(out, dnm, bytesOut);
