...
// Module: CompanyPersonnelDirectory.java
// Author: C.K.Harvey
...
public class CompanyPersonnelDirectory extends HttpServlet
{
                   ...
                   String imagesLibraryDir, String sessionsDir, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    dashboardUtils.outputPageFrame(con, stmt, rs, out, req, "CompanyPersonnelDirectory", "", "128", unm, sid, uty, men, den, dnm, bnm, "", localDefnsDir, defnsDir, hmenuCount, bytesOut);
  
    dashboardUtils.drawTitle(out, "People", "128", unm, sid, uty, men, den, dnm, bnm, bytesOut);
