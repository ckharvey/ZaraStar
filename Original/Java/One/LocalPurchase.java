// =======================================================================================================================================================================================================
// System: ZaraStar DocumentEngine: LP Record Access
// Module: localPurchase.java
// Author: C.K.Harvey
...
public class LocalPurchase
{
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringLP() throws Exception
  {  
    return "lp ( LPCode char(20) not null,         Date date not null,         CompanyCode char(20) not null, "
              ...
              + "unused8 char(20),                 Status char(1),             ShipAddrCode char(20), "
              + "unused7 char(20),                 StoreCode char(20),         ProjectCode char(20), "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsLP(String[] s) throws Exception
  {
    s[0] = "lpDateInx on lp (Date)";
    s[1] = "lpCompanyCodeInx on lp (CompanyCode)";
    s[2] = "lpSalesPersonInx on lp (SalesPerson)";
    
    return 3;
  }
      
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesLP() throws Exception
  {  
    return "LPCode, Date, CompanyCode, CompanyName, Address1, Address2, Address3, Address4, Address5, PostCode, FAO, Notes, "
         + "unused1, unused2, Misc1, Misc2, GSTTotal, TotalTotal, unused3, unused4, unused5, AllReceived, SignOn, "
         + "DateLastModified, unused8, Status, ShipAddrCode, unused7, StoreCode, ProjectCode, Rate, Currency, ShipName, "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesLP() throws Exception
  {
    return "CDCCCCCCCCCCCCCCFFDDFCCSCCCCCCFCCCCCCCCFFCCCCCCCCCFFCDCCI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesLP(short[] sizes) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesLP() throws Exception
  {
    return "MMMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringLPL() throws Exception
  {  
    return "lpl ( LPCode char(20) not null,   ItemCode char(20) not null,    Description char(80), "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsLPL(String[] s) throws Exception
  {
    s[0] = "lplItemCodeInx on lpl(ItemCode)";
    
    return 1;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesLPL() throws Exception
  {  
    return "LPCode, ItemCode, Description, UnitPrice, Quantity, Amount, GSTRate, ActualUnitPrice, ActualQuantity, ActualAmount, "
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesLPL() throws Exception
  {
    return "CCCFFFCFFFCCSCCICCCFCICFCDCCDCCC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesLPL(short[] sizes) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesLPL() throws Exception
  {
    return "OOOOOOOOOOOOOOOOOOOOOMOOOOOOOOOO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringLPLL() throws Exception
  {  
    return "lpll ( LPCode char(20) not null,   Entry char(6) not null,   Line integer not null,   Text char(80), "
                + "unique(LPCode, Entry, Line))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsLPLL(String[] s) throws Exception
  {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesLPLL() throws Exception
  {  
    return "LPCode, Entry, Line, Text";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesLPLL() throws Exception
  {
    return "CCIC";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesLPLL(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 6;   sizes[2] = 0;   sizes[3] = 80;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesLPLL() throws Exception
  {
    return "MMMO";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getTableCreateStringLPA() throws Exception
  {  
    return "lpa ( Code char(20) not null, LibraryDocCode integer not null, unique(Code, LibraryDocCode))";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public int getIndexCreateStringsLPA(String[] s) throws Exception
  {
    s[0]="\0"; // remove compiler warning
    return 0;
  }
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldNamesLPA() throws Exception
  {  
    return "Code, LibraryDocCode";
  }
  
  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldTypesLPA() throws Exception
  {
    return "CI";
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public void getFieldSizesLPA(short[] sizes) throws Exception
  {
    sizes[0] = 20;   sizes[1] = 0;
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  public String getFieldStylesLPA() throws Exception
  {
    return "MM";
  }
                              ...
                              String errStr, byte[] dataAlready, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    if(cad == 'A' && code[0] == '\000')
    {
      messagePage.msgScreen(false, out, req, 6, unm, sid, uty, men, den, dnm, bnm, "LocalPurchase", imagesDir, localDefnsDir,
                         defnsDir, bytesOut);
      return true;
    }
    ...
    {                            // in the correct order
      dispOrEdit = 'E';
      sortFields(dataAlready, headData, "lp");
    }
    ...
    short[] fieldSizesLP = new short[60]; // plenty
    getFieldSizesLP(fieldSizesLP);

    if(cad == 'A') // not a new one
    {
      short[] fieldSizesLPL = new short[40]; // plenty
      getFieldSizesLPL(fieldSizesLPL);
      ...
      if(dispOrEdit == 'D')
      {  
        numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "226.htm", 2, getFieldNamesLP(), fieldSizesLP, getFieldNamesLPL(), 
                             fieldSizesLPL, null, null);
      }
      else numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "226a.htm", 1, getFieldNamesLP(), fieldSizesLP, null, null, null, null);
      ...
      {
        prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "A", generalUtils.stringFromBytes(code, 0L), date, "226a.htm", 
      ...
      if(dispOrEdit == 'D') // display head *and* lines
      {
        ...
        stmt.executeUpdate("UPDATE lp SET TotalTotal = " + (totalAmt2Lines + totalGSTAmt2Lines) + ", GSTTotal = " 
                         + totalGSTAmt2Lines + ", BaseTotalTotal = " + (totalAmtLines + totalGSTAmtLines) + ", BaseGSTTotal = "
                         + totalGSTAmtLines + " WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
        stmt.close();
        ...
        scoutln(headData, bytesOut, "lp.subtotalbeforegst=" + generalUtils.doubleToStr(totalAmt2Lines) + "\001"); // subtotal on screen

        generalUtils.repDoubleGivenSeparator('2', '\001', headData, 5000, (short)39, (totalAmtLines + totalGSTAmtLines));
        generalUtils.repDoubleGivenSeparator('2', '\001', headData, 5000, (short)40, totalGSTAmtLines);

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2', headData, 5000, 50); // group discount

        scoutln(headData, bytesOut, "lp.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");

        generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 30); // rate
        scoutln(headData, bytesOut, "lp.rateNoTrailing=" + generalUtils.dfsAsStrGivenBinary1(true, headData, (short)30) + "\001");
        ...
        if(attachments.length() == 0)
          attachments= "none";
        scoutln(headData, bytesOut, "lp.Attachments=" + attachments + "\001");        
      }
      else // edit
      {
        ddlData = accountsUtils.getCurrencyNamesDDLData(con, stmt, rs, "lp.Currency",  dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);
        ddlData = documentUtils.getSalesPersonDDLData(con, stmt, rs, "lp.SalesPerson", ddlData, ddlDataUpto, ddlDataLen);
      ...
      generalUtils.bytesDPsGivenSeparator(true, '\001', '2',  headData, 5000, 50); // groupDiscount
    ...
    {
      numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "226a.htm", 1, getFieldNamesLP(), fieldSizesLP, null, null, null, null);

      if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not 
      {                            // be in the correct order
        sortFields(dataAlready, data, "lp");
      }
      else
      {
        screenLayout.buildNewDetails(fieldNames, numFields, "lp", data);

        documentUtils.getNextCode(con, stmt, rs, "lp", true, code);
        
        generalUtils.repAlphaUsingOnes(data, 5000, "LPCode", generalUtils.stringFromBytes(code, 0L));
      ...
      prependEdit(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, "C", generalUtils.stringFromBytes(code, 0L), date, "226a.htm",  
                  localDefnsDir, defnsDir, prependCode, req, bytesOut);
  ...
  {
    b[0]= '\000';
    scoutln(b, bytesOut, "_.lineFile=lpl.line\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5020, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "lp", date, unm))
      scoutln(b, bytesOut, "_.permitted=y\001");
    else scoutln(b, bytesOut, "_.permitted=n\001");

    scoutln(b, bytesOut, "_.stockRec=lpl.itemcode\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 3001, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "lp", date, unm))
      scoutln(b, bytesOut, "_.stockPermitted=y\001");
    else scoutln(b, bytesOut, "_.stockPermitted=n\001");

    scoutln(b, bytesOut, "_.soRec=lpl.socode\001");
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 3001, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "lp", date, unm))
                          ...
                          String den, String dnm, String bnm, byte[] b, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5020, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "<script language=\"JavaScript\">");
      scoutln(b, bytesOut, "function affect(line){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/LocalPurchaseLine?unm=" + unm + "&sid=" + sid
                       ...
                       String code, String date, byte[] b, HttpServletRequest req, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5018, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      scoutln(b, bytesOut, "function fetch(){");
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/LocalPurchaseHeaderEdit?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=A&p3=&p4=\");}\n");

      scoutln(b, bytesOut, "function gst(){");
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/GSTRatesChange?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=LP\";}");
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6093, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PricgrChange?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=LP\";}");
      }
      ...
      if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6098, unm, uty, dnm, localDefnsDir, defnsDir))
      {
        ...
        scoutln(b, bytesOut, "window.location.href=\"/central/servlet/DocumentChangeDiscounts?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=LP\";}");
      }
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5020, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/LocalPurchaseLine?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=&p3=&p4=\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 1025, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/DocumentTraceExecute?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=Z\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/DocumentAttachments?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=lpa\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 8016, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.replace(\"/central/servlet/MailExternalUserCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&p1=LocalPurchasePage&p2=" + code2 + "&p3=Local%20Purchase&bnm=" + bnm + "\");}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11800, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/TrailShow?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2 + "&p2=L\";}");
    }
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5023, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/AdminPrintControl?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=LocalPurchasePrint&p2=" + code2 + "&p3=\";}");
    }
        ...
        if(authenticationUtils.verifyAccess(con, stmt, rs, req, 11200, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PrintToPDFUtils?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p3=" + code2 + "&p1=0.000&p5=LocalPurchase&p2=LocalPurchasePrint\";}");
    }


    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 4190, unm, uty, dnm, localDefnsDir, defnsDir)) // should be 4191
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/FaxCreate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + code2
                         + "&p2=Z&p3=LocalPurchasePrint&p4=&p5=Local%20Purchase\";}");
    }
       ...
       && authenticationUtils.verifyAccess(con, stmt, rs, req, 5014, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      ...
      scoutln(b, bytesOut, "window.location.href=\"/central/servlet/PurchaseOrderSetPrices?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p2=LP&p1=" + code2 + "\";}");
    }
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', ' ', "", "LocalPurchasePage", date, unm, sid, uty, men, dnm, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
    scoutln(b, bytesOut, "<form>");
  }
                           ...
                           String localDefnsDir, String defnsDir, byte[] b, HttpServletRequest req, int[] bytesOut) throws Exception
  {
    ...
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/LocalPurchaseHeaderUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1="
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ', cad.charAt(0), "", "LocalPurchaseHeaderEdit", date, unm, sid, uty, men, dnm, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
                      ...
                      char cad, byte[] recData, int recDataLen, byte[] rtnLineBytes, int[] bytesOut) throws Exception
  {
    ...
    if(searchDataString(recData, recDataLen, "lpl", b, lineBytes) == -1)
      return 'N';
    ...
    sortFields(recData, buf, "lpl"); // sorts the data field (using buf in the process); results are put back into recData
    recDataLen = generalUtils.lengthBytes(recData, 0);
    generalUtils.zeroize(buf, 2000);
        
    String fieldNames = getFieldNamesLPL();
    ...
    while(x < len)
    {
      ...
      if(searchDataString(recData, recDataLen, "lpl", fieldName, value) != -1) // entry exists
      {
        ...
        {
          generalUtils.putAlpha(buf, 2000, (short)25, generalUtils.convertDateToSQLFormat(generalUtils.stringFromBytes(value, 0L)));  
        }
        else
        if(fieldCount == 28) // dateConfirmed
        {
          generalUtils.putAlpha(buf, 2000, (short)28, generalUtils.convertDateToSQLFormat(generalUtils.stringFromBytes(value, 0L)));  
        }
        else
        {
    ...
    generalUtils.repAlpha(buf, 2000, (short)30, mfrOut[0]);
    generalUtils.repAlpha(buf, 2000, (short)31, mfrCodeOut[0]);
    ...
    if((generalUtils.dfsAsStr(buf, (short)25)).length() == 0) // RequiredBy 
      generalUtils.putAlpha(buf, 2000, (short)25, "1970-01-01");

    if((generalUtils.dfsAsStr(buf, (short)28)).length() == 0) // dateConfirmed 
    generalUtils.putAlpha(buf, 2000, (short)28, "1970-01-01");

    generalUtils.repAlpha(buf, 2000, (short)7, "0"); // actualUnitPrice 
    generalUtils.repAlpha(buf, 2000, (short)8, "0"); // actualQuantity
    generalUtils.repAlpha(buf, 2000, (short)9, "0"); // actualAmount

    generalUtils.repAlpha(buf, 2000, (short)11, unm);

    if((generalUtils.dfsAsStr(buf, (short)15)).length() == 0) // soLine
      generalUtils.repAlpha(buf, 2000, (short)15, "0");

    byte[] rateB = new byte[30];
    getAnLPFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir); // getCurrencyRateGivenCode
    ...
    if(   searchDataString(recData, recDataLen, "lpl", fieldName, value) != -1 // exists
       && value[0] != '\000')
    {
    ...
    if(searchDataString(recData, recDataLen, "lpl", fieldName, value) != -1) // exists
    {
      if(value[0] == '\000') // description fld is blank
      {
        ...
        if(inventory.getStockRecGivenCode(con, stmt, rs, itemCode, '\000', data) != -1) // exists
        {
          ...
          if(! unitPriceGiven)
          {
            nonBaseSellPrice = generalUtils.dfsAsDouble(data, (short)18);  // purchase price
            byte[] currency = new byte[50];
            getAnLPFieldGivenCode(con, stmt, rs, "Currency", code, currency, dnm, localDefnsDir, defnsDir);
      ...
      else // strip only the first desc line for LPL rec
      {
  ...
  {
    stmt = con.createStatement();
    stmt.executeUpdate("UPDATE lp SET SignOn = '" + unm + "', DateLastModified = NULL WHERE LPCode = '"
  ...
  private void updateMultipleLines(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, byte[] descData, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      rs = stmt.executeQuery("SELECT COUNT(*) AS rowcount FROM lpll WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) 
      ...
      while(lineCount <= numDescLines && lineCount <= numLinesAtPresent) // overwrite those lines which exist
      {
        ...
        stmt.executeUpdate("UPDATE lpll SET Text = '" + sanitisedDesc + "' WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L)
      ...
      while(lineCount <= numDescLines) // add those lines which do not exist
      {
        ...
        stmt.executeUpdate("INSERT INTO lpll (" + getFieldNamesLPLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L) + "','"
      ...
      {
        stmt.executeUpdate("DELETE FROM lpll WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  public String getAnLPFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, String lpCode, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    byte[] b     = new byte[21];
    generalUtils.strToBytes(b, lpCode);

    getAnLPFieldGivenCode(con, stmt, rs, fieldName, b, value, dnm, localDefnsDir, defnsDir);

    return generalUtils.stringFromBytes(value, 0L);
  }
  // -------------------------------------------------------------------------------------------------------------------------------
  public void getAnLPFieldGivenCode(Connection con, Statement stmt, ResultSet rs, String fieldName, byte[] lpCode, byte[] value, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    if(lpCode[0] == '\000') // just-in-case
      return;

    generalUtils.toUpper(lpCode, 0);

    stmt = con.createStatement();

    rs = stmt.executeQuery("SELECT " + fieldName + " FROM lp WHERE LPCode = '" + generalUtils.stringFromBytes(lpCode, 0L) + "'");
    if(! rs.next())
      value[0] = '\000';
                                        ...
                                        throws Exception
  {
    ...
    String layoutFile="226b.htm";

    short[] fieldSizesLPL = new short[40]; // plenty
    getFieldSizesLPL(fieldSizesLPL);

    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, layoutFile, 1, getFieldNamesLPL(), fieldSizesLPL, null, null, null, null);
    ...
    if(line[0] != '\000') // existing line
    {
      if(code[0] != '\000') // just-in-case
      {
        if(dataAlready[0] != '\000') // coming with an err msg - passing-in data already entered but the data's fields may (will) not 
        {                            //  be in the correct order
          sortFields(dataAlready, data, "lpl");
        }
        else
        {
    ...
    else // new line
    {
      ...
      {
        data[0]= '\000';
        scoutln(data, bytesOut, "lpl.entry=" + generalUtils.intToStr(nextLine) + "\001");

        String gstRateDefault = accountsUtils.getDefaultGSTRate(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "lpl.gstrate=" + gstRateDefault + "\001");

        String storeDefault = documentUtils.getDefaultStore(con, stmt, rs, dnm, localDefnsDir, defnsDir);
        scoutln(data, bytesOut, "lpl.storecode=" + storeDefault + "\001");
      }
      
      newOrEdit = 'N';
    }

    ddlData = documentUtils.getStoreDDLData(con, stmt, rs, "lpl.storecode",  ddlData, ddlDataUpto, ddlDataLen);
    ddlData = accountsUtils.getGSTRatesDDLData(con, stmt, rs, "lpl.gstrate", dnm, ddlData, ddlDataUpto, ddlDataLen, localDefnsDir, defnsDir);

    ddlData = inventory.getMfrsDDLData(con, stmt, rs, "lpl.manufacturer", ddlData, ddlDataUpto, ddlDataLen);

    getAnLPFieldGivenCode(con, stmt, rs, "Currency", code, b, dnm, localDefnsDir, defnsDir); // getCurrencyGivenCode
    scoutln(data, bytesOut, "lpl.currency=" + generalUtils.stringFromBytes(b, 0L) + "\001");

    scoutln(data, bytesOut, "lpl.basecurrency=" + accountsUtils.getBaseCurrency(con, stmt, rs, dnm, localDefnsDir, defnsDir) + "\001");
    ...
    prependEditLine(con, stmt, rs, unm, sid, uty, men, den, dnm, bnm, errStr, cad, generalUtils.stringFromBytes(code, 0L),
                    generalUtils.stringFromBytes(line, 0L), "226b.htm", localDefnsDir, defnsDir, prependCode, newOrEdit, req, bytesOut);
                                 ...
                                 throws Exception
  {
    ...
    scoutln(b, bytesOut, "function save(thisOp){var saveStr=\"\";" + saveStr + "\n");
    scoutln(b, bytesOut, "var saveStr2=strip(saveStr);window.location.replace(\"/central/servlet/LocalPurchaseLineUpdate?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men=" + men + "&den=" + den + "&dnm=" + dnm + "&bnm=" + bnm + "&p1=" + cad
    ...
    outputPageFrame(con, stmt, rs, b, req, newOrEdit, ' ', "", "LocalPurchaseLine", "", unm, sid, uty, men, dnm, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  ...
  //       'F' if not updated
  //       'I' if illegal code
  public char putHead(Connection con, Statement stmt, ResultSet rs, byte[] originalCode, String unm, String dnm, String localDefnsDir, String defnsDir, char cad, byte[] recData, int recDataLen, byte[] code, int[] bytesOut)
                      throws Exception
  {
    byte[] str = new byte[21];  str[0] = '\000';
    generalUtils.catAsBytes("LPCode", 0, str, true);

    if(searchDataString(recData, recDataLen, "lp", str, code) == -1)
      return 'N';
    ...
    if(searchDataString(recData, recDataLen, "lp", fldName, value) != -1) // entry exists
    {
      if(value[0] == '\000' || generalUtils.doubleFromBytesCharFormat(value, 0) == 0.0)
      {
        ...
        searchDataString(recData, recDataLen, "lp", fldName, currency); // assumes exists

        generalUtils.strToBytes(fldName, "Date");
        searchDataString(recData, recDataLen, "lp", fldName, date); // assumes exists
    ...
    String fieldNamesLP = getFieldNamesLP();
    ...
    for(x=3;x<10;++x)
    {
      getFieldName(fieldNamesLP, x, fldName);
      if(searchDataString(recData, recDataLen, "lp", fldName, value) != -1) // entry exists
      {
        if(value[0] != '\000')
    ...
    len = fieldNamesLP.length();
    int y, fieldCount=0;
    x=0;
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesLP.charAt(x) != ',')
        fldName[y++] = (byte)fieldNamesLP.charAt(x++);
      fldName[y] = '\000';
      ++x;
                             ...
                             int[] bytesOut) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM lp WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    if(! rs.next())
    {
      rs.close();
      stmt.close();
    ...
    String fieldTypes = getFieldTypesLP();
    ...
    {    
      String fieldNames = getFieldNamesLP();
      ...
      while(x < len)
      {
        ...
        scoutln(data, bytesOut, "lp." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
  ...
  public char putRecHeadGivenCode(Connection con, Statement stmt, ResultSet rs, byte[] code, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    try
    {
      ...
      if(newOrEdit == 'N')
      {
        ...
        q = "INSERT INTO lp (" + getFieldNamesLP() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE lp SET " + opStr + " WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "'";
      }
  ...
  public char putRecLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char newOrEdit, byte[] data, String dnm, String localDefnsDir, String defnsDir)
  {
    ...
    try
    {
      ...
      String opStr="";
      boolean first = true;
      String fieldTypes = getFieldTypesLPL();
      int x=0, count=0;
      if(newOrEdit == 'N')
      {
        // change: abc\0def\0... format into: 'abc','def',...
        ...
        q = "INSERT INTO lpl (" + getFieldNamesLPL() + ") VALUES (" + opStr + ")";
      }
      else // newOrEdit == 'E'
      {
        String thisFieldName;
        ...
        q = "UPDATE lpl SET " + opStr + " WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '" + generalUtils.stringFromBytes(line, 0L) + "'";
      }
  ...
  public boolean deleteLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut)
  {
    try
    {
      ...
      stmt.executeUpdate("DELETE FROM lpl WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '"
                         ...
                         String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM lpl WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      if(separator == '\000')
      ...
      else // separator == '\001'
      {
        ...
        while(x < lenFieldNames)
        {
          ...
          while(x < lenFieldNames && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          s += "lpl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001";
          ++x;
          while(x < lenFieldNames && fieldNames.charAt(x) == ' ')
            ++x;
        }
  ...
  public int getLine(Connection con, Statement stmt, ResultSet rs, byte[] code, byte[] line, char separator, byte[] data, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    if(code[0] == '\000') // just-in-case
      return -1;
    ...
    rs = stmt.executeQuery("SELECT * FROM lpl WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Line = '"
                                     + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
      ...
      else // separator == '\001'
      {
        ...
        while(x < len)
        {
          ...
          while(x < len && fieldNames.charAt(x) != ',')
            thisFieldName += fieldNames.charAt(x++);
          thisFieldType = fieldTypes.charAt(count++);
          scoutln(data, bytesOut, "lpl." + thisFieldName + "=" + getValue(count, thisFieldType, rs, rsmd) + "\001");
          ++x;
          while(x < len && fieldNames.charAt(x) == ' ')
            ++x;
        }
                                 ...
                                 String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT * FROM lpll WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {
                                ...
                                String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    rs = stmt.executeQuery("SELECT Text FROM lpll WHERE LPCode = '" + generalUtils.stringFromBytes(code, 0L) + "' AND Entry = '"
                                     + generalUtils.stringFromBytes(line, 0L) + "'");
    ResultSetMetaData rsmd = rs.getMetaData();
    while(rs.next())
    {    
                                  ...
                                  int[] bytesOut) throws Exception
  {
    ...
    outputPageFrame(con, stmt, rs, b, req, ' ',  ' ', "", "OrderAcknowledgementLine", date, unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, bytesOut);
  }

  // -------------------------------------------------------------------------------------------------------------------------------
  // picks-up the list of fieldnames for the LP or LPL file, and fetches the data value for that field; and rebuilds the data string
  private void sortFields(byte[] ipBuf, byte[] opBuf, String which) throws Exception
  {
    ...
    if(which.equals("lp"))
      fieldNames = getFieldNamesLP();
    else // if(which.equals("lpl"))
      fieldNames = getFieldNamesLPL();
    int len = fieldNames.length();
  ...
  public void updatePrices(Connection con, Statement stmt, ResultSet rs, byte[] code, String band, String clear, String unm, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    byte[] rateB = new byte[30];
    getAnLPFieldGivenCode(con, stmt, rs, "Rate", code, rateB, dnm, localDefnsDir, defnsDir);
    double rate = generalUtils.doubleFromBytesCharFormat(rateB, 0);
                                           ...
                                           String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    numFields = screenLayout.layoutToBuffer(buf1, buf2, size1, fieldNames, fieldTypes, fieldSizes, localDefnsDir, defnsDir, "226d.htm", 2, getFieldNamesLP(), fieldSizesLP, getFieldNamesLPL(), 
                         fieldSizesLPL, null, null);
    ...
    int x=0, y, fieldCount=0;
    int len = fieldNamesLP.length();
    while(x < len)
    {
      y=0;
      while(x < len && fieldNamesLP.charAt(x) != ',')
        fieldName[y++] = (byte)fieldNamesLP.charAt(x++);
      fieldName[y] = '\000';
      ++x;
      ...
      if(searchDataString(data, recDataLen, "lp", fieldName, value) != -1) // entry exists
      {
    ...
    if(attachments.length() == 0)
      attachments= "none";
    scoutln(data, bytesOut, "lp.Attachments=" + attachments + "\001");
                               ...
                               String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT LibraryDocCode FROM lpa WHERE Code = '" + code + "'");
      while(rs.next())           
      {    
                               ...
                               String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    String subMenuText = dashboardUtils.buildSubMenuText(con, stmt, rs, req, "5016", unm, sid, uty, men, den, dnm, bnm, localDefnsDir, defnsDir, hmenuCount);

    subMenuText += "<table id='title' width=100%><tr><td colspan=2 nowrap><p>Local Requisition" + directoryUtils.buildHelp(5016) + "</td></tr></table>";
                                  ...
                                  int[] hmenuCount) throws Exception
  {
    ...
    if(callingServlet.equals("LocalPurchasePage"))
      s += drawOptions5016(con, stmt, rs, req, hmenuCount, date, unm, uty, dnm, localDefnsDir, defnsDir);
    else
    if(callingServlet.equals("LocalPurchaseHeaderEdit"))
      s += drawOptions5018(hmenuCount, cad, unm, sid, uty, men, den, dnm, bnm);
    else 
    if(callingServlet.equals("LocalPurchaseLine"))
      s += drawOptions5020(hmenuCount, newOrEdit, unm, sid, uty, men, den, dnm, bnm);
  ...
  // -----------------------------------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5016(Connection con, Statement stmt, ResultSet rs, HttpServletRequest req, int[] hmenuCount, String date, String unm, String uty, String dnm,
                                 String localDefnsDir, String defnsDir) throws Exception
  {      
    String s = "";
      
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 5018, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "lp", date, unm))
    ...
    if(authenticationUtils.verifyAccess(con, stmt, rs, req, 6094, unm, uty, dnm, localDefnsDir, defnsDir) && serverUtils.passLockCheck(con, stmt, rs, "lp", date, unm))
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0]++ + "');\"><a href=\"javascript:attach()\">Attachments</a></dt></dl>\n";
    
    boolean LocalPurchasePrint  = authenticationUtils.verifyAccess(con, stmt, rs, req, 5023, unm, uty, dnm, localDefnsDir, defnsDir);
    ...
    if(LocalPurchasePrint || _4190 || MailExternalUserCreate || PrintToPDFUtils)
    {
      s += "<dl><dt onmouseover=\"setup('hmenu" + hmenuCount[0] + "');\">Send</dt><dd id='hmenu" + hmenuCount[0]++ + "'><ul>";
      if(LocalPurchasePrint)
    ...
    if(serverUtils.passLockCheck(con, stmt, rs, "lp", date, unm))
    {
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5018(int[] hmenuCount, char cad, String unm, String sid, String uty, String men,
                               String mainDNM, String dnm, String bnm) throws Exception
  {      
    ...
    s += "{var url = \"http://" + men + "/central/servlet/SupplierSelect?unm=\" + escape('" + unm
  ...
  // -------------------------------------------------------------------------------------------------------------------------------
  private String drawOptions5020(int[] hmenuCount, char newOrEdit, String unm, String sid, String uty,
                              ...
                              throws Exception
  {
    try
    {
      ...
      stmt.executeUpdate("INSERT INTO lpll (" + getFieldNamesLPLL() + ") VALUES ('" + generalUtils.stringFromBytes(code, 0L) + "','" + line
  ...
  public void setPurchasePrices(Connection con, Statement stmt, ResultSet rs, byte[] code, String unm, String dnm, String localDefnsDir, String defnsDir) throws Exception
  {
    ...
    String lpDate = getAnLPFieldGivenCode(con, stmt, rs, "Date", generalUtils.stringFromBytes(code, 0L), dnm, localDefnsDir, defnsDir);
    ...
    for(int x=0;x<linesCount[0];++x)
    {
      if(generalUtils.getListEntryByNum(x, linesData, line)) // just-in-case
      {
        ...
        if(inventory.existsItemRecGivenCode(con, stmt, rs, itemCode))
        {
          ...
          if(unitPriceD != 0.0)
          {
            inventory.updateStockPurchasePriceAndDate(con, stmt, rs, itemCode, unitPrice, lpDate);
          }
        }
      }
    }
