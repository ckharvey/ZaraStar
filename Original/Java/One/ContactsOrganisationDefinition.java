// =======================================================================================================================================================================================================
// System: ZaraStar Contacts: Organization Definition
// Module: ContactsOrganisationDefinition.java
// Author: C.K.Harvey
...
public class ContactsOrganisationDefinition extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
  {
    ...
    catch(Exception e)
    {
      ...
      messagePage.errorPage(out, req, e, "Communications Error", unm, sid, dnm, bnm, urlBit, men, den, uty, "ContactsOrganisationDefinition", bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 8860, bytesOut[0], 0, "ERR:");
                    ...
                    String bnm, int[] bytesOut) throws Exception
  {
    ...
    if(! authenticationUtils.verifyAccess(con, stmt, rs, req, 8860, unm, uty, dnm, localDefnsDir, defnsDir))
    {
      messagePage.msgScreen(false, out, req, 13, unm, sid, uty, men, den, dnm, bnm, "8860", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 8860, bytesOut[0], 0, "ACC:");
    ...
    {
      messagePage.msgScreen(false, out, req, 12, unm, sid, uty, men, den, dnm, bnm, "8860", imagesDir, localDefnsDir, defnsDir, bytesOut);
      serverUtils.etotalBytes(req, unm, dnm, 8860, bytesOut[0], 0, "SID:");
      if(con  != null) con.close();
      if(out != null) out.flush();
      return;
    }
    ...
    serverUtils.totalBytes(con, stmt, rs, req, unm, dnm, 8860, bytesOut[0], 0, (new java.util.Date().getTime() - startTime), "");
    if(con  != null) con.close();
    if(out != null) out.flush();
  }
  ...
  {
    scoutln(out, bytesOut, "<html><head><title>Organization Definition</title>");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/ContactsOrganisationDefinitionUpdate?unm=\" + escape('" + unm + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty + "') + \"&men=\" + escape('" + men
                         + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
                         + "') + \"&p1=\" + code + \"&p2=\" + name + \"&p3=\" + newOrEdit + \"&dnm=" + dnm + "\";");
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/ContactsOrganisationsDefinitionDelete?unm=\" + escape('" + unm
    ...
    scoutln(out, bytesOut, "var url = \"http://" + men + "/central/servlet/ContactsOrganisationsDefinitionEdit?unm=\" + escape('" + unm
                         + "') + \"&sid=\" + escape('" + sid + "') + \"&uty=\" + escape('" + uty
                         + "') + \"&men=\" + escape('" + men + "') + \"&den=\" + escape('" + den + "') + \"&bnm=\" + escape('" + bnm
                           + "') + \"&p1=\" + code + \"&dnm=\" + escape('" + dnm + "');");
    ...
    scoutln(out, bytesOut, "messageElement.innerHTML='<p><a href=\"javascript:updateE()\">Update the Organization</a>';");
    ...
    scoutln(out, bytesOut, "this.location.replace(\"/central/servlet/ContactsOrganisationDefinition?unm=" + unm + "&sid=" + sid + "&uty=" + uty + "&men="
    ...
    scoutln(out, bytesOut, "<td nowrap><p>Organization Code &nbsp;</td>");
    scoutln(out, bytesOut, "<td nowrap><p>Organization Name &nbsp;</td></tr>");
    ...
    scoutln(out, bytesOut, "<tr><td><span id=\"codebox\"><input type=text name=code size=8 maxlength=10></span></td>");
    scoutln(out, bytesOut, "<td><input type=text name=name size=60 maxlength=80></td></tr>");
    
    scoutln(out, bytesOut, "<tr><td>&nbsp;</td></tr>");
    scoutln(out, bytesOut, "<tr><td colspan=3><span id=\"option\"><p><a href=\"javascript:updateN()\">Add the Organization</a></span></td></tr>");
  ...
  private void list(PrintWriter out, String dnm, String localDefnsDir, String defnsDir, int[] bytesOut) throws Exception
  {
    ...
    try
    {
      ...
      rs = stmt.executeQuery("SELECT Code, Name FROM organizations ORDER BY Code");
